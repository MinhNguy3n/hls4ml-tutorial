<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="my_prj" ideType="classic" top="my_prj">
    <files>
        ...
        <file name="../../my_prj_test.cpp" sc="0" tb="1" cflags="-I../../firmware -std=c++0x -Wno-unknown-pragmas" csimflags="" blackbox="false"/>
    </files>
    <solutions>
