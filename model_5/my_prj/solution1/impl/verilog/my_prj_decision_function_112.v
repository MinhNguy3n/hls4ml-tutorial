...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_12_1_1_x27 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x27_U1398(
    .din0(12'd125),
    .din1(12'd21),
    .din2(12'd4059),
    .din3(12'd3798),
...
assign icmp_ln86_1810_fu_330_p2 = (($signed(x_15_val_int_reg) < $signed(18'd260803)) ? 1'b1 : 1'b0);

assign icmp_ln86_1811_fu_336_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260983)) ? 1'b1 : 1'b0);

assign icmp_ln86_1812_fu_342_p2 = (($signed(x_14_val_int_reg) < $signed(18'd313)) ? 1'b1 : 1'b0);

assign icmp_ln86_1813_fu_348_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1684)) ? 1'b1 : 1'b0);

assign icmp_ln86_1814_fu_354_p2 = (($signed(x_14_val_int_reg) < $signed(18'd304)) ? 1'b1 : 1'b0);

assign icmp_ln86_1815_fu_360_p2 = (($signed(x_14_val_int_reg) < $signed(18'd336)) ? 1'b1 : 1'b0);

assign icmp_ln86_1816_fu_366_p2 = (($signed(x_2_val_int_reg) < $signed(18'd261748)) ? 1'b1 : 1'b0);

assign icmp_ln86_1817_fu_372_p2 = (($signed(x_3_val_int_reg) < $signed(18'd168)) ? 1'b1 : 1'b0);

assign icmp_ln86_1818_fu_378_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261063)) ? 1'b1 : 1'b0);

assign icmp_ln86_1819_fu_384_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261274)) ? 1'b1 : 1'b0);

assign icmp_ln86_1820_fu_390_p2 = (($signed(x_15_val_int_reg) < $signed(18'd2815)) ? 1'b1 : 1'b0);

assign icmp_ln86_1821_fu_396_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260975)) ? 1'b1 : 1'b0);

assign icmp_ln86_1822_fu_402_p2 = (($signed(x_3_val_int_reg) < $signed(18'd262116)) ? 1'b1 : 1'b0);

assign icmp_ln86_1823_fu_408_p2 = (($signed(x_3_val_int_reg) < $signed(18'd564)) ? 1'b1 : 1'b0);

assign icmp_ln86_1824_fu_414_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1451)) ? 1'b1 : 1'b0);

assign icmp_ln86_1825_fu_420_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1896)) ? 1'b1 : 1'b0);

assign icmp_ln86_1826_fu_426_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259004)) ? 1'b1 : 1'b0);

assign icmp_ln86_1827_fu_432_p2 = (($signed(x_4_val_int_reg) < $signed(18'd20)) ? 1'b1 : 1'b0);

assign icmp_ln86_1828_fu_438_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261418)) ? 1'b1 : 1'b0);

assign icmp_ln86_1829_fu_444_p2 = (($signed(x_0_val_int_reg) < $signed(18'd933)) ? 1'b1 : 1'b0);

assign icmp_ln86_1830_fu_450_p2 = (($signed(x_10_val_int_reg) < $signed(18'd260003)) ? 1'b1 : 1'b0);

assign icmp_ln86_1831_fu_456_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259636)) ? 1'b1 : 1'b0);

assign icmp_ln86_1832_fu_462_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260383)) ? 1'b1 : 1'b0);

assign icmp_ln86_1833_fu_468_p2 = (($signed(x_6_val_int_reg) < $signed(18'd61)) ? 1'b1 : 1'b0);

assign icmp_ln86_1834_fu_474_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2374)) ? 1'b1 : 1'b0);

assign icmp_ln86_1835_fu_480_p2 = (($signed(x_5_val_int_reg) < $signed(18'd831)) ? 1'b1 : 1'b0);

assign icmp_ln86_1836_fu_486_p2 = (($signed(x_14_val_int_reg) < $signed(18'd287)) ? 1'b1 : 1'b0);

assign icmp_ln86_1837_fu_492_p2 = (($signed(x_13_val_int_reg) < $signed(18'd261759)) ? 1'b1 : 1'b0);

assign icmp_ln86_1838_fu_498_p2 = (($signed(x_10_val_int_reg) < $signed(18'd261671)) ? 1'b1 : 1'b0);

assign icmp_ln86_1839_fu_504_p2 = (($signed(x_14_val_int_reg) < $signed(18'd950)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_324_p2 = (($signed(x_15_val_int_reg) < $signed(18'd879)) ? 1'b1 : 1'b0);
