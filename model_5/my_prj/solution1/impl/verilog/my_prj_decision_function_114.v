...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_11_1_1_x25 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 11 ))
sparsemux_65_5_11_1_1_x25_U1374(
    .din0(11'd1),
    .din1(11'd1991),
    .din2(11'd306),
    .din3(11'd43),
...
assign icmp_ln86_1752_fu_322_p2 = (($signed(x_3_val_int_reg) < $signed(18'd2161)) ? 1'b1 : 1'b0);

assign icmp_ln86_1753_fu_328_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1779)) ? 1'b1 : 1'b0);

assign icmp_ln86_1754_fu_334_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1856)) ? 1'b1 : 1'b0);

assign icmp_ln86_1755_fu_340_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2036)) ? 1'b1 : 1'b0);

assign icmp_ln86_1756_fu_346_p2 = (($signed(x_5_val_int_reg) < $signed(18'd924)) ? 1'b1 : 1'b0);

assign icmp_ln86_1757_fu_352_p2 = (($signed(x_2_val_int_reg) < $signed(18'd2095)) ? 1'b1 : 1'b0);

assign icmp_ln86_1758_fu_358_p2 = (($signed(x_5_val_int_reg) < $signed(18'd1759)) ? 1'b1 : 1'b0);

assign icmp_ln86_1759_fu_364_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1565)) ? 1'b1 : 1'b0);

assign icmp_ln86_1760_fu_370_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1307)) ? 1'b1 : 1'b0);

assign icmp_ln86_1761_fu_376_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260992)) ? 1'b1 : 1'b0);

assign icmp_ln86_1762_fu_382_p2 = (($signed(x_3_val_int_reg) < $signed(18'd2652)) ? 1'b1 : 1'b0);

assign icmp_ln86_1763_fu_388_p2 = (($signed(x_2_val_int_reg) < $signed(18'd2282)) ? 1'b1 : 1'b0);

assign icmp_ln86_1764_fu_394_p2 = (($signed(x_1_val_int_reg) < $signed(18'd35)) ? 1'b1 : 1'b0);

assign icmp_ln86_1765_fu_400_p2 = (($signed(x_5_val_int_reg) < $signed(18'd1546)) ? 1'b1 : 1'b0);

assign icmp_ln86_1766_fu_406_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1462)) ? 1'b1 : 1'b0);

assign icmp_ln86_1767_fu_412_p2 = (($signed(x_4_val_int_reg) < $signed(18'd1622)) ? 1'b1 : 1'b0);

assign icmp_ln86_1768_fu_418_p2 = (($signed(x_15_val_int_reg) < $signed(18'd3241)) ? 1'b1 : 1'b0);

assign icmp_ln86_1769_fu_424_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1451)) ? 1'b1 : 1'b0);

assign icmp_ln86_1770_fu_430_p2 = (($signed(x_1_val_int_reg) < $signed(18'd375)) ? 1'b1 : 1'b0);

assign icmp_ln86_1771_fu_436_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1753)) ? 1'b1 : 1'b0);

assign icmp_ln86_1772_fu_442_p2 = (($signed(x_4_val_int_reg) < $signed(18'd2526)) ? 1'b1 : 1'b0);

assign icmp_ln86_1773_fu_448_p2 = (($signed(x_15_val_int_reg) < $signed(18'd643)) ? 1'b1 : 1'b0);

assign icmp_ln86_1774_fu_454_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1732)) ? 1'b1 : 1'b0);

assign icmp_ln86_1775_fu_460_p2 = (($signed(x_2_val_int_reg) < $signed(18'd2110)) ? 1'b1 : 1'b0);

assign icmp_ln86_1776_fu_466_p2 = (($signed(x_3_val_int_reg) < $signed(18'd2496)) ? 1'b1 : 1'b0);

assign icmp_ln86_1777_fu_472_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1648)) ? 1'b1 : 1'b0);

assign icmp_ln86_1778_fu_478_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261673)) ? 1'b1 : 1'b0);

assign icmp_ln86_1779_fu_484_p2 = (($signed(x_3_val_int_reg) < $signed(18'd2706)) ? 1'b1 : 1'b0);

assign icmp_ln86_1780_fu_490_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261638)) ? 1'b1 : 1'b0);

assign icmp_ln86_1781_fu_496_p2 = (($signed(x_4_val_int_reg) < $signed(18'd2478)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_316_p2 = (($signed(x_3_val_int_reg) < $signed(18'd2435)) ? 1'b1 : 1'b0);
