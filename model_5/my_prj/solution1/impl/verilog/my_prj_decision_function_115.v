...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_12_1_1_x26 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x26_U1362(
    .din0(12'd3998),
    .din1(12'd39),
    .din2(12'd3740),
    .din3(12'd3967),
...
assign icmp_ln86_1723_fu_312_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261788)) ? 1'b1 : 1'b0);

assign icmp_ln86_1724_fu_318_p2 = (($signed(x_9_val_int_reg) < $signed(18'd1449)) ? 1'b1 : 1'b0);

assign icmp_ln86_1725_fu_324_p2 = (($signed(x_10_val_int_reg) < $signed(18'd261952)) ? 1'b1 : 1'b0);

assign icmp_ln86_1726_fu_330_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260817)) ? 1'b1 : 1'b0);

assign icmp_ln86_1727_fu_336_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261133)) ? 1'b1 : 1'b0);

assign icmp_ln86_1728_fu_342_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261494)) ? 1'b1 : 1'b0);

assign icmp_ln86_1729_fu_348_p2 = (($signed(x_12_val_int_reg) < $signed(18'd261902)) ? 1'b1 : 1'b0);

assign icmp_ln86_1730_fu_354_p2 = (($signed(x_0_val_int_reg) < $signed(18'd467)) ? 1'b1 : 1'b0);

assign icmp_ln86_1731_fu_360_p2 = (($signed(x_13_val_int_reg) < $signed(18'd1296)) ? 1'b1 : 1'b0);

assign icmp_ln86_1732_fu_366_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261464)) ? 1'b1 : 1'b0);

assign icmp_ln86_1733_fu_372_p2 = (($signed(x_2_val_int_reg) < $signed(18'd260984)) ? 1'b1 : 1'b0);

assign icmp_ln86_1734_fu_378_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261065)) ? 1'b1 : 1'b0);

assign icmp_ln86_1735_fu_384_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261984)) ? 1'b1 : 1'b0);

assign icmp_ln86_1736_fu_390_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261288)) ? 1'b1 : 1'b0);

assign icmp_ln86_1737_fu_396_p2 = (($signed(x_10_val_int_reg) < $signed(18'd261285)) ? 1'b1 : 1'b0);

assign icmp_ln86_1738_fu_402_p2 = (($signed(x_9_val_int_reg) < $signed(18'd122)) ? 1'b1 : 1'b0);

assign icmp_ln86_1739_fu_408_p2 = (($signed(x_15_val_int_reg) < $signed(18'd76)) ? 1'b1 : 1'b0);

assign icmp_ln86_1740_fu_414_p2 = (($signed(x_0_val_int_reg) < $signed(18'd907)) ? 1'b1 : 1'b0);

assign icmp_ln86_1741_fu_420_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261274)) ? 1'b1 : 1'b0);

assign icmp_ln86_1742_fu_426_p2 = (($signed(x_0_val_int_reg) < $signed(18'd615)) ? 1'b1 : 1'b0);

assign icmp_ln86_1743_fu_432_p2 = (($signed(x_0_val_int_reg) < $signed(18'd364)) ? 1'b1 : 1'b0);

assign icmp_ln86_1744_fu_438_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260853)) ? 1'b1 : 1'b0);

assign icmp_ln86_1745_fu_444_p2 = (($signed(x_14_val_int_reg) < $signed(18'd262064)) ? 1'b1 : 1'b0);

assign icmp_ln86_1746_fu_450_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1251)) ? 1'b1 : 1'b0);

assign icmp_ln86_1747_fu_456_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261089)) ? 1'b1 : 1'b0);

assign icmp_ln86_1748_fu_462_p2 = (($signed(x_13_val_int_reg) < $signed(18'd2020)) ? 1'b1 : 1'b0);

assign icmp_ln86_1749_fu_468_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261083)) ? 1'b1 : 1'b0);

assign icmp_ln86_1750_fu_474_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261501)) ? 1'b1 : 1'b0);

assign icmp_ln86_1751_fu_480_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261717)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_306_p2 = (($signed(x_0_val_int_reg) < $signed(18'd911)) ? 1'b1 : 1'b0);
