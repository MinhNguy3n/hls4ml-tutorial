...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_12_1_1_x25 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x25_U1282(
    .din0(12'd3606),
    .din1(12'd464),
    .din2(12'd385),
    .din3(12'd3907),
...
assign icmp_ln86_1546_fu_310_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261787)) ? 1'b1 : 1'b0);

assign icmp_ln86_1547_fu_316_p2 = (($signed(x_15_val_int_reg) < $signed(18'd973)) ? 1'b1 : 1'b0);

assign icmp_ln86_1548_fu_322_p2 = (($signed(x_3_val_int_reg) < $signed(18'd646)) ? 1'b1 : 1'b0);

assign icmp_ln86_1549_fu_328_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260848)) ? 1'b1 : 1'b0);

assign icmp_ln86_1550_fu_334_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1638)) ? 1'b1 : 1'b0);

assign icmp_ln86_1551_fu_340_p2 = (($signed(x_15_val_int_reg) < $signed(18'd1162)) ? 1'b1 : 1'b0);

assign icmp_ln86_1552_fu_346_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260914)) ? 1'b1 : 1'b0);

assign icmp_ln86_1553_fu_352_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261703)) ? 1'b1 : 1'b0);

assign icmp_ln86_1554_fu_358_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261276)) ? 1'b1 : 1'b0);

assign icmp_ln86_1555_fu_364_p2 = (($signed(x_10_val_int_reg) < $signed(18'd260925)) ? 1'b1 : 1'b0);

assign icmp_ln86_1556_fu_370_p2 = (($signed(x_15_val_int_reg) < $signed(18'd784)) ? 1'b1 : 1'b0);

assign icmp_ln86_1557_fu_376_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1316)) ? 1'b1 : 1'b0);

assign icmp_ln86_1558_fu_382_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1263)) ? 1'b1 : 1'b0);

assign icmp_ln86_1559_fu_388_p2 = (($signed(x_15_val_int_reg) < $signed(18'd1682)) ? 1'b1 : 1'b0);

assign icmp_ln86_1560_fu_394_p2 = (($signed(x_2_val_int_reg) < $signed(18'd261018)) ? 1'b1 : 1'b0);

assign icmp_ln86_1561_fu_400_p2 = (($signed(x_2_val_int_reg) < $signed(18'd261001)) ? 1'b1 : 1'b0);

assign icmp_ln86_1562_fu_406_p2 = (($signed(x_10_val_int_reg) < $signed(18'd260801)) ? 1'b1 : 1'b0);

assign icmp_ln86_1563_fu_412_p2 = (($signed(x_12_val_int_reg) < $signed(18'd260860)) ? 1'b1 : 1'b0);

assign icmp_ln86_1564_fu_418_p2 = (($signed(x_0_val_int_reg) < $signed(18'd653)) ? 1'b1 : 1'b0);

assign icmp_ln86_1565_fu_424_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260843)) ? 1'b1 : 1'b0);

assign icmp_ln86_1566_fu_430_p2 = (($signed(x_9_val_int_reg) < $signed(18'd260568)) ? 1'b1 : 1'b0);

assign icmp_ln86_1567_fu_436_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261782)) ? 1'b1 : 1'b0);

assign icmp_ln86_1568_fu_442_p2 = (($signed(x_3_val_int_reg) < $signed(18'd48)) ? 1'b1 : 1'b0);

assign icmp_ln86_1569_fu_448_p2 = (($signed(x_1_val_int_reg) < $signed(18'd785)) ? 1'b1 : 1'b0);

assign icmp_ln86_1570_fu_454_p2 = (($signed(x_15_val_int_reg) < $signed(18'd548)) ? 1'b1 : 1'b0);

assign icmp_ln86_1571_fu_460_p2 = (($signed(x_9_val_int_reg) < $signed(18'd262052)) ? 1'b1 : 1'b0);

assign icmp_ln86_1572_fu_466_p2 = (($signed(x_9_val_int_reg) < $signed(18'd1262)) ? 1'b1 : 1'b0);

assign icmp_ln86_1573_fu_472_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1314)) ? 1'b1 : 1'b0);

assign icmp_ln86_1574_fu_478_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1264)) ? 1'b1 : 1'b0);

assign icmp_ln86_1575_fu_484_p2 = (($signed(x_15_val_int_reg) < $signed(18'd2154)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_304_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261889)) ? 1'b1 : 1'b0);
