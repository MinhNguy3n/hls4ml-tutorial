...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_12_1_1_x24 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x24_U1237(
    .din0(12'd12),
    .din1(12'd968),
    .din2(12'd3941),
    .din3(12'd4060),
...
assign icmp_ln86_58_fu_344_p2 = (($signed(x_3_val_int_reg) < $signed(18'd821)) ? 1'b1 : 1'b0);

assign icmp_ln86_59_fu_350_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260822)) ? 1'b1 : 1'b0);

assign icmp_ln86_60_fu_356_p2 = (($signed(x_14_val_int_reg) < $signed(18'd517)) ? 1'b1 : 1'b0);

assign icmp_ln86_61_fu_362_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1338)) ? 1'b1 : 1'b0);

assign icmp_ln86_62_fu_368_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261275)) ? 1'b1 : 1'b0);

assign icmp_ln86_63_fu_374_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261164)) ? 1'b1 : 1'b0);

assign icmp_ln86_64_fu_380_p2 = (($signed(x_6_val_int_reg) < $signed(18'd261500)) ? 1'b1 : 1'b0);

assign icmp_ln86_65_fu_386_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1270)) ? 1'b1 : 1'b0);

assign icmp_ln86_66_fu_392_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1402)) ? 1'b1 : 1'b0);

assign icmp_ln86_67_fu_398_p2 = (($signed(x_4_val_int_reg) < $signed(18'd459)) ? 1'b1 : 1'b0);

assign icmp_ln86_68_fu_404_p2 = (($signed(x_13_val_int_reg) < $signed(18'd1897)) ? 1'b1 : 1'b0);

assign icmp_ln86_69_fu_410_p2 = (($signed(x_0_val_int_reg) < $signed(18'd262091)) ? 1'b1 : 1'b0);

assign icmp_ln86_70_fu_416_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261078)) ? 1'b1 : 1'b0);

assign icmp_ln86_71_fu_422_p2 = (($signed(x_5_val_int_reg) < $signed(18'd262015)) ? 1'b1 : 1'b0);

assign icmp_ln86_72_fu_428_p2 = (($signed(x_6_val_int_reg) < $signed(18'd261491)) ? 1'b1 : 1'b0);

assign icmp_ln86_73_fu_434_p2 = (($signed(x_11_val_int_reg) < $signed(18'd262095)) ? 1'b1 : 1'b0);

assign icmp_ln86_74_fu_440_p2 = (($signed(x_2_val_int_reg) < $signed(18'd500)) ? 1'b1 : 1'b0);

assign icmp_ln86_75_fu_446_p2 = (($signed(x_2_val_int_reg) < $signed(18'd577)) ? 1'b1 : 1'b0);

assign icmp_ln86_76_fu_452_p2 = (($signed(x_1_val_int_reg) < $signed(18'd260219)) ? 1'b1 : 1'b0);

assign icmp_ln86_77_fu_458_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261919)) ? 1'b1 : 1'b0);

assign icmp_ln86_78_fu_464_p2 = (($signed(x_6_val_int_reg) < $signed(18'd261317)) ? 1'b1 : 1'b0);

assign icmp_ln86_79_fu_470_p2 = (($signed(x_15_val_int_reg) < $signed(18'd265)) ? 1'b1 : 1'b0);

assign icmp_ln86_80_fu_476_p2 = (($signed(x_0_val_int_reg) < $signed(18'd873)) ? 1'b1 : 1'b0);

assign icmp_ln86_81_fu_482_p2 = (($signed(x_11_val_int_reg) < $signed(18'd2333)) ? 1'b1 : 1'b0);

assign icmp_ln86_82_fu_488_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260811)) ? 1'b1 : 1'b0);

assign icmp_ln86_83_fu_494_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1012)) ? 1'b1 : 1'b0);

assign icmp_ln86_84_fu_500_p2 = (($signed(x_12_val_int_reg) < $signed(18'd261188)) ? 1'b1 : 1'b0);

assign icmp_ln86_85_fu_506_p2 = (($signed(x_14_val_int_reg) < $signed(18'd262024)) ? 1'b1 : 1'b0);

assign icmp_ln86_86_fu_512_p2 = (($signed(x_14_val_int_reg) < $signed(18'd204)) ? 1'b1 : 1'b0);

assign icmp_ln86_87_fu_518_p2 = (($signed(x_11_val_int_reg) < $signed(18'd1595)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_338_p2 = (($signed(x_1_val_int_reg) < $signed(18'd260490)) ? 1'b1 : 1'b0);
