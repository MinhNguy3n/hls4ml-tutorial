...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_11_1_1_x13 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 11 ))
sparsemux_65_5_11_1_1_x13_U686(
    .din0(11'd104),
    .din1(11'd2041),
    .din2(11'd518),
    .din3(11'd82),
...
assign icmp_ln86_1311_fu_328_p2 = (($signed(x_15_val_int_reg) < $signed(18'd973)) ? 1'b1 : 1'b0);

assign icmp_ln86_1312_fu_334_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1142)) ? 1'b1 : 1'b0);

assign icmp_ln86_1313_fu_340_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261348)) ? 1'b1 : 1'b0);

assign icmp_ln86_1314_fu_346_p2 = (($signed(x_10_val_int_reg) < $signed(18'd632)) ? 1'b1 : 1'b0);

assign icmp_ln86_1315_fu_352_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1737)) ? 1'b1 : 1'b0);

assign icmp_ln86_1316_fu_358_p2 = (($signed(x_15_val_int_reg) < $signed(18'd832)) ? 1'b1 : 1'b0);

assign icmp_ln86_1317_fu_364_p2 = (($signed(x_1_val_int_reg) < $signed(18'd462)) ? 1'b1 : 1'b0);

assign icmp_ln86_1318_fu_370_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261878)) ? 1'b1 : 1'b0);

assign icmp_ln86_1319_fu_376_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1511)) ? 1'b1 : 1'b0);

assign icmp_ln86_1320_fu_382_p2 = (($signed(x_1_val_int_reg) < $signed(18'd627)) ? 1'b1 : 1'b0);

assign icmp_ln86_1321_fu_388_p2 = (($signed(x_11_val_int_reg) < $signed(18'd929)) ? 1'b1 : 1'b0);

assign icmp_ln86_1322_fu_394_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1624)) ? 1'b1 : 1'b0);

assign icmp_ln86_1323_fu_400_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1370)) ? 1'b1 : 1'b0);

assign icmp_ln86_1324_fu_406_p2 = (($signed(x_12_val_int_reg) < $signed(18'd260410)) ? 1'b1 : 1'b0);

assign icmp_ln86_1325_fu_412_p2 = (($signed(x_14_val_int_reg) < $signed(18'd262035)) ? 1'b1 : 1'b0);

assign icmp_ln86_1326_fu_418_p2 = (($signed(x_6_val_int_reg) < $signed(18'd261700)) ? 1'b1 : 1'b0);

assign icmp_ln86_1327_fu_424_p2 = (($signed(x_14_val_int_reg) < $signed(18'd119)) ? 1'b1 : 1'b0);

assign icmp_ln86_1328_fu_430_p2 = (($signed(x_2_val_int_reg) < $signed(18'd594)) ? 1'b1 : 1'b0);

assign icmp_ln86_1329_fu_436_p2 = (($signed(x_6_val_int_reg) < $signed(18'd40)) ? 1'b1 : 1'b0);

assign icmp_ln86_1330_fu_442_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261024)) ? 1'b1 : 1'b0);

assign icmp_ln86_1331_fu_448_p2 = (($signed(x_3_val_int_reg) < $signed(18'd262110)) ? 1'b1 : 1'b0);

assign icmp_ln86_1332_fu_454_p2 = (($signed(x_3_val_int_reg) < $signed(18'd774)) ? 1'b1 : 1'b0);

assign icmp_ln86_1333_fu_460_p2 = (($signed(x_4_val_int_reg) < $signed(18'd527)) ? 1'b1 : 1'b0);

assign icmp_ln86_1334_fu_466_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2061)) ? 1'b1 : 1'b0);

assign icmp_ln86_1335_fu_472_p2 = (($signed(x_13_val_int_reg) < $signed(18'd1553)) ? 1'b1 : 1'b0);

assign icmp_ln86_1336_fu_478_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1468)) ? 1'b1 : 1'b0);

assign icmp_ln86_1337_fu_484_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1884)) ? 1'b1 : 1'b0);

assign icmp_ln86_1338_fu_490_p2 = (($signed(x_3_val_int_reg) < $signed(18'd2111)) ? 1'b1 : 1'b0);

assign icmp_ln86_1339_fu_496_p2 = (($signed(x_2_val_int_reg) < $signed(18'd2066)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_322_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1000)) ? 1'b1 : 1'b0);
