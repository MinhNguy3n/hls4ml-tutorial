...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_11_1_1_x10 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 11 ))
sparsemux_65_5_11_1_1_x10_U601(
    .din0(11'd9),
    .din1(11'd1976),
    .din2(11'd1808),
    .din3(11'd1999),
...
assign icmp_ln86_1380_fu_340_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261187)) ? 1'b1 : 1'b0);

assign icmp_ln86_1381_fu_346_p2 = (($signed(x_12_val_int_reg) < $signed(18'd124)) ? 1'b1 : 1'b0);

assign icmp_ln86_1382_fu_352_p2 = (($signed(x_4_val_int_reg) < $signed(18'd518)) ? 1'b1 : 1'b0);

assign icmp_ln86_1383_fu_358_p2 = (($signed(x_5_val_int_reg) < $signed(18'd559)) ? 1'b1 : 1'b0);

assign icmp_ln86_1384_fu_364_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1974)) ? 1'b1 : 1'b0);

assign icmp_ln86_1385_fu_370_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1595)) ? 1'b1 : 1'b0);

assign icmp_ln86_1386_fu_376_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261196)) ? 1'b1 : 1'b0);

assign icmp_ln86_1387_fu_382_p2 = (($signed(x_7_val_int_reg) < $signed(18'd261234)) ? 1'b1 : 1'b0);

assign icmp_ln86_1388_fu_388_p2 = (($signed(x_4_val_int_reg) < $signed(18'd261296)) ? 1'b1 : 1'b0);

assign icmp_ln86_1389_fu_394_p2 = (($signed(x_15_val_int_reg) < $signed(18'd501)) ? 1'b1 : 1'b0);

assign icmp_ln86_1390_fu_400_p2 = (($signed(x_12_val_int_reg) < $signed(18'd261608)) ? 1'b1 : 1'b0);

assign icmp_ln86_1391_fu_406_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259200)) ? 1'b1 : 1'b0);

assign icmp_ln86_1392_fu_412_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261054)) ? 1'b1 : 1'b0);

assign icmp_ln86_1393_fu_418_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259928)) ? 1'b1 : 1'b0);

assign icmp_ln86_1394_fu_424_p2 = (($signed(x_7_val_int_reg) < $signed(18'd261167)) ? 1'b1 : 1'b0);

assign icmp_ln86_1395_fu_430_p2 = (($signed(x_6_val_int_reg) < $signed(18'd66)) ? 1'b1 : 1'b0);

assign icmp_ln86_1396_fu_436_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1705)) ? 1'b1 : 1'b0);

assign icmp_ln86_1397_fu_442_p2 = (($signed(x_15_val_int_reg) < $signed(18'd359)) ? 1'b1 : 1'b0);

assign icmp_ln86_1398_fu_448_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261156)) ? 1'b1 : 1'b0);

assign icmp_ln86_1399_fu_454_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260942)) ? 1'b1 : 1'b0);

assign icmp_ln86_1400_fu_460_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1051)) ? 1'b1 : 1'b0);

assign icmp_ln86_1401_fu_466_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2863)) ? 1'b1 : 1'b0);

assign icmp_ln86_1402_fu_472_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1847)) ? 1'b1 : 1'b0);

assign icmp_ln86_1403_fu_478_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261694)) ? 1'b1 : 1'b0);

assign icmp_ln86_1404_fu_484_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259177)) ? 1'b1 : 1'b0);

assign icmp_ln86_1405_fu_490_p2 = (($signed(x_2_val_int_reg) < $signed(18'd260858)) ? 1'b1 : 1'b0);

assign icmp_ln86_1406_fu_496_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1154)) ? 1'b1 : 1'b0);

assign icmp_ln86_1407_fu_502_p2 = (($signed(x_0_val_int_reg) < $signed(18'd628)) ? 1'b1 : 1'b0);

assign icmp_ln86_1408_fu_508_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2142)) ? 1'b1 : 1'b0);

assign icmp_ln86_1409_fu_514_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261133)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_334_p2 = (($signed(x_7_val_int_reg) < $signed(18'd261743)) ? 1'b1 : 1'b0);
