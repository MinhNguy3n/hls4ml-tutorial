...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_63_5_12_1_1_x4 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_63_5_12_1_1_x4_U1141(
    .din0(12'd3650),
    .din1(12'd4080),
    .din2(12'd3933),
    .din3(12'd986),
...
assign icmp_ln86_256_fu_336_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260895)) ? 1'b1 : 1'b0);

assign icmp_ln86_257_fu_342_p2 = (($signed(x_7_val_int_reg) < $signed(18'd2726)) ? 1'b1 : 1'b0);

assign icmp_ln86_258_fu_348_p2 = (($signed(x_2_val_int_reg) < $signed(18'd260969)) ? 1'b1 : 1'b0);

assign icmp_ln86_259_fu_354_p2 = (($signed(x_6_val_int_reg) < $signed(18'd2826)) ? 1'b1 : 1'b0);

assign icmp_ln86_260_fu_360_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261274)) ? 1'b1 : 1'b0);

assign icmp_ln86_261_fu_366_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260933)) ? 1'b1 : 1'b0);

assign icmp_ln86_262_fu_372_p2 = (($signed(x_5_val_int_reg) < $signed(18'd261511)) ? 1'b1 : 1'b0);

assign icmp_ln86_263_fu_378_p2 = (($signed(x_2_val_int_reg) < $signed(18'd261003)) ? 1'b1 : 1'b0);

assign icmp_ln86_264_fu_384_p2 = (($signed(x_11_val_int_reg) < $signed(18'd2283)) ? 1'b1 : 1'b0);

assign icmp_ln86_265_fu_390_p2 = (($signed(x_10_val_int_reg) < $signed(18'd260939)) ? 1'b1 : 1'b0);

assign icmp_ln86_266_fu_396_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260807)) ? 1'b1 : 1'b0);

assign icmp_ln86_267_fu_402_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260802)) ? 1'b1 : 1'b0);

assign icmp_ln86_268_fu_408_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1483)) ? 1'b1 : 1'b0);

assign icmp_ln86_269_fu_414_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261078)) ? 1'b1 : 1'b0);

assign icmp_ln86_270_fu_420_p2 = (($signed(x_7_val_int_reg) < $signed(18'd1326)) ? 1'b1 : 1'b0);

assign icmp_ln86_271_fu_426_p2 = (($signed(x_7_val_int_reg) < $signed(18'd1370)) ? 1'b1 : 1'b0);

assign icmp_ln86_272_fu_432_p2 = (($signed(x_0_val_int_reg) < $signed(18'd817)) ? 1'b1 : 1'b0);

assign icmp_ln86_273_fu_438_p2 = (($signed(x_9_val_int_reg) < $signed(18'd958)) ? 1'b1 : 1'b0);

assign icmp_ln86_274_fu_444_p2 = (($signed(x_10_val_int_reg) < $signed(18'd260534)) ? 1'b1 : 1'b0);

assign icmp_ln86_275_fu_450_p2 = (($signed(x_11_val_int_reg) < $signed(18'd2363)) ? 1'b1 : 1'b0);

assign icmp_ln86_276_fu_456_p2 = (($signed(x_13_val_int_reg) < $signed(18'd358)) ? 1'b1 : 1'b0);

assign icmp_ln86_277_fu_462_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260819)) ? 1'b1 : 1'b0);

assign icmp_ln86_278_fu_468_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260822)) ? 1'b1 : 1'b0);

assign icmp_ln86_279_fu_474_p2 = (($signed(x_12_val_int_reg) < $signed(18'd1740)) ? 1'b1 : 1'b0);

assign icmp_ln86_280_fu_480_p2 = (($signed(x_13_val_int_reg) < $signed(18'd1899)) ? 1'b1 : 1'b0);

assign icmp_ln86_281_fu_486_p2 = (($signed(x_2_val_int_reg) < $signed(18'd260906)) ? 1'b1 : 1'b0);

assign icmp_ln86_282_fu_492_p2 = (($signed(x_7_val_int_reg) < $signed(18'd3367)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_330_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261039)) ? 1'b1 : 1'b0);
