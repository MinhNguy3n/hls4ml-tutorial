...
begin
    sparsemux_61_5_12_1_1_x_U1266 : component my_prj_sparsemux_61_5_12_1_1_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_10_fu_394_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_772)) else "0";
    icmp_ln86_11_fu_400_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_31A)) else "0";
    icmp_ln86_12_fu_406_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_6CA)) else "0";
    icmp_ln86_13_fu_412_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_338)) else "0";
    icmp_ln86_14_fu_418_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FFE1)) else "0";
    icmp_ln86_15_fu_424_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_239)) else "0";
    icmp_ln86_16_fu_430_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_1ED)) else "0";
    icmp_ln86_17_fu_436_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FCEC)) else "0";
    icmp_ln86_18_fu_442_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_13C)) else "0";
    icmp_ln86_19_fu_448_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_546)) else "0";
    icmp_ln86_1_fu_340_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FB42)) else "0";
    icmp_ln86_20_fu_454_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_DD)) else "0";
    icmp_ln86_21_fu_460_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FBEC)) else "0";
    icmp_ln86_22_fu_466_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2A8)) else "0";
    icmp_ln86_23_fu_472_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_658)) else "0";
    icmp_ln86_24_fu_478_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF3B)) else "0";
    icmp_ln86_25_fu_484_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_60)) else "0";
    icmp_ln86_26_fu_490_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_302)) else "0";
    icmp_ln86_27_fu_496_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FF49)) else "0";
    icmp_ln86_28_fu_502_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FBF5)) else "0";
    icmp_ln86_2_fu_346_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FBF0)) else "0";
    icmp_ln86_3_fu_352_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_382)) else "0";
    icmp_ln86_4_fu_358_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_75E)) else "0";
    icmp_ln86_5_fu_364_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FBEC)) else "0";
    icmp_ln86_6_fu_370_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_57C)) else "0";
    icmp_ln86_7_fu_376_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_197)) else "0";
    icmp_ln86_8_fu_382_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FE5A)) else "0";
    icmp_ln86_9_fu_388_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_651)) else "0";
    icmp_ln86_fu_334_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_253)) else "0";
