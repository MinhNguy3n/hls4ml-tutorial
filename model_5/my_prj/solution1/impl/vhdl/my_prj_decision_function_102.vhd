...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_63_5_12_1_1_x9 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_63_5_12_1_1_x9_U1519 : component my_prj_sparsemux_63_5_12_1_1_x9
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_2094_fu_314_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_2095_fu_320_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_92)) else "0";
    icmp_ln86_2096_fu_326_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_2AE)) else "0";
    icmp_ln86_2097_fu_332_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F7C1)) else "0";
    icmp_ln86_2098_fu_338_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F4E6)) else "0";
    icmp_ln86_2099_fu_344_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE87)) else "0";
    icmp_ln86_2100_fu_350_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_D1)) else "0";
    icmp_ln86_2101_fu_356_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FF98)) else "0";
    icmp_ln86_2102_fu_362_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB54)) else "0";
    icmp_ln86_2103_fu_368_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_481)) else "0";
    icmp_ln86_2104_fu_374_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_A38)) else "0";
    icmp_ln86_2105_fu_380_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FA06)) else "0";
    icmp_ln86_2106_fu_386_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_A9)) else "0";
    icmp_ln86_2107_fu_392_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FF60)) else "0";
    icmp_ln86_2108_fu_398_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF50)) else "0";
    icmp_ln86_2109_fu_404_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF3E)) else "0";
    icmp_ln86_2110_fu_410_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_BF)) else "0";
    icmp_ln86_2111_fu_416_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FFD8)) else "0";
    icmp_ln86_2112_fu_422_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_623)) else "0";
    icmp_ln86_2113_fu_428_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FCCA)) else "0";
    icmp_ln86_2114_fu_434_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FAB7)) else "0";
    icmp_ln86_2115_fu_440_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FCD3)) else "0";
    icmp_ln86_2116_fu_446_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3EB36)) else "0";
    icmp_ln86_2117_fu_452_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F4D8)) else "0";
    icmp_ln86_2118_fu_458_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FB1B)) else "0";
    icmp_ln86_2119_fu_464_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_319)) else "0";
    icmp_ln86_2120_fu_470_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_DD)) else "0";
    icmp_ln86_2121_fu_476_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FA5D)) else "0";
    icmp_ln86_2122_fu_482_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3C)) else "0";
    icmp_ln86_fu_308_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_7C5)) else "0";
