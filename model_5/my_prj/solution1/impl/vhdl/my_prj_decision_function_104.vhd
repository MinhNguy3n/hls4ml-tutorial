...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_61_5_12_1_1_x3 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_61_5_12_1_1_x3_U1490 : component my_prj_sparsemux_61_5_12_1_1_x3
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_2041_fu_322_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FB3E)) else "0";
    icmp_ln86_2042_fu_328_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_2043_fu_334_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FB32)) else "0";
    icmp_ln86_2044_fu_340_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_2045_fu_346_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F11E)) else "0";
    icmp_ln86_2046_fu_352_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_2E3)) else "0";
    icmp_ln86_2047_fu_358_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_F4)) else "0";
    icmp_ln86_2048_fu_364_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_81C)) else "0";
    icmp_ln86_2049_fu_370_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FED4)) else "0";
    icmp_ln86_2050_fu_376_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_2BD)) else "0";
    icmp_ln86_2051_fu_382_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F118)) else "0";
    icmp_ln86_2052_fu_388_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_7B8)) else "0";
    icmp_ln86_2053_fu_394_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_852)) else "0";
    icmp_ln86_2054_fu_400_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_81A)) else "0";
    icmp_ln86_2055_fu_406_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FB32)) else "0";
    icmp_ln86_2056_fu_412_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_4C)) else "0";
    icmp_ln86_2057_fu_418_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FA91)) else "0";
    icmp_ln86_2058_fu_424_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FAEA)) else "0";
    icmp_ln86_2059_fu_430_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_290)) else "0";
    icmp_ln86_2060_fu_436_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEC1)) else "0";
    icmp_ln86_2061_fu_442_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FD48)) else "0";
    icmp_ln86_2062_fu_448_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FD67)) else "0";
    icmp_ln86_2063_fu_454_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_A9B)) else "0";
    icmp_ln86_2064_fu_460_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_667)) else "0";
    icmp_ln86_2065_fu_466_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F5F0)) else "0";
    icmp_ln86_2066_fu_472_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3F99B)) else "0";
    icmp_ln86_2067_fu_478_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_68F)) else "0";
    icmp_ln86_2068_fu_484_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3F861)) else "0";
    icmp_ln86_fu_316_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_7B6)) else "0";
