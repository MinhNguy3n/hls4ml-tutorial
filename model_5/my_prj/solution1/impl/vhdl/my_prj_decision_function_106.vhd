...
begin
    sparsemux_61_5_13_1_1_x_U1460 : component my_prj_sparsemux_61_5_13_1_1_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv13_0;
    icmp_ln86_1988_fu_324_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_4CC)) else "0";
    icmp_ln86_1989_fu_330_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_8C8)) else "0";
    icmp_ln86_1990_fu_336_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FF5D)) else "0";
    icmp_ln86_1991_fu_342_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_340)) else "0";
    icmp_ln86_1992_fu_348_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FD23)) else "0";
    icmp_ln86_1993_fu_354_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_74)) else "0";
    icmp_ln86_1994_fu_360_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_144)) else "0";
    icmp_ln86_1995_fu_366_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD81)) else "0";
    icmp_ln86_1996_fu_372_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3C5)) else "0";
    icmp_ln86_1997_fu_378_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_68C)) else "0";
    icmp_ln86_1998_fu_384_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_DE)) else "0";
    icmp_ln86_1999_fu_390_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FFDF)) else "0";
    icmp_ln86_2000_fu_396_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_21)) else "0";
    icmp_ln86_2001_fu_402_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_5)) else "0";
    icmp_ln86_2002_fu_408_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_24A)) else "0";
    icmp_ln86_2003_fu_414_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_379)) else "0";
    icmp_ln86_2004_fu_420_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9A)) else "0";
    icmp_ln86_2005_fu_426_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FE12)) else "0";
    icmp_ln86_2006_fu_432_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FC3F)) else "0";
    icmp_ln86_2007_fu_438_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAD5)) else "0";
    icmp_ln86_2008_fu_444_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_61F)) else "0";
    icmp_ln86_2009_fu_450_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FCDE)) else "0";
    icmp_ln86_2010_fu_456_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF90)) else "0";
    icmp_ln86_2011_fu_462_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FB43)) else "0";
    icmp_ln86_2012_fu_468_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_CC)) else "0";
    icmp_ln86_2013_fu_474_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_17F)) else "0";
    icmp_ln86_2014_fu_480_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_1C1)) else "0";
    icmp_ln86_fu_318_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FC6C)) else "0";
