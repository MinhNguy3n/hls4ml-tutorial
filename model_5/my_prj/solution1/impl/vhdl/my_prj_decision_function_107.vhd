...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_11_1_1_x26 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x26_U1446 : component my_prj_sparsemux_65_5_11_1_1_x26
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1958_fu_342_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_254)) else "0";
    icmp_ln86_1959_fu_348_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1D1)) else "0";
    icmp_ln86_1960_fu_354_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FE2D)) else "0";
    icmp_ln86_1961_fu_360_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_33)) else "0";
    icmp_ln86_1962_fu_366_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FF62)) else "0";
    icmp_ln86_1963_fu_372_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FED5)) else "0";
    icmp_ln86_1964_fu_378_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FDAB)) else "0";
    icmp_ln86_1965_fu_384_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEB7)) else "0";
    icmp_ln86_1966_fu_390_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF05)) else "0";
    icmp_ln86_1967_fu_396_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6E)) else "0";
    icmp_ln86_1968_fu_402_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FB73)) else "0";
    icmp_ln86_1969_fu_408_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF3D)) else "0";
    icmp_ln86_1970_fu_414_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_DA)) else "0";
    icmp_ln86_1971_fu_420_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_5E)) else "0";
    icmp_ln86_1972_fu_426_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FE88)) else "0";
    icmp_ln86_1973_fu_432_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_149)) else "0";
    icmp_ln86_1974_fu_438_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FD)) else "0";
    icmp_ln86_1975_fu_444_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_219)) else "0";
    icmp_ln86_1976_fu_450_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2B2)) else "0";
    icmp_ln86_1977_fu_466_p2 <= "1" when (signed(tmp_fu_456_p4) < signed(ap_const_lv16_1)) else "0";
    icmp_ln86_1978_fu_472_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_15)) else "0";
    icmp_ln86_1979_fu_478_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_324)) else "0";
    icmp_ln86_1980_fu_484_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FDF7)) else "0";
    icmp_ln86_1981_fu_490_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FB78)) else "0";
    icmp_ln86_1982_fu_496_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FF26)) else "0";
    icmp_ln86_1983_fu_502_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_497)) else "0";
    icmp_ln86_1984_fu_508_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_266)) else "0";
    icmp_ln86_1985_fu_514_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1D2)) else "0";
    icmp_ln86_1986_fu_520_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FCFA)) else "0";
    icmp_ln86_1987_fu_526_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FCCA)) else "0";
    icmp_ln86_fu_336_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE1C)) else "0";
    ...
    select_ln117_fu_651_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_456_p4 <= x_14_val_int_reg(17 downto 2);
