...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_11_1_1_x25 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x25_U1374 : component my_prj_sparsemux_65_5_11_1_1_x25
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv11_0;
    icmp_ln86_1752_fu_322_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_871)) else "0";
    icmp_ln86_1753_fu_328_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6F3)) else "0";
    icmp_ln86_1754_fu_334_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_740)) else "0";
    icmp_ln86_1755_fu_340_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_7F4)) else "0";
    icmp_ln86_1756_fu_346_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_39C)) else "0";
    icmp_ln86_1757_fu_352_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_82F)) else "0";
    icmp_ln86_1758_fu_358_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_6DF)) else "0";
    icmp_ln86_1759_fu_364_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_61D)) else "0";
    icmp_ln86_1760_fu_370_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_51B)) else "0";
    icmp_ln86_1761_fu_376_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FB80)) else "0";
    icmp_ln86_1762_fu_382_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_A5C)) else "0";
    icmp_ln86_1763_fu_388_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_8EA)) else "0";
    icmp_ln86_1764_fu_394_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_23)) else "0";
    icmp_ln86_1765_fu_400_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_60A)) else "0";
    icmp_ln86_1766_fu_406_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_5B6)) else "0";
    icmp_ln86_1767_fu_412_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_656)) else "0";
    icmp_ln86_1768_fu_418_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_CA9)) else "0";
    icmp_ln86_1769_fu_424_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_5AB)) else "0";
    icmp_ln86_1770_fu_430_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_177)) else "0";
    icmp_ln86_1771_fu_436_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6D9)) else "0";
    icmp_ln86_1772_fu_442_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_9DE)) else "0";
    icmp_ln86_1773_fu_448_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_283)) else "0";
    icmp_ln86_1774_fu_454_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6C4)) else "0";
    icmp_ln86_1775_fu_460_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_83E)) else "0";
    icmp_ln86_1776_fu_466_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_9C0)) else "0";
    icmp_ln86_1777_fu_472_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_670)) else "0";
    icmp_ln86_1778_fu_478_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FE29)) else "0";
    icmp_ln86_1779_fu_484_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_A92)) else "0";
    icmp_ln86_1780_fu_490_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FE06)) else "0";
    icmp_ln86_1781_fu_496_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_9AE)) else "0";
    icmp_ln86_fu_316_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_983)) else "0";
