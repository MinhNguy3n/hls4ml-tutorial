...
begin
    sparsemux_59_5_12_1_1_x0_U1086 : component my_prj_sparsemux_59_5_12_1_1_x0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_396_fu_326_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_692)) else "0";
    icmp_ln86_397_fu_332_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_77)) else "0";
    icmp_ln86_398_fu_338_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_BAC)) else "0";
    icmp_ln86_399_fu_344_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_77E)) else "0";
    icmp_ln86_400_fu_350_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_38)) else "0";
    icmp_ln86_401_fu_356_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FCC5)) else "0";
    icmp_ln86_402_fu_362_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FBB7)) else "0";
    icmp_ln86_403_fu_368_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FD31)) else "0";
    icmp_ln86_404_fu_374_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FE2F)) else "0";
    icmp_ln86_405_fu_380_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FEAA)) else "0";
    icmp_ln86_406_fu_386_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6B8)) else "0";
    icmp_ln86_407_fu_392_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_6D)) else "0";
    icmp_ln86_408_fu_398_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_619)) else "0";
    icmp_ln86_409_fu_404_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FB61)) else "0";
    icmp_ln86_410_fu_410_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_3FCC4)) else "0";
    icmp_ln86_411_fu_416_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FEBA)) else "0";
    icmp_ln86_412_fu_422_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3D1)) else "0";
    icmp_ln86_413_fu_428_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB3F)) else "0";
    icmp_ln86_414_fu_434_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6A6)) else "0";
    icmp_ln86_415_fu_440_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_24)) else "0";
    icmp_ln86_416_fu_446_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_113)) else "0";
    icmp_ln86_417_fu_452_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FFA9)) else "0";
    icmp_ln86_418_fu_458_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_986)) else "0";
    icmp_ln86_419_fu_464_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3F5)) else "0";
    icmp_ln86_420_fu_470_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_365)) else "0";
    icmp_ln86_421_fu_476_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_34F)) else "0";
    icmp_ln86_422_fu_482_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FFF9)) else "0";
    icmp_ln86_fu_320_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_80C)) else "0";
