...
begin
    sparsemux_61_5_13_1_1_U1058 : component my_prj_sparsemux_61_5_13_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_453_fu_334_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_196)) else "0";
    icmp_ln86_454_fu_340_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD0A)) else "0";
    icmp_ln86_455_fu_346_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_149)) else "0";
    icmp_ln86_456_fu_352_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FF4A)) else "0";
    icmp_ln86_457_fu_358_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FCDA)) else "0";
    icmp_ln86_458_fu_364_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FD72)) else "0";
    icmp_ln86_459_fu_370_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_115)) else "0";
    icmp_ln86_460_fu_376_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FB1D)) else "0";
    icmp_ln86_461_fu_382_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_2E2)) else "0";
    icmp_ln86_462_fu_388_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_5BD)) else "0";
    icmp_ln86_463_fu_394_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FF46)) else "0";
    icmp_ln86_464_fu_400_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD9B)) else "0";
    icmp_ln86_465_fu_406_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_232)) else "0";
    icmp_ln86_466_fu_412_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FF0D)) else "0";
    icmp_ln86_467_fu_418_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_75)) else "0";
    icmp_ln86_468_fu_424_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FD95)) else "0";
    icmp_ln86_469_fu_430_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FE24)) else "0";
    icmp_ln86_470_fu_436_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FB66)) else "0";
    icmp_ln86_471_fu_442_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_1F1)) else "0";
    icmp_ln86_472_fu_448_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FD85)) else "0";
    icmp_ln86_473_fu_454_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_A1)) else "0";
    icmp_ln86_474_fu_460_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_32A)) else "0";
    icmp_ln86_475_fu_466_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FCF0)) else "0";
    icmp_ln86_476_fu_472_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FEA2)) else "0";
    icmp_ln86_477_fu_478_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_4D)) else "0";
    icmp_ln86_478_fu_484_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_B4)) else "0";
    icmp_ln86_479_fu_490_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_AF)) else "0";
    icmp_ln86_fu_328_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_1D)) else "0";
    ...
    select_ln117_fu_688_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_3_fu_496_p4 <= x_11_val_int_reg(17 downto 2);
