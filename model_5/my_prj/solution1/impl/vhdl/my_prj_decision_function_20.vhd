...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_13_1_1_x18 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_13_1_1_x18_U999 : component my_prj_sparsemux_65_5_13_1_1_x18
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_566_fu_332_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAC4)) else "0";
    icmp_ln86_567_fu_338_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAD5)) else "0";
    icmp_ln86_568_fu_344_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FAF4)) else "0";
    icmp_ln86_569_fu_350_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FFE1)) else "0";
    icmp_ln86_570_fu_356_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9C)) else "0";
    icmp_ln86_571_fu_362_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_572_fu_368_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAB9)) else "0";
    icmp_ln86_573_fu_374_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FEBD)) else "0";
    icmp_ln86_574_fu_380_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F957)) else "0";
    icmp_ln86_575_fu_386_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAB8)) else "0";
    icmp_ln86_576_fu_392_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD86)) else "0";
    icmp_ln86_577_fu_398_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FB21)) else "0";
    icmp_ln86_578_fu_404_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAEE)) else "0";
    icmp_ln86_579_fu_410_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD80)) else "0";
    icmp_ln86_580_fu_416_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9A)) else "0";
    icmp_ln86_581_fu_422_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3F80C)) else "0";
    icmp_ln86_582_fu_428_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FF30)) else "0";
    icmp_ln86_583_fu_434_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_677)) else "0";
    icmp_ln86_584_fu_440_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAE6)) else "0";
    icmp_ln86_585_fu_446_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_77)) else "0";
    icmp_ln86_586_fu_452_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_584)) else "0";
    icmp_ln86_587_fu_458_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FEA3)) else "0";
    icmp_ln86_588_fu_464_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_18F)) else "0";
    icmp_ln86_589_fu_470_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAF8)) else "0";
    icmp_ln86_590_fu_476_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_89D)) else "0";
    icmp_ln86_591_fu_482_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB4A)) else "0";
    icmp_ln86_fu_326_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB00)) else "0";
