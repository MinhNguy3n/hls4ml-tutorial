...
begin
    sparsemux_65_5_12_1_1_x_U67 : component my_prj_sparsemux_65_5_12_1_1_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_896_fu_306_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD68)) else "0";
    icmp_ln86_897_fu_312_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_612)) else "0";
    icmp_ln86_898_fu_318_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FEA3)) else "0";
    icmp_ln86_899_fu_324_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_37)) else "0";
    icmp_ln86_900_fu_330_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_85)) else "0";
    icmp_ln86_901_fu_336_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_C4A)) else "0";
    icmp_ln86_902_fu_342_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FD0C)) else "0";
    icmp_ln86_903_fu_348_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FD88)) else "0";
    icmp_ln86_904_fu_354_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF1B)) else "0";
    icmp_ln86_905_fu_360_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FD29)) else "0";
    icmp_ln86_906_fu_366_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_52)) else "0";
    icmp_ln86_907_fu_372_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_19)) else "0";
    icmp_ln86_908_fu_378_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_5C9)) else "0";
    icmp_ln86_909_fu_384_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_81E)) else "0";
    icmp_ln86_910_fu_390_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FCCA)) else "0";
    icmp_ln86_911_fu_396_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FC61)) else "0";
    icmp_ln86_912_fu_402_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAE2)) else "0";
    icmp_ln86_913_fu_408_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FD35)) else "0";
    icmp_ln86_914_fu_414_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE12)) else "0";
    icmp_ln86_915_fu_420_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_18)) else "0";
    icmp_ln86_916_fu_426_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_43)) else "0";
    icmp_ln86_917_fu_432_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FCC1)) else "0";
    icmp_ln86_918_fu_438_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF75)) else "0";
    icmp_ln86_919_fu_444_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF59)) else "0";
    icmp_ln86_920_fu_450_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_BE)) else "0";
    icmp_ln86_921_fu_456_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_78F)) else "0";
    icmp_ln86_922_fu_462_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_367)) else "0";
    icmp_ln86_923_fu_468_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_731)) else "0";
    icmp_ln86_924_fu_474_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_EDF)) else "0";
    icmp_ln86_925_fu_480_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_E52)) else "0";
    icmp_ln86_fu_300_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF45)) else "0";
