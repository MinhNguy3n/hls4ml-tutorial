...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_13_1_1_x14 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_13_1_1_x14_U828 : component my_prj_sparsemux_65_5_13_1_1_x14
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1000_fu_410_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_6AA)) else "0";
    icmp_ln86_1001_fu_416_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_5D3)) else "0";
    icmp_ln86_1002_fu_422_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FD28)) else "0";
    icmp_ln86_1003_fu_428_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_9AA)) else "0";
    icmp_ln86_1004_fu_434_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FEBB)) else "0";
    icmp_ln86_1005_fu_440_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FDC3)) else "0";
    icmp_ln86_1006_fu_446_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_194)) else "0";
    icmp_ln86_1007_fu_452_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCA7)) else "0";
    icmp_ln86_1008_fu_458_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_2FF)) else "0";
    icmp_ln86_1009_fu_464_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_18C4)) else "0";
    icmp_ln86_1010_fu_470_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3C5)) else "0";
    icmp_ln86_1011_fu_476_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD82)) else "0";
    icmp_ln86_1012_fu_482_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_7A)) else "0";
    icmp_ln86_1013_fu_488_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_551)) else "0";
    icmp_ln86_1014_fu_494_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3F563)) else "0";
    icmp_ln86_986_fu_326_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_1CC)) else "0";
    icmp_ln86_987_fu_332_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_765)) else "0";
    icmp_ln86_988_fu_338_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_21F)) else "0";
    icmp_ln86_989_fu_344_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_6EC)) else "0";
    icmp_ln86_990_fu_350_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB7E)) else "0";
    icmp_ln86_991_fu_356_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_B3)) else "0";
    icmp_ln86_992_fu_362_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_47B)) else "0";
    icmp_ln86_993_fu_368_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FDB2)) else "0";
    icmp_ln86_994_fu_374_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_33E)) else "0";
    icmp_ln86_995_fu_380_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_4DC)) else "0";
    icmp_ln86_996_fu_386_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCAC)) else "0";
    icmp_ln86_997_fu_392_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_663)) else "0";
    icmp_ln86_998_fu_398_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FEF4)) else "0";
    icmp_ln86_999_fu_404_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FFBE)) else "0";
    icmp_ln86_fu_320_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_49F)) else "0";
