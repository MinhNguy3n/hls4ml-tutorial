...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_13_1_1_x13 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_13_1_1_x13_U812 : component my_prj_sparsemux_65_5_13_1_1_x13
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1015_fu_350_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_1016_fu_356_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD82)) else "0";
    icmp_ln86_1017_fu_362_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_73E)) else "0";
    icmp_ln86_1018_fu_368_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD83)) else "0";
    icmp_ln86_1019_fu_374_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_16F)) else "0";
    icmp_ln86_1020_fu_380_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3F835)) else "0";
    icmp_ln86_1021_fu_386_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_118)) else "0";
    icmp_ln86_1022_fu_392_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FED2)) else "0";
    icmp_ln86_1023_fu_398_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FADD)) else "0";
    icmp_ln86_1024_fu_404_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_656)) else "0";
    icmp_ln86_1025_fu_410_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_314)) else "0";
    icmp_ln86_1026_fu_416_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_DB)) else "0";
    icmp_ln86_1027_fu_422_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FB9C)) else "0";
    icmp_ln86_1028_fu_428_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_DA)) else "0";
    icmp_ln86_1029_fu_434_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_730)) else "0";
    icmp_ln86_1030_fu_440_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB29)) else "0";
    icmp_ln86_1031_fu_446_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_2E0)) else "0";
    icmp_ln86_1032_fu_452_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_66A)) else "0";
    icmp_ln86_1033_fu_458_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_22E)) else "0";
    icmp_ln86_1034_fu_464_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FBB3)) else "0";
    icmp_ln86_1035_fu_470_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FF82)) else "0";
    icmp_ln86_1036_fu_476_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_334)) else "0";
    icmp_ln86_1037_fu_482_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_57C)) else "0";
    icmp_ln86_1038_fu_488_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_1039_fu_494_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_4A5)) else "0";
    icmp_ln86_1040_fu_500_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FD84)) else "0";
    icmp_ln86_1041_fu_506_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FD26)) else "0";
    icmp_ln86_1042_fu_512_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FD1D)) else "0";
    icmp_ln86_1043_fu_518_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_3FED7)) else "0";
    icmp_ln86_fu_344_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAE3)) else "0";
