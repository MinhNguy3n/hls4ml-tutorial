...
begin
    sparsemux_63_5_12_1_1_x0_U796 : component my_prj_sparsemux_63_5_12_1_1_x0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1044_fu_344_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_497)) else "0";
    icmp_ln86_1045_fu_350_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3F622)) else "0";
    icmp_ln86_1046_fu_356_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_12A)) else "0";
    icmp_ln86_1047_fu_362_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_4B2)) else "0";
    icmp_ln86_1048_fu_368_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_785)) else "0";
    icmp_ln86_1049_fu_374_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FBCA)) else "0";
    icmp_ln86_1050_fu_380_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_B5)) else "0";
    icmp_ln86_1051_fu_386_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_49)) else "0";
    icmp_ln86_1052_fu_392_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_253)) else "0";
    icmp_ln86_1053_fu_398_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_5CA)) else "0";
    icmp_ln86_1054_fu_404_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_7E2)) else "0";
    icmp_ln86_1055_fu_410_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_180)) else "0";
    icmp_ln86_1056_fu_416_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF29)) else "0";
    icmp_ln86_1057_fu_422_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FFB2)) else "0";
    icmp_ln86_1058_fu_428_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FFED)) else "0";
    icmp_ln86_1059_fu_434_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1B)) else "0";
    icmp_ln86_1060_fu_440_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FFD3)) else "0";
    icmp_ln86_1061_fu_446_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_2BF)) else "0";
    icmp_ln86_1062_fu_452_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_2E9)) else "0";
    icmp_ln86_1063_fu_458_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_99)) else "0";
    icmp_ln86_1064_fu_464_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_86A)) else "0";
    icmp_ln86_1065_fu_470_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_6E6)) else "0";
    icmp_ln86_1066_fu_476_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_16)) else "0";
    icmp_ln86_1067_fu_482_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_41F)) else "0";
    icmp_ln86_1068_fu_488_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_1232)) else "0";
    icmp_ln86_1069_fu_494_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FD57)) else "0";
    icmp_ln86_1070_fu_500_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE9E)) else "0";
    icmp_ln86_1071_fu_506_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FEEC)) else "0";
    icmp_ln86_1072_fu_512_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_10A)) else "0";
    icmp_ln86_fu_338_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FE2B)) else "0";
