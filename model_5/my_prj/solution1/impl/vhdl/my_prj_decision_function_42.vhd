...
begin
    sparsemux_65_5_12_1_1_x19_U726 : component my_prj_sparsemux_65_5_12_1_1_x19
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1192_fu_342_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FBAF)) else "0";
    icmp_ln86_1193_fu_348_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3F9BD)) else "0";
    icmp_ln86_1194_fu_354_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3F710)) else "0";
    icmp_ln86_1195_fu_360_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3F981)) else "0";
    icmp_ln86_1196_fu_366_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_672)) else "0";
    icmp_ln86_1197_fu_372_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2E2)) else "0";
    icmp_ln86_1198_fu_378_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3F816)) else "0";
    icmp_ln86_1199_fu_384_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FE7A)) else "0";
    icmp_ln86_1200_fu_390_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FE68)) else "0";
    icmp_ln86_1201_fu_396_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC79)) else "0";
    icmp_ln86_1202_fu_402_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE80)) else "0";
    icmp_ln86_1203_fu_408_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_196)) else "0";
    icmp_ln86_1204_fu_414_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FE3F)) else "0";
    icmp_ln86_1205_fu_420_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3F6F8)) else "0";
    icmp_ln86_1206_fu_426_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FA32)) else "0";
    icmp_ln86_1207_fu_432_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_5B3)) else "0";
    icmp_ln86_1208_fu_438_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_222)) else "0";
    icmp_ln86_1209_fu_444_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAB3)) else "0";
    icmp_ln86_1210_fu_450_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_49A)) else "0";
    icmp_ln86_1211_fu_456_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FB2B)) else "0";
    icmp_ln86_1212_fu_462_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD79)) else "0";
    icmp_ln86_1213_fu_468_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_310)) else "0";
    icmp_ln86_1214_fu_474_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FB21)) else "0";
    icmp_ln86_1215_fu_480_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3F821)) else "0";
    icmp_ln86_1216_fu_486_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3F8D9)) else "0";
    icmp_ln86_1217_fu_492_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FCF5)) else "0";
    icmp_ln86_1218_fu_498_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FF38)) else "0";
    icmp_ln86_1219_fu_504_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC08)) else "0";
    icmp_ln86_1220_fu_510_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FB86)) else "0";
    icmp_ln86_fu_336_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FB50)) else "0";
