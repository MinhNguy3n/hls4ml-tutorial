...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_11_1_1_x13 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x13_U686 : component my_prj_sparsemux_65_5_11_1_1_x13
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1311_fu_328_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3CD)) else "0";
    icmp_ln86_1312_fu_334_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_476)) else "0";
    icmp_ln86_1313_fu_340_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FCE4)) else "0";
    icmp_ln86_1314_fu_346_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_278)) else "0";
    icmp_ln86_1315_fu_352_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6C9)) else "0";
    icmp_ln86_1316_fu_358_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_340)) else "0";
    icmp_ln86_1317_fu_364_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1CE)) else "0";
    icmp_ln86_1318_fu_370_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEF6)) else "0";
    icmp_ln86_1319_fu_376_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_5E7)) else "0";
    icmp_ln86_1320_fu_382_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_273)) else "0";
    icmp_ln86_1321_fu_388_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3A1)) else "0";
    icmp_ln86_1322_fu_394_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_658)) else "0";
    icmp_ln86_1323_fu_400_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_55A)) else "0";
    icmp_ln86_1324_fu_406_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3F93A)) else "0";
    icmp_ln86_1325_fu_412_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF93)) else "0";
    icmp_ln86_1326_fu_418_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_1327_fu_424_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_77)) else "0";
    icmp_ln86_1328_fu_430_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_252)) else "0";
    icmp_ln86_1329_fu_436_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_28)) else "0";
    icmp_ln86_1330_fu_442_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FBA0)) else "0";
    icmp_ln86_1331_fu_448_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FFDE)) else "0";
    icmp_ln86_1332_fu_454_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_306)) else "0";
    icmp_ln86_1333_fu_460_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_20F)) else "0";
    icmp_ln86_1334_fu_466_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_80D)) else "0";
    icmp_ln86_1335_fu_472_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_611)) else "0";
    icmp_ln86_1336_fu_478_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_5BC)) else "0";
    icmp_ln86_1337_fu_484_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_75C)) else "0";
    icmp_ln86_1338_fu_490_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_83F)) else "0";
    icmp_ln86_1339_fu_496_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_812)) else "0";
    icmp_ln86_fu_322_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3E8)) else "0";
