...
begin
    sparsemux_65_5_12_1_1_x17_U643 : component my_prj_sparsemux_65_5_12_1_1_x17
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1398_fu_332_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_491)) else "0";
    icmp_ln86_1399_fu_338_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_278)) else "0";
    icmp_ln86_1400_fu_344_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_BF0)) else "0";
    icmp_ln86_1401_fu_350_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_75B)) else "0";
    icmp_ln86_1402_fu_356_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_A2)) else "0";
    icmp_ln86_1403_fu_362_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FE0B)) else "0";
    icmp_ln86_1404_fu_368_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FEA3)) else "0";
    icmp_ln86_1405_fu_374_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_346)) else "0";
    icmp_ln86_1406_fu_380_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FF36)) else "0";
    icmp_ln86_1407_fu_386_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF60)) else "0";
    icmp_ln86_1408_fu_392_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_12B)) else "0";
    icmp_ln86_1409_fu_398_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FEBC)) else "0";
    icmp_ln86_1410_fu_404_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FDB7)) else "0";
    icmp_ln86_1411_fu_410_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FB80)) else "0";
    icmp_ln86_1412_fu_416_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD87)) else "0";
    icmp_ln86_1413_fu_422_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_216)) else "0";
    icmp_ln86_1414_fu_428_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FF0D)) else "0";
    icmp_ln86_1415_fu_434_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_145)) else "0";
    icmp_ln86_1416_fu_440_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FA01)) else "0";
    icmp_ln86_1417_fu_446_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FC3D)) else "0";
    icmp_ln86_1418_fu_452_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_220)) else "0";
    icmp_ln86_1419_fu_458_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FF68)) else "0";
    icmp_ln86_1420_fu_464_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCA6)) else "0";
    icmp_ln86_1421_fu_470_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FD87)) else "0";
    icmp_ln86_1422_fu_476_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_25C)) else "0";
    icmp_ln86_1423_fu_482_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6F)) else "0";
    icmp_ln86_1424_fu_488_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_363)) else "0";
    icmp_ln86_1425_fu_494_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD59)) else "0";
    icmp_ln86_1426_fu_500_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FD94)) else "0";
    icmp_ln86_1427_fu_506_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FFA9)) else "0";
    icmp_ln86_fu_326_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FC9F)) else "0";
