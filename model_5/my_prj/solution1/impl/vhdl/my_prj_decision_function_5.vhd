...
begin
    sparsemux_63_5_12_1_1_x5_U1195 : component my_prj_sparsemux_63_5_12_1_1_x5
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_141_fu_314_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_146)) else "0";
    icmp_ln86_142_fu_320_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FDA7)) else "0";
    icmp_ln86_143_fu_326_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF63)) else "0";
    icmp_ln86_144_fu_332_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3E)) else "0";
    icmp_ln86_145_fu_338_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FE21)) else "0";
    icmp_ln86_146_fu_344_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FDEB)) else "0";
    icmp_ln86_147_fu_350_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FED7)) else "0";
    icmp_ln86_148_fu_356_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_60)) else "0";
    icmp_ln86_149_fu_362_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_2F3)) else "0";
    icmp_ln86_150_fu_368_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FAB9)) else "0";
    icmp_ln86_151_fu_374_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE90)) else "0";
    icmp_ln86_152_fu_380_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF68)) else "0";
    icmp_ln86_153_fu_386_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FDB4)) else "0";
    icmp_ln86_154_fu_392_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_8E)) else "0";
    icmp_ln86_155_fu_398_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_9D)) else "0";
    icmp_ln86_156_fu_404_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_4DC)) else "0";
    icmp_ln86_157_fu_410_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FDEF)) else "0";
    icmp_ln86_158_fu_416_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_79)) else "0";
    icmp_ln86_159_fu_422_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_A3C)) else "0";
    icmp_ln86_160_fu_428_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FEF9)) else "0";
    icmp_ln86_161_fu_434_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_196)) else "0";
    icmp_ln86_162_fu_440_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_12D)) else "0";
    icmp_ln86_163_fu_446_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD8C)) else "0";
    icmp_ln86_164_fu_452_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_156)) else "0";
    icmp_ln86_165_fu_458_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F814)) else "0";
    icmp_ln86_166_fu_464_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FE1F)) else "0";
    icmp_ln86_167_fu_470_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FDCB)) else "0";
    icmp_ln86_168_fu_476_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF96)) else "0";
    icmp_ln86_169_fu_482_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FC8D)) else "0";
    icmp_ln86_fu_308_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FDB7)) else "0";
