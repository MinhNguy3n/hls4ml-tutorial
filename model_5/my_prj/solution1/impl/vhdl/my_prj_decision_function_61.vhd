...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_11_1_1_x7 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x7_U504 : component my_prj_sparsemux_65_5_11_1_1_x7
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1116_fu_310_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FD64)) else "0";
    icmp_ln86_1117_fu_316_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_1B0)) else "0";
    icmp_ln86_1118_fu_322_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_265)) else "0";
    icmp_ln86_1119_fu_328_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_21F)) else "0";
    icmp_ln86_1120_fu_334_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FD48)) else "0";
    icmp_ln86_1121_fu_340_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FDFD)) else "0";
    icmp_ln86_1122_fu_346_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE5D)) else "0";
    icmp_ln86_1123_fu_352_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_1124_fu_358_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FEA5)) else "0";
    icmp_ln86_1125_fu_364_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_14)) else "0";
    icmp_ln86_1126_fu_370_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FF92)) else "0";
    icmp_ln86_1127_fu_376_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD5B)) else "0";
    icmp_ln86_1128_fu_382_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FEA2)) else "0";
    icmp_ln86_1129_fu_388_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_71F)) else "0";
    icmp_ln86_1130_fu_394_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD90)) else "0";
    icmp_ln86_1131_fu_400_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_2CD)) else "0";
    icmp_ln86_1132_fu_406_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_37)) else "0";
    icmp_ln86_1133_fu_412_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC4D)) else "0";
    icmp_ln86_1134_fu_418_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEA4)) else "0";
    icmp_ln86_1135_fu_424_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_145)) else "0";
    icmp_ln86_1136_fu_430_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_26C)) else "0";
    icmp_ln86_1137_fu_436_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF52)) else "0";
    icmp_ln86_1138_fu_442_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_3FFBD)) else "0";
    icmp_ln86_1139_fu_448_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FCBE)) else "0";
    icmp_ln86_1140_fu_454_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FD55)) else "0";
    icmp_ln86_1141_fu_460_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FFE3)) else "0";
    icmp_ln86_1142_fu_466_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD82)) else "0";
    icmp_ln86_1143_fu_472_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FFEF)) else "0";
    icmp_ln86_1144_fu_478_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FE80)) else "0";
    icmp_ln86_1145_fu_484_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_444)) else "0";
    icmp_ln86_fu_304_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_1F5)) else "0";
