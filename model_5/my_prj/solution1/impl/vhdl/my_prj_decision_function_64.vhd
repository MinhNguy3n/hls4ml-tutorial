...
begin
    sparsemux_65_5_12_1_1_x12_U467 : component my_prj_sparsemux_65_5_12_1_1_x12
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1030_fu_318_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_151)) else "0";
    icmp_ln86_1031_fu_324_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1BD)) else "0";
    icmp_ln86_1032_fu_330_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FED5)) else "0";
    icmp_ln86_1033_fu_336_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FEFC)) else "0";
    icmp_ln86_1034_fu_342_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_1035_fu_348_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_92F)) else "0";
    icmp_ln86_1036_fu_354_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FBE9)) else "0";
    icmp_ln86_1037_fu_360_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FEA3)) else "0";
    icmp_ln86_1038_fu_366_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_5E0)) else "0";
    icmp_ln86_1039_fu_372_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FAAA)) else "0";
    icmp_ln86_1040_fu_378_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_4C)) else "0";
    icmp_ln86_1041_fu_384_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCAA)) else "0";
    icmp_ln86_1042_fu_390_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC31)) else "0";
    icmp_ln86_1043_fu_396_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FB4E)) else "0";
    icmp_ln86_1044_fu_402_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD9D)) else "0";
    icmp_ln86_1045_fu_408_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF09)) else "0";
    icmp_ln86_1046_fu_414_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FC2B)) else "0";
    icmp_ln86_1047_fu_420_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FBB5)) else "0";
    icmp_ln86_1048_fu_426_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6B3)) else "0";
    icmp_ln86_1049_fu_432_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FAD5)) else "0";
    icmp_ln86_1050_fu_438_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FB11)) else "0";
    icmp_ln86_1051_fu_444_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FED3)) else "0";
    icmp_ln86_1052_fu_450_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE78)) else "0";
    icmp_ln86_1053_fu_456_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB3D)) else "0";
    icmp_ln86_1054_fu_462_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF84)) else "0";
    icmp_ln86_1055_fu_468_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FD61)) else "0";
    icmp_ln86_1056_fu_474_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FD5C)) else "0";
    icmp_ln86_1057_fu_480_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FD4A)) else "0";
    icmp_ln86_1058_fu_486_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_20B)) else "0";
    icmp_ln86_fu_312_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FBCD)) else "0";
