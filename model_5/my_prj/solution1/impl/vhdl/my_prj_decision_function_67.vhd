...
begin
    sparsemux_65_5_13_1_1_x8_U442 : component my_prj_sparsemux_65_5_13_1_1_x8
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_942_fu_318_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC78)) else "0";
    icmp_ln86_943_fu_324_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_141)) else "0";
    icmp_ln86_944_fu_330_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_29E)) else "0";
    icmp_ln86_945_fu_336_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE73)) else "0";
    icmp_ln86_946_fu_342_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_43C)) else "0";
    icmp_ln86_947_fu_348_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_7DC)) else "0";
    icmp_ln86_948_fu_354_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_949_fu_360_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_2C)) else "0";
    icmp_ln86_950_fu_366_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_49)) else "0";
    icmp_ln86_951_fu_372_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FC62)) else "0";
    icmp_ln86_952_fu_378_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_518)) else "0";
    icmp_ln86_953_fu_384_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FFF4)) else "0";
    icmp_ln86_954_fu_390_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD68)) else "0";
    icmp_ln86_955_fu_396_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE35)) else "0";
    icmp_ln86_956_fu_402_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FC00)) else "0";
    icmp_ln86_957_fu_408_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_53D)) else "0";
    icmp_ln86_958_fu_414_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF0F)) else "0";
    icmp_ln86_959_fu_420_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6F)) else "0";
    icmp_ln86_960_fu_426_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_142)) else "0";
    icmp_ln86_961_fu_432_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_111)) else "0";
    icmp_ln86_962_fu_438_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF26)) else "0";
    icmp_ln86_963_fu_444_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_5D4)) else "0";
    icmp_ln86_964_fu_450_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_35D)) else "0";
    icmp_ln86_965_fu_456_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_8F7)) else "0";
    icmp_ln86_966_fu_462_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FFCD)) else "0";
    icmp_ln86_967_fu_468_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FC)) else "0";
    icmp_ln86_968_fu_474_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FD93)) else "0";
    icmp_ln86_969_fu_480_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6B)) else "0";
    icmp_ln86_970_fu_486_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_891)) else "0";
    icmp_ln86_971_fu_492_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_196)) else "0";
    icmp_ln86_fu_312_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_310)) else "0";
