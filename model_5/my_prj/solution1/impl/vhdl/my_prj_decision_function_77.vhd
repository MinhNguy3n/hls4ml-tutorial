...
begin
    sparsemux_65_5_11_1_1_x3_U324 : component my_prj_sparsemux_65_5_11_1_1_x3
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_647_fu_334_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_1F5)) else "0";
    icmp_ln86_648_fu_340_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FEAE)) else "0";
    icmp_ln86_649_fu_346_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FDE4)) else "0";
    icmp_ln86_650_fu_352_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FF54)) else "0";
    icmp_ln86_651_fu_358_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_8F5)) else "0";
    icmp_ln86_652_fu_364_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_23B)) else "0";
    icmp_ln86_653_fu_370_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_654_fu_376_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_54)) else "0";
    icmp_ln86_655_fu_382_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FDFE)) else "0";
    icmp_ln86_656_fu_388_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_141)) else "0";
    icmp_ln86_657_fu_394_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_A10)) else "0";
    icmp_ln86_658_fu_400_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_226)) else "0";
    icmp_ln86_659_fu_406_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_DD4)) else "0";
    icmp_ln86_660_fu_412_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FD22)) else "0";
    icmp_ln86_661_fu_418_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_95)) else "0";
    icmp_ln86_662_fu_424_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF93)) else "0";
    icmp_ln86_663_fu_430_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_383)) else "0";
    icmp_ln86_664_fu_436_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FE47)) else "0";
    icmp_ln86_665_fu_442_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FDC5)) else "0";
    icmp_ln86_666_fu_448_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FEA4)) else "0";
    icmp_ln86_667_fu_454_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_135)) else "0";
    icmp_ln86_668_fu_460_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FEFF)) else "0";
    icmp_ln86_669_fu_466_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_19C)) else "0";
    icmp_ln86_670_fu_472_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FFEB)) else "0";
    icmp_ln86_671_fu_478_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_B0B)) else "0";
    icmp_ln86_672_fu_484_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_125)) else "0";
    icmp_ln86_673_fu_490_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_19A)) else "0";
    icmp_ln86_674_fu_496_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_692)) else "0";
    icmp_ln86_675_fu_502_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_C8F)) else "0";
    ...
    select_ln117_fu_653_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_318_p4 <= x_3_val_int_reg(17 downto 8);
