...
begin
    sparsemux_65_5_12_1_1_x3_U219 : component my_prj_sparsemux_65_5_12_1_1_x3
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_379_fu_302_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_49)) else "0";
    icmp_ln86_380_fu_308_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_1EC)) else "0";
    icmp_ln86_381_fu_314_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_AF)) else "0";
    icmp_ln86_382_fu_320_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF4C)) else "0";
    icmp_ln86_383_fu_326_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3CD)) else "0";
    icmp_ln86_384_fu_332_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3D4)) else "0";
    icmp_ln86_385_fu_338_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_9D)) else "0";
    icmp_ln86_386_fu_344_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE73)) else "0";
    icmp_ln86_387_fu_350_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_42C)) else "0";
    icmp_ln86_388_fu_356_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3E5)) else "0";
    icmp_ln86_389_fu_362_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_341)) else "0";
    icmp_ln86_390_fu_368_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6A7)) else "0";
    icmp_ln86_391_fu_374_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_54C)) else "0";
    icmp_ln86_392_fu_380_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_365)) else "0";
    icmp_ln86_393_fu_386_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FDFE)) else "0";
    icmp_ln86_394_fu_392_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_6F0)) else "0";
    icmp_ln86_395_fu_398_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_146)) else "0";
    icmp_ln86_396_fu_404_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF9F)) else "0";
    icmp_ln86_397_fu_410_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF02)) else "0";
    icmp_ln86_398_fu_416_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEFE)) else "0";
    icmp_ln86_399_fu_422_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FFED)) else "0";
    icmp_ln86_400_fu_428_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_675)) else "0";
    icmp_ln86_401_fu_434_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_160)) else "0";
    icmp_ln86_402_fu_440_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_232)) else "0";
    icmp_ln86_403_fu_446_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_172)) else "0";
    icmp_ln86_404_fu_452_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FE8E)) else "0";
    icmp_ln86_405_fu_458_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_26D)) else "0";
    icmp_ln86_406_fu_464_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_255)) else "0";
    icmp_ln86_407_fu_470_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_340)) else "0";
    icmp_ln86_408_fu_476_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_4C2)) else "0";
    icmp_ln86_fu_296_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_295)) else "0";
