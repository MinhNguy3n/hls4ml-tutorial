...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_55_5_11_1_1_x IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_55_5_11_1_1_x_U1604 : component my_prj_sparsemux_55_5_11_1_1_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00001",
    ...
    ap_return <= 
        ...
        ap_const_lv11_0;
    icmp_ln86_119_fu_310_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE72)) else "0";
    icmp_ln86_120_fu_316_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_F6E)) else "0";
    icmp_ln86_121_fu_322_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_257)) else "0";
    icmp_ln86_122_fu_328_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_71C)) else "0";
    icmp_ln86_123_fu_334_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FF75)) else "0";
    icmp_ln86_124_fu_340_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_221)) else "0";
    icmp_ln86_125_fu_346_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FC7D)) else "0";
    icmp_ln86_126_fu_352_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_F5)) else "0";
    icmp_ln86_127_fu_358_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_A2)) else "0";
    icmp_ln86_128_fu_364_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_2DC)) else "0";
    icmp_ln86_129_fu_370_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1EF)) else "0";
    icmp_ln86_130_fu_376_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_DA)) else "0";
    icmp_ln86_131_fu_382_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FDA9)) else "0";
    icmp_ln86_132_fu_388_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FBCD)) else "0";
    icmp_ln86_133_fu_394_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_1C)) else "0";
    icmp_ln86_134_fu_400_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FD21)) else "0";
    icmp_ln86_135_fu_406_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_13B)) else "0";
    icmp_ln86_136_fu_412_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FC8B)) else "0";
    icmp_ln86_137_fu_418_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FC90)) else "0";
    icmp_ln86_138_fu_424_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1DF)) else "0";
    icmp_ln86_139_fu_430_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCCF)) else "0";
    icmp_ln86_140_fu_436_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_66)) else "0";
    icmp_ln86_141_fu_442_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FC39)) else "0";
    icmp_ln86_142_fu_448_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FE6D)) else "0";
    icmp_ln86_143_fu_454_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_31F)) else "0";
    icmp_ln86_fu_304_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_1D)) else "0";
