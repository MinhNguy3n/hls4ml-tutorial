...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_63_5_12_1_1_x7 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 12 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_63_5_12_1_1_x7_U1252(
    .din0(12'd1715),
    .din1(12'd1242),
    .din2(12'd47),
    .din3(12'd10),
...
assign icmp_ln86_29_fu_332_p2 = (($signed(x_15_val_int_reg) < $signed(18'd2012)) ? 1'b1 : 1'b0);

assign icmp_ln86_30_fu_338_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261694)) ? 1'b1 : 1'b0);

assign icmp_ln86_31_fu_344_p2 = (($signed(x_0_val_int_reg) < $signed(18'd316)) ? 1'b1 : 1'b0);

assign icmp_ln86_32_fu_350_p2 = (($signed(x_1_val_int_reg) < $signed(18'd960)) ? 1'b1 : 1'b0);

assign icmp_ln86_33_fu_356_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261340)) ? 1'b1 : 1'b0);

assign icmp_ln86_34_fu_362_p2 = (($signed(x_15_val_int_reg) < $signed(18'd926)) ? 1'b1 : 1'b0);

assign icmp_ln86_35_fu_368_p2 = (($signed(x_1_val_int_reg) < $signed(18'd264)) ? 1'b1 : 1'b0);

assign icmp_ln86_36_fu_374_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261417)) ? 1'b1 : 1'b0);

assign icmp_ln86_37_fu_380_p2 = (($signed(x_10_val_int_reg) < $signed(18'd2152)) ? 1'b1 : 1'b0);

assign icmp_ln86_38_fu_386_p2 = (($signed(x_9_val_int_reg) < $signed(18'd1551)) ? 1'b1 : 1'b0);

assign icmp_ln86_39_fu_392_p2 = (($signed(x_6_val_int_reg) < $signed(18'd2068)) ? 1'b1 : 1'b0);

assign icmp_ln86_40_fu_398_p2 = (($signed(x_7_val_int_reg) < $signed(18'd4434)) ? 1'b1 : 1'b0);

assign icmp_ln86_41_fu_404_p2 = (($signed(x_14_val_int_reg) < $signed(18'd734)) ? 1'b1 : 1'b0);

assign icmp_ln86_42_fu_410_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261590)) ? 1'b1 : 1'b0);

assign icmp_ln86_43_fu_416_p2 = (($signed(x_1_val_int_reg) < $signed(18'd260144)) ? 1'b1 : 1'b0);

assign icmp_ln86_44_fu_422_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261985)) ? 1'b1 : 1'b0);

assign icmp_ln86_45_fu_428_p2 = (($signed(x_13_val_int_reg) < $signed(18'd1135)) ? 1'b1 : 1'b0);

assign icmp_ln86_46_fu_434_p2 = (($signed(x_4_val_int_reg) < $signed(18'd261968)) ? 1'b1 : 1'b0);

assign icmp_ln86_47_fu_440_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261659)) ? 1'b1 : 1'b0);

assign icmp_ln86_48_fu_446_p2 = (($signed(x_1_val_int_reg) < $signed(18'd908)) ? 1'b1 : 1'b0);

assign icmp_ln86_49_fu_452_p2 = (($signed(x_10_val_int_reg) < $signed(18'd1293)) ? 1'b1 : 1'b0);

assign icmp_ln86_50_fu_458_p2 = (($signed(x_1_val_int_reg) < $signed(18'd1030)) ? 1'b1 : 1'b0);

assign icmp_ln86_51_fu_464_p2 = (($signed(x_13_val_int_reg) < $signed(18'd43)) ? 1'b1 : 1'b0);

assign icmp_ln86_52_fu_470_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261560)) ? 1'b1 : 1'b0);

assign icmp_ln86_53_fu_476_p2 = (($signed(x_9_val_int_reg) < $signed(18'd555)) ? 1'b1 : 1'b0);

assign icmp_ln86_54_fu_482_p2 = (($signed(x_6_val_int_reg) < $signed(18'd3769)) ? 1'b1 : 1'b0);

assign icmp_ln86_55_fu_488_p2 = (($signed(x_6_val_int_reg) < $signed(18'd3441)) ? 1'b1 : 1'b0);

assign icmp_ln86_56_fu_494_p2 = (($signed(x_3_val_int_reg) < $signed(18'd715)) ? 1'b1 : 1'b0);

assign icmp_ln86_57_fu_500_p2 = (($signed(x_14_val_int_reg) < $signed(18'd3088)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_326_p2 = (($signed(x_4_val_int_reg) < $signed(18'd1003)) ? 1'b1 : 1'b0);
