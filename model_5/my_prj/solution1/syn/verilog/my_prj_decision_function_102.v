...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_63_5_12_1_1_x9 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 12 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_63_5_12_1_1_x9_U1519(
    .din0(12'd176),
    .din1(12'd16),
    .din2(12'd61),
    .din3(12'd3909),
...
assign icmp_ln86_2094_fu_314_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261275)) ? 1'b1 : 1'b0);

assign icmp_ln86_2095_fu_320_p2 = (($signed(x_14_val_int_reg) < $signed(18'd146)) ? 1'b1 : 1'b0);

assign icmp_ln86_2096_fu_326_p2 = (($signed(x_5_val_int_reg) < $signed(18'd686)) ? 1'b1 : 1'b0);

assign icmp_ln86_2097_fu_332_p2 = (($signed(x_1_val_int_reg) < $signed(18'd260033)) ? 1'b1 : 1'b0);

assign icmp_ln86_2098_fu_338_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259302)) ? 1'b1 : 1'b0);

assign icmp_ln86_2099_fu_344_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261767)) ? 1'b1 : 1'b0);

assign icmp_ln86_2100_fu_350_p2 = (($signed(x_14_val_int_reg) < $signed(18'd209)) ? 1'b1 : 1'b0);

assign icmp_ln86_2101_fu_356_p2 = (($signed(x_2_val_int_reg) < $signed(18'd262040)) ? 1'b1 : 1'b0);

assign icmp_ln86_2102_fu_362_p2 = (($signed(x_2_val_int_reg) < $signed(18'd260948)) ? 1'b1 : 1'b0);

assign icmp_ln86_2103_fu_368_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1153)) ? 1'b1 : 1'b0);

assign icmp_ln86_2104_fu_374_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2616)) ? 1'b1 : 1'b0);

assign icmp_ln86_2105_fu_380_p2 = (($signed(x_15_val_int_reg) < $signed(18'd260614)) ? 1'b1 : 1'b0);

assign icmp_ln86_2106_fu_386_p2 = (($signed(x_14_val_int_reg) < $signed(18'd169)) ? 1'b1 : 1'b0);

assign icmp_ln86_2107_fu_392_p2 = (($signed(x_5_val_int_reg) < $signed(18'd261984)) ? 1'b1 : 1'b0);

assign icmp_ln86_2108_fu_398_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261968)) ? 1'b1 : 1'b0);

assign icmp_ln86_2109_fu_404_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261950)) ? 1'b1 : 1'b0);

assign icmp_ln86_2110_fu_410_p2 = (($signed(x_14_val_int_reg) < $signed(18'd191)) ? 1'b1 : 1'b0);

assign icmp_ln86_2111_fu_416_p2 = (($signed(x_9_val_int_reg) < $signed(18'd262104)) ? 1'b1 : 1'b0);

assign icmp_ln86_2112_fu_422_p2 = (($signed(x_7_val_int_reg) < $signed(18'd1571)) ? 1'b1 : 1'b0);

assign icmp_ln86_2113_fu_428_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261322)) ? 1'b1 : 1'b0);

assign icmp_ln86_2114_fu_434_p2 = (($signed(x_1_val_int_reg) < $signed(18'd260791)) ? 1'b1 : 1'b0);

assign icmp_ln86_2115_fu_440_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261331)) ? 1'b1 : 1'b0);

assign icmp_ln86_2116_fu_446_p2 = (($signed(x_1_val_int_reg) < $signed(18'd256822)) ? 1'b1 : 1'b0);

assign icmp_ln86_2117_fu_452_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259288)) ? 1'b1 : 1'b0);

assign icmp_ln86_2118_fu_458_p2 = (($signed(x_1_val_int_reg) < $signed(18'd260891)) ? 1'b1 : 1'b0);

assign icmp_ln86_2119_fu_464_p2 = (($signed(x_10_val_int_reg) < $signed(18'd793)) ? 1'b1 : 1'b0);

assign icmp_ln86_2120_fu_470_p2 = (($signed(x_14_val_int_reg) < $signed(18'd221)) ? 1'b1 : 1'b0);

assign icmp_ln86_2121_fu_476_p2 = (($signed(x_9_val_int_reg) < $signed(18'd260701)) ? 1'b1 : 1'b0);

assign icmp_ln86_2122_fu_482_p2 = (($signed(x_5_val_int_reg) < $signed(18'd60)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_308_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1989)) ? 1'b1 : 1'b0);
