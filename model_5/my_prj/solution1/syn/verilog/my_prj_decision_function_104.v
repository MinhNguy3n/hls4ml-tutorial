...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_61_5_12_1_1_x3 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 12 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_61_5_12_1_1_x3_U1490(
    .din0(12'd53),
    .din1(12'd3387),
    .din2(12'd0),
    .din3(12'd3997),
...
assign icmp_ln86_2041_fu_322_p2 = (($signed(x_11_val_int_reg) < $signed(18'd260926)) ? 1'b1 : 1'b0);

assign icmp_ln86_2042_fu_328_p2 = (($signed(x_15_val_int_reg) < $signed(18'd170)) ? 1'b1 : 1'b0);

assign icmp_ln86_2043_fu_334_p2 = (($signed(x_10_val_int_reg) < $signed(18'd260914)) ? 1'b1 : 1'b0);

assign icmp_ln86_2044_fu_340_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261700)) ? 1'b1 : 1'b0);

assign icmp_ln86_2045_fu_346_p2 = (($signed(x_1_val_int_reg) < $signed(18'd258334)) ? 1'b1 : 1'b0);

assign icmp_ln86_2046_fu_352_p2 = (($signed(x_4_val_int_reg) < $signed(18'd739)) ? 1'b1 : 1'b0);

assign icmp_ln86_2047_fu_358_p2 = (($signed(x_4_val_int_reg) < $signed(18'd244)) ? 1'b1 : 1'b0);

assign icmp_ln86_2048_fu_364_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2076)) ? 1'b1 : 1'b0);

assign icmp_ln86_2049_fu_370_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261844)) ? 1'b1 : 1'b0);

assign icmp_ln86_2050_fu_376_p2 = (($signed(x_0_val_int_reg) < $signed(18'd701)) ? 1'b1 : 1'b0);

assign icmp_ln86_2051_fu_382_p2 = (($signed(x_1_val_int_reg) < $signed(18'd258328)) ? 1'b1 : 1'b0);

assign icmp_ln86_2052_fu_388_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1976)) ? 1'b1 : 1'b0);

assign icmp_ln86_2053_fu_394_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2130)) ? 1'b1 : 1'b0);

assign icmp_ln86_2054_fu_400_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2074)) ? 1'b1 : 1'b0);

assign icmp_ln86_2055_fu_406_p2 = (($signed(x_7_val_int_reg) < $signed(18'd260914)) ? 1'b1 : 1'b0);

assign icmp_ln86_2056_fu_412_p2 = (($signed(x_5_val_int_reg) < $signed(18'd76)) ? 1'b1 : 1'b0);

assign icmp_ln86_2057_fu_418_p2 = (($signed(x_9_val_int_reg) < $signed(18'd260753)) ? 1'b1 : 1'b0);

assign icmp_ln86_2058_fu_424_p2 = (($signed(x_11_val_int_reg) < $signed(18'd260842)) ? 1'b1 : 1'b0);

assign icmp_ln86_2059_fu_430_p2 = (($signed(x_1_val_int_reg) < $signed(18'd656)) ? 1'b1 : 1'b0);

assign icmp_ln86_2060_fu_436_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261825)) ? 1'b1 : 1'b0);

assign icmp_ln86_2061_fu_442_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261448)) ? 1'b1 : 1'b0);

assign icmp_ln86_2062_fu_448_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261479)) ? 1'b1 : 1'b0);

assign icmp_ln86_2063_fu_454_p2 = (($signed(x_0_val_int_reg) < $signed(18'd2715)) ? 1'b1 : 1'b0);

assign icmp_ln86_2064_fu_460_p2 = (($signed(x_6_val_int_reg) < $signed(18'd1639)) ? 1'b1 : 1'b0);

assign icmp_ln86_2065_fu_466_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259568)) ? 1'b1 : 1'b0);

assign icmp_ln86_2066_fu_472_p2 = (($signed(x_11_val_int_reg) < $signed(18'd260507)) ? 1'b1 : 1'b0);

assign icmp_ln86_2067_fu_478_p2 = (($signed(x_6_val_int_reg) < $signed(18'd1679)) ? 1'b1 : 1'b0);

assign icmp_ln86_2068_fu_484_p2 = (($signed(x_10_val_int_reg) < $signed(18'd260193)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_316_p2 = (($signed(x_0_val_int_reg) < $signed(18'd1974)) ? 1'b1 : 1'b0);
