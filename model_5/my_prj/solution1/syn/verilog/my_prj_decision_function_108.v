...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_61_5_12_1_1_x2 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 12 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_61_5_12_1_1_x2_U1436(
    .din0(12'd167),
    .din1(12'd3370),
    .din2(12'd4092),
    .din3(12'd157),
...
assign icmp_ln86_1930_fu_290_p2 = (($signed(x_14_val_int_reg) < $signed(18'd848)) ? 1'b1 : 1'b0);

assign icmp_ln86_1931_fu_296_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1270)) ? 1'b1 : 1'b0);

assign icmp_ln86_1932_fu_302_p2 = (($signed(x_3_val_int_reg) < $signed(18'd657)) ? 1'b1 : 1'b0);

assign icmp_ln86_1933_fu_308_p2 = (($signed(x_1_val_int_reg) < $signed(18'd71)) ? 1'b1 : 1'b0);

assign icmp_ln86_1934_fu_314_p2 = (($signed(x_3_val_int_reg) < $signed(18'd671)) ? 1'b1 : 1'b0);

assign icmp_ln86_1935_fu_320_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1872)) ? 1'b1 : 1'b0);

assign icmp_ln86_1936_fu_326_p2 = (($signed(x_14_val_int_reg) < $signed(18'd672)) ? 1'b1 : 1'b0);

assign icmp_ln86_1937_fu_332_p2 = (($signed(x_14_val_int_reg) < $signed(18'd547)) ? 1'b1 : 1'b0);

assign icmp_ln86_1938_fu_338_p2 = (($signed(x_2_val_int_reg) < $signed(18'd553)) ? 1'b1 : 1'b0);

assign icmp_ln86_1939_fu_344_p2 = (($signed(x_3_val_int_reg) < $signed(18'd172)) ? 1'b1 : 1'b0);

assign icmp_ln86_1940_fu_350_p2 = (($signed(x_3_val_int_reg) < $signed(18'd629)) ? 1'b1 : 1'b0);

assign icmp_ln86_1941_fu_356_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261727)) ? 1'b1 : 1'b0);

assign icmp_ln86_1942_fu_362_p2 = (($signed(x_1_val_int_reg) < $signed(18'd894)) ? 1'b1 : 1'b0);

assign icmp_ln86_1943_fu_368_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2096)) ? 1'b1 : 1'b0);

assign icmp_ln86_1944_fu_374_p2 = (($signed(x_3_val_int_reg) < $signed(18'd354)) ? 1'b1 : 1'b0);

assign icmp_ln86_1945_fu_380_p2 = (($signed(x_3_val_int_reg) < $signed(18'd542)) ? 1'b1 : 1'b0);

assign icmp_ln86_1946_fu_386_p2 = (($signed(x_12_val_int_reg) < $signed(18'd960)) ? 1'b1 : 1'b0);

assign icmp_ln86_1947_fu_392_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1105)) ? 1'b1 : 1'b0);

assign icmp_ln86_1948_fu_398_p2 = (($signed(x_3_val_int_reg) < $signed(18'd979)) ? 1'b1 : 1'b0);

assign icmp_ln86_1949_fu_404_p2 = (($signed(x_14_val_int_reg) < $signed(18'd927)) ? 1'b1 : 1'b0);

assign icmp_ln86_1950_fu_410_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260552)) ? 1'b1 : 1'b0);

assign icmp_ln86_1951_fu_416_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1641)) ? 1'b1 : 1'b0);

assign icmp_ln86_1952_fu_422_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1921)) ? 1'b1 : 1'b0);

assign icmp_ln86_1953_fu_428_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1292)) ? 1'b1 : 1'b0);

assign icmp_ln86_1954_fu_434_p2 = (($signed(x_3_val_int_reg) < $signed(18'd3771)) ? 1'b1 : 1'b0);

assign icmp_ln86_1955_fu_440_p2 = (($signed(x_5_val_int_reg) < $signed(18'd1552)) ? 1'b1 : 1'b0);

assign icmp_ln86_1956_fu_446_p2 = (($signed(x_3_val_int_reg) < $signed(18'd3173)) ? 1'b1 : 1'b0);

assign icmp_ln86_1957_fu_452_p2 = (($signed(x_11_val_int_reg) < $signed(18'd203)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_284_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1176)) ? 1'b1 : 1'b0);
