...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_59_5_12_1_1_x0 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_59_5_12_1_1_x0_U1086(
    .din0(12'd1542),
    .din1(12'd4092),
    .din2(12'd3998),
    .din3(12'd40),
...
assign icmp_ln86_396_fu_326_p2 = (($signed(x_15_val_int_reg) < $signed(18'd1682)) ? 1'b1 : 1'b0);

assign icmp_ln86_397_fu_332_p2 = (($signed(x_10_val_int_reg) < $signed(18'd119)) ? 1'b1 : 1'b0);

assign icmp_ln86_398_fu_338_p2 = (($signed(x_5_val_int_reg) < $signed(18'd2988)) ? 1'b1 : 1'b0);

assign icmp_ln86_399_fu_344_p2 = (($signed(x_15_val_int_reg) < $signed(18'd1918)) ? 1'b1 : 1'b0);

assign icmp_ln86_400_fu_350_p2 = (($signed(x_7_val_int_reg) < $signed(18'd56)) ? 1'b1 : 1'b0);

assign icmp_ln86_401_fu_356_p2 = (($signed(x_6_val_int_reg) < $signed(18'd261317)) ? 1'b1 : 1'b0);

assign icmp_ln86_402_fu_362_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261047)) ? 1'b1 : 1'b0);

assign icmp_ln86_403_fu_368_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261425)) ? 1'b1 : 1'b0);

assign icmp_ln86_404_fu_374_p2 = (($signed(x_5_val_int_reg) < $signed(18'd261679)) ? 1'b1 : 1'b0);

assign icmp_ln86_405_fu_380_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261802)) ? 1'b1 : 1'b0);

assign icmp_ln86_406_fu_386_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1720)) ? 1'b1 : 1'b0);

assign icmp_ln86_407_fu_392_p2 = (($signed(x_7_val_int_reg) < $signed(18'd109)) ? 1'b1 : 1'b0);

assign icmp_ln86_408_fu_398_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1561)) ? 1'b1 : 1'b0);

assign icmp_ln86_409_fu_404_p2 = (($signed(x_9_val_int_reg) < $signed(18'd260961)) ? 1'b1 : 1'b0);

assign icmp_ln86_410_fu_410_p2 = (($signed(x_13_val_int_reg) < $signed(18'd261316)) ? 1'b1 : 1'b0);

assign icmp_ln86_411_fu_416_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261818)) ? 1'b1 : 1'b0);

assign icmp_ln86_412_fu_422_p2 = (($signed(x_9_val_int_reg) < $signed(18'd977)) ? 1'b1 : 1'b0);

assign icmp_ln86_413_fu_428_p2 = (($signed(x_2_val_int_reg) < $signed(18'd260927)) ? 1'b1 : 1'b0);

assign icmp_ln86_414_fu_434_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1702)) ? 1'b1 : 1'b0);

assign icmp_ln86_415_fu_440_p2 = (($signed(x_2_val_int_reg) < $signed(18'd36)) ? 1'b1 : 1'b0);

assign icmp_ln86_416_fu_446_p2 = (($signed(x_11_val_int_reg) < $signed(18'd275)) ? 1'b1 : 1'b0);

assign icmp_ln86_417_fu_452_p2 = (($signed(x_10_val_int_reg) < $signed(18'd262057)) ? 1'b1 : 1'b0);

assign icmp_ln86_418_fu_458_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2438)) ? 1'b1 : 1'b0);

assign icmp_ln86_419_fu_464_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1013)) ? 1'b1 : 1'b0);

assign icmp_ln86_420_fu_470_p2 = (($signed(x_1_val_int_reg) < $signed(18'd869)) ? 1'b1 : 1'b0);

assign icmp_ln86_421_fu_476_p2 = (($signed(x_14_val_int_reg) < $signed(18'd847)) ? 1'b1 : 1'b0);

assign icmp_ln86_422_fu_482_p2 = (($signed(x_1_val_int_reg) < $signed(18'd262137)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_320_p2 = (($signed(x_15_val_int_reg) < $signed(18'd2060)) ? 1'b1 : 1'b0);
