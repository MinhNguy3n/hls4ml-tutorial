...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_11_1_1_x18 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 11 ))
sparsemux_65_5_11_1_1_x18_U932(
    .din0(11'd1583),
    .din1(11'd1980),
    .din2(11'd1605),
    .din3(11'd232),
...
assign icmp_ln86_737_fu_338_p2 = (($signed(x_0_val_int_reg) < $signed(18'd253)) ? 1'b1 : 1'b0);

assign icmp_ln86_738_fu_344_p2 = (($signed(x_4_val_int_reg) < $signed(18'd261126)) ? 1'b1 : 1'b0);

assign icmp_ln86_739_fu_350_p2 = (($signed(x_5_val_int_reg) < $signed(18'd261509)) ? 1'b1 : 1'b0);

assign icmp_ln86_740_fu_356_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1216)) ? 1'b1 : 1'b0);

assign icmp_ln86_741_fu_362_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260898)) ? 1'b1 : 1'b0);

assign icmp_ln86_742_fu_368_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260940)) ? 1'b1 : 1'b0);

assign icmp_ln86_743_fu_374_p2 = (($signed(x_1_val_int_reg) < $signed(18'd30)) ? 1'b1 : 1'b0);

assign icmp_ln86_744_fu_380_p2 = (($signed(x_1_val_int_reg) < $signed(18'd196)) ? 1'b1 : 1'b0);

assign icmp_ln86_745_fu_386_p2 = (($signed(x_6_val_int_reg) < $signed(18'd803)) ? 1'b1 : 1'b0);

assign icmp_ln86_746_fu_392_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1245)) ? 1'b1 : 1'b0);

assign icmp_ln86_747_fu_398_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261281)) ? 1'b1 : 1'b0);

assign icmp_ln86_748_fu_404_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261288)) ? 1'b1 : 1'b0);

assign icmp_ln86_749_fu_410_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261286)) ? 1'b1 : 1'b0);

assign icmp_ln86_750_fu_416_p2 = (($signed(x_7_val_int_reg) < $signed(18'd90)) ? 1'b1 : 1'b0);

assign icmp_ln86_751_fu_422_p2 = (($signed(x_12_val_int_reg) < $signed(18'd868)) ? 1'b1 : 1'b0);

assign icmp_ln86_752_fu_428_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261370)) ? 1'b1 : 1'b0);

assign icmp_ln86_753_fu_434_p2 = (($signed(x_12_val_int_reg) < $signed(18'd260984)) ? 1'b1 : 1'b0);

assign icmp_ln86_754_fu_440_p2 = (($signed(x_5_val_int_reg) < $signed(18'd261998)) ? 1'b1 : 1'b0);

assign icmp_ln86_755_fu_446_p2 = (($signed(x_7_val_int_reg) < $signed(18'd2140)) ? 1'b1 : 1'b0);

assign icmp_ln86_756_fu_452_p2 = (($signed(x_10_val_int_reg) < $signed(18'd260170)) ? 1'b1 : 1'b0);

assign icmp_ln86_757_fu_458_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1538)) ? 1'b1 : 1'b0);

assign icmp_ln86_758_fu_464_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260843)) ? 1'b1 : 1'b0);

assign icmp_ln86_759_fu_470_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260872)) ? 1'b1 : 1'b0);

assign icmp_ln86_760_fu_476_p2 = (($signed(x_4_val_int_reg) < $signed(18'd261010)) ? 1'b1 : 1'b0);

assign icmp_ln86_761_fu_482_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260954)) ? 1'b1 : 1'b0);

assign icmp_ln86_762_fu_488_p2 = (($signed(x_9_val_int_reg) < $signed(18'd1526)) ? 1'b1 : 1'b0);

assign icmp_ln86_763_fu_494_p2 = (($signed(x_15_val_int_reg) < $signed(18'd170)) ? 1'b1 : 1'b0);

assign icmp_ln86_764_fu_500_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260986)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_332_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261559)) ? 1'b1 : 1'b0);
