...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_11_1_1_x17 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 11 ))
sparsemux_65_5_11_1_1_x17_U867(
    .din0(11'd7),
    .din1(11'd1911),
    .din2(11'd447),
    .din3(11'd212),
...
assign icmp_ln86_866_fu_296_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261161)) ? 1'b1 : 1'b0);

assign icmp_ln86_867_fu_302_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261481)) ? 1'b1 : 1'b0);

assign icmp_ln86_868_fu_308_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261314)) ? 1'b1 : 1'b0);

assign icmp_ln86_869_fu_314_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261326)) ? 1'b1 : 1'b0);

assign icmp_ln86_870_fu_320_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261474)) ? 1'b1 : 1'b0);

assign icmp_ln86_871_fu_326_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261436)) ? 1'b1 : 1'b0);

assign icmp_ln86_872_fu_332_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261109)) ? 1'b1 : 1'b0);

assign icmp_ln86_873_fu_338_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261079)) ? 1'b1 : 1'b0);

assign icmp_ln86_874_fu_344_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261176)) ? 1'b1 : 1'b0);

assign icmp_ln86_875_fu_350_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261243)) ? 1'b1 : 1'b0);

assign icmp_ln86_876_fu_356_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261390)) ? 1'b1 : 1'b0);

assign icmp_ln86_877_fu_362_p2 = (($signed(x_15_val_int_reg) < $signed(18'd1115)) ? 1'b1 : 1'b0);

assign icmp_ln86_878_fu_368_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261419)) ? 1'b1 : 1'b0);

assign icmp_ln86_879_fu_374_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261585)) ? 1'b1 : 1'b0);

assign icmp_ln86_880_fu_380_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261300)) ? 1'b1 : 1'b0);

assign icmp_ln86_881_fu_386_p2 = (($signed(x_4_val_int_reg) < $signed(18'd261318)) ? 1'b1 : 1'b0);

assign icmp_ln86_882_fu_392_p2 = (($signed(x_15_val_int_reg) < $signed(18'd359)) ? 1'b1 : 1'b0);

assign icmp_ln86_883_fu_398_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261345)) ? 1'b1 : 1'b0);

assign icmp_ln86_884_fu_404_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261317)) ? 1'b1 : 1'b0);

assign icmp_ln86_885_fu_410_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261757)) ? 1'b1 : 1'b0);

assign icmp_ln86_886_fu_416_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261337)) ? 1'b1 : 1'b0);

assign icmp_ln86_887_fu_422_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261348)) ? 1'b1 : 1'b0);

assign icmp_ln86_888_fu_428_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261350)) ? 1'b1 : 1'b0);

assign icmp_ln86_889_fu_434_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261307)) ? 1'b1 : 1'b0);

assign icmp_ln86_890_fu_440_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261449)) ? 1'b1 : 1'b0);

assign icmp_ln86_891_fu_446_p2 = (($signed(x_12_val_int_reg) < $signed(18'd733)) ? 1'b1 : 1'b0);

assign icmp_ln86_892_fu_452_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261730)) ? 1'b1 : 1'b0);

assign icmp_ln86_893_fu_458_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261433)) ? 1'b1 : 1'b0);

assign icmp_ln86_894_fu_464_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261569)) ? 1'b1 : 1'b0);

assign icmp_ln86_895_fu_470_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261483)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_290_p2 = (($signed(x_4_val_int_reg) < $signed(18'd261559)) ? 1'b1 : 1'b0);
