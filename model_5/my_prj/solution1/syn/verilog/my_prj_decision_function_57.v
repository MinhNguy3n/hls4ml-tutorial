...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_12_1_1_x16 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x16_U550(
    .din0(12'd3888),
    .din1(12'd49),
    .din2(12'd3861),
    .din3(12'd41),
...
assign icmp_ln86_1235_fu_326_p2 = (($signed(x_11_val_int_reg) < $signed(18'd260916)) ? 1'b1 : 1'b0);

assign icmp_ln86_1236_fu_332_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261874)) ? 1'b1 : 1'b0);

assign icmp_ln86_1237_fu_338_p2 = (($signed(x_15_val_int_reg) < $signed(18'd261322)) ? 1'b1 : 1'b0);

assign icmp_ln86_1238_fu_344_p2 = (($signed(x_14_val_int_reg) < $signed(18'd195)) ? 1'b1 : 1'b0);

assign icmp_ln86_1239_fu_350_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261641)) ? 1'b1 : 1'b0);

assign icmp_ln86_1240_fu_356_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261720)) ? 1'b1 : 1'b0);

assign icmp_ln86_1241_fu_362_p2 = (($signed(x_14_val_int_reg) < $signed(18'd151)) ? 1'b1 : 1'b0);

assign icmp_ln86_1242_fu_368_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261989)) ? 1'b1 : 1'b0);

assign icmp_ln86_1243_fu_374_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261268)) ? 1'b1 : 1'b0);

assign icmp_ln86_1244_fu_380_p2 = (($signed(x_15_val_int_reg) < $signed(18'd262031)) ? 1'b1 : 1'b0);

assign icmp_ln86_1245_fu_386_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261727)) ? 1'b1 : 1'b0);

assign icmp_ln86_1246_fu_392_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261907)) ? 1'b1 : 1'b0);

assign icmp_ln86_1247_fu_398_p2 = (($signed(x_14_val_int_reg) < $signed(18'd47)) ? 1'b1 : 1'b0);

assign icmp_ln86_1248_fu_404_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261964)) ? 1'b1 : 1'b0);

assign icmp_ln86_1249_fu_410_p2 = (($signed(x_2_val_int_reg) < $signed(18'd261810)) ? 1'b1 : 1'b0);

assign icmp_ln86_1250_fu_426_p2 = (($signed(tmp_fu_416_p4) < $signed(12'd1)) ? 1'b1 : 1'b0);

assign icmp_ln86_1251_fu_432_p2 = (($signed(x_1_val_int_reg) < $signed(18'd260359)) ? 1'b1 : 1'b0);

assign icmp_ln86_1252_fu_438_p2 = (($signed(x_11_val_int_reg) < $signed(18'd260717)) ? 1'b1 : 1'b0);

assign icmp_ln86_1253_fu_444_p2 = (($signed(x_12_val_int_reg) < $signed(18'd261133)) ? 1'b1 : 1'b0);

assign icmp_ln86_1254_fu_450_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261474)) ? 1'b1 : 1'b0);

assign icmp_ln86_1255_fu_456_p2 = (($signed(x_3_val_int_reg) < $signed(18'd333)) ? 1'b1 : 1'b0);

assign icmp_ln86_1256_fu_462_p2 = (($signed(x_2_val_int_reg) < $signed(18'd404)) ? 1'b1 : 1'b0);

assign icmp_ln86_1257_fu_468_p2 = (($signed(x_2_val_int_reg) < $signed(18'd261573)) ? 1'b1 : 1'b0);

assign icmp_ln86_1258_fu_474_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261565)) ? 1'b1 : 1'b0);

assign icmp_ln86_1259_fu_480_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261691)) ? 1'b1 : 1'b0);

assign icmp_ln86_1260_fu_486_p2 = (($signed(x_12_val_int_reg) < $signed(18'd261682)) ? 1'b1 : 1'b0);

assign icmp_ln86_1261_fu_492_p2 = (($signed(x_1_val_int_reg) < $signed(18'd257)) ? 1'b1 : 1'b0);

assign icmp_ln86_1262_fu_498_p2 = (($signed(x_4_val_int_reg) < $signed(18'd261977)) ? 1'b1 : 1'b0);

assign icmp_ln86_1263_fu_504_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261937)) ? 1'b1 : 1'b0);

assign icmp_ln86_1264_fu_510_p2 = (($signed(x_6_val_int_reg) < $signed(18'd262001)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_320_p2 = (($signed(x_5_val_int_reg) < $signed(18'd261713)) ? 1'b1 : 1'b0);
...
assign tmp_fu_416_p4 = {{x_3_val_int_reg[17:6]}};
