...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_12_1_1_x14 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x14_U515(
    .din0(12'd848),
    .din1(12'd289),
    .din2(12'd432),
    .din3(12'd41),
...
assign icmp_ln86_1146_fu_312_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261260)) ? 1'b1 : 1'b0);

assign icmp_ln86_1147_fu_318_p2 = (($signed(x_11_val_int_reg) < $signed(18'd262138)) ? 1'b1 : 1'b0);

assign icmp_ln86_1148_fu_324_p2 = (($signed(x_1_val_int_reg) < $signed(18'd745)) ? 1'b1 : 1'b0);

assign icmp_ln86_1149_fu_330_p2 = (($signed(x_15_val_int_reg) < $signed(18'd262078)) ? 1'b1 : 1'b0);

assign icmp_ln86_1150_fu_336_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261374)) ? 1'b1 : 1'b0);

assign icmp_ln86_1151_fu_342_p2 = (($signed(x_2_val_int_reg) < $signed(18'd261273)) ? 1'b1 : 1'b0);

assign icmp_ln86_1152_fu_348_p2 = (($signed(x_15_val_int_reg) < $signed(18'd595)) ? 1'b1 : 1'b0);

assign icmp_ln86_1153_fu_354_p2 = (($signed(x_14_val_int_reg) < $signed(18'd250)) ? 1'b1 : 1'b0);

assign icmp_ln86_1154_fu_360_p2 = (($signed(x_0_val_int_reg) < $signed(18'd90)) ? 1'b1 : 1'b0);

assign icmp_ln86_1155_fu_366_p2 = (($signed(x_3_val_int_reg) < $signed(18'd262020)) ? 1'b1 : 1'b0);

assign icmp_ln86_1156_fu_372_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261695)) ? 1'b1 : 1'b0);

assign icmp_ln86_1157_fu_378_p2 = (($signed(x_12_val_int_reg) < $signed(18'd261726)) ? 1'b1 : 1'b0);

assign icmp_ln86_1158_fu_384_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261134)) ? 1'b1 : 1'b0);

assign icmp_ln86_1159_fu_400_p2 = (($signed(tmp_fu_390_p4) < $signed(17'd1)) ? 1'b1 : 1'b0);

assign icmp_ln86_1160_fu_406_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261202)) ? 1'b1 : 1'b0);

assign icmp_ln86_1161_fu_412_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261114)) ? 1'b1 : 1'b0);

assign icmp_ln86_1162_fu_418_p2 = (($signed(x_1_val_int_reg) < $signed(18'd810)) ? 1'b1 : 1'b0);

assign icmp_ln86_1163_fu_424_p2 = (($signed(x_14_val_int_reg) < $signed(18'd356)) ? 1'b1 : 1'b0);

assign icmp_ln86_1164_fu_430_p2 = (($signed(x_1_val_int_reg) < $signed(18'd358)) ? 1'b1 : 1'b0);

assign icmp_ln86_1165_fu_436_p2 = (($signed(x_1_val_int_reg) < $signed(18'd130)) ? 1'b1 : 1'b0);

assign icmp_ln86_1166_fu_442_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261557)) ? 1'b1 : 1'b0);

assign icmp_ln86_1167_fu_448_p2 = (($signed(x_10_val_int_reg) < $signed(18'd261580)) ? 1'b1 : 1'b0);

assign icmp_ln86_1168_fu_454_p2 = (($signed(x_10_val_int_reg) < $signed(18'd258)) ? 1'b1 : 1'b0);

assign icmp_ln86_1169_fu_460_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261525)) ? 1'b1 : 1'b0);

assign icmp_ln86_1170_fu_466_p2 = (($signed(x_10_val_int_reg) < $signed(18'd261968)) ? 1'b1 : 1'b0);

assign icmp_ln86_1171_fu_472_p2 = (($signed(x_15_val_int_reg) < $signed(18'd1446)) ? 1'b1 : 1'b0);

assign icmp_ln86_1172_fu_478_p2 = (($signed(x_1_val_int_reg) < $signed(18'd262)) ? 1'b1 : 1'b0);

assign icmp_ln86_1173_fu_484_p2 = (($signed(x_14_val_int_reg) < $signed(18'd260798)) ? 1'b1 : 1'b0);

assign icmp_ln86_1174_fu_490_p2 = (($signed(x_15_val_int_reg) < $signed(18'd2107)) ? 1'b1 : 1'b0);

assign icmp_ln86_1175_fu_496_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2251)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_306_p2 = (($signed(x_15_val_int_reg) < $signed(18'd879)) ? 1'b1 : 1'b0);
...
assign tmp_fu_390_p4 = {{x_3_val_int_reg[17:1]}};
