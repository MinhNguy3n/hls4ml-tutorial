...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_13_1_1_x10 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 13 ))
sparsemux_65_5_13_1_1_x10_U493(
    .din0(13'd10),
    .din1(13'd7996),
    .din2(13'd526),
    .din3(13'd23),
...
assign icmp_ln86_1088_fu_314_p2 = (($signed(x_3_val_int_reg) < $signed(18'd262054)) ? 1'b1 : 1'b0);

assign icmp_ln86_1089_fu_320_p2 = (($signed(x_3_val_int_reg) < $signed(18'd481)) ? 1'b1 : 1'b0);

assign icmp_ln86_1090_fu_326_p2 = (($signed(x_14_val_int_reg) < $signed(18'd127)) ? 1'b1 : 1'b0);

assign icmp_ln86_1091_fu_332_p2 = (($signed(x_3_val_int_reg) < $signed(18'd679)) ? 1'b1 : 1'b0);

assign icmp_ln86_1092_fu_338_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1035)) ? 1'b1 : 1'b0);

assign icmp_ln86_1093_fu_344_p2 = (($signed(x_14_val_int_reg) < $signed(18'd732)) ? 1'b1 : 1'b0);

assign icmp_ln86_1094_fu_350_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261818)) ? 1'b1 : 1'b0);

assign icmp_ln86_1095_fu_356_p2 = (($signed(x_9_val_int_reg) < $signed(18'd261422)) ? 1'b1 : 1'b0);

assign icmp_ln86_1096_fu_372_p2 = (($signed(tmp_fu_362_p4) < $signed(10'd1)) ? 1'b1 : 1'b0);

assign icmp_ln86_1097_fu_378_p2 = (($signed(x_14_val_int_reg) < $signed(18'd367)) ? 1'b1 : 1'b0);

assign icmp_ln86_1098_fu_384_p2 = (($signed(x_15_val_int_reg) < $signed(18'd926)) ? 1'b1 : 1'b0);

assign icmp_ln86_1099_fu_390_p2 = (($signed(x_3_val_int_reg) < $signed(18'd209)) ? 1'b1 : 1'b0);

assign icmp_ln86_1100_fu_396_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1106)) ? 1'b1 : 1'b0);

assign icmp_ln86_1101_fu_402_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1102)) ? 1'b1 : 1'b0);

assign icmp_ln86_1102_fu_408_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261942)) ? 1'b1 : 1'b0);

assign icmp_ln86_1103_fu_414_p2 = (($signed(x_14_val_int_reg) < $signed(18'd262064)) ? 1'b1 : 1'b0);

assign icmp_ln86_1104_fu_420_p2 = (($signed(x_15_val_int_reg) < $signed(18'd262078)) ? 1'b1 : 1'b0);

assign icmp_ln86_1105_fu_426_p2 = (($signed(x_15_val_int_reg) < $signed(18'd312)) ? 1'b1 : 1'b0);

assign icmp_ln86_1106_fu_432_p2 = (($signed(x_14_val_int_reg) < $signed(18'd403)) ? 1'b1 : 1'b0);

assign icmp_ln86_1107_fu_438_p2 = (($signed(x_14_val_int_reg) < $signed(18'd144)) ? 1'b1 : 1'b0);

assign icmp_ln86_1108_fu_444_p2 = (($signed(x_0_val_int_reg) < $signed(18'd261784)) ? 1'b1 : 1'b0);

assign icmp_ln86_1109_fu_450_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1136)) ? 1'b1 : 1'b0);

assign icmp_ln86_1110_fu_456_p2 = (($signed(x_12_val_int_reg) < $signed(18'd260891)) ? 1'b1 : 1'b0);

assign icmp_ln86_1111_fu_462_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261747)) ? 1'b1 : 1'b0);

assign icmp_ln86_1112_fu_468_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261356)) ? 1'b1 : 1'b0);

assign icmp_ln86_1113_fu_474_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1450)) ? 1'b1 : 1'b0);

assign icmp_ln86_1114_fu_480_p2 = (($signed(x_6_val_int_reg) < $signed(18'd668)) ? 1'b1 : 1'b0);

assign icmp_ln86_1115_fu_486_p2 = (($signed(x_15_val_int_reg) < $signed(18'd879)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_308_p2 = (($signed(x_14_val_int_reg) < $signed(18'd562)) ? 1'b1 : 1'b0);
...
assign tmp_fu_362_p4 = {{x_3_val_int_reg[17:8]}};
