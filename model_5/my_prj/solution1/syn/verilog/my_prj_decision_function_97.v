...
reg   [17:0] x_1_val_read_reg_1317;
wire    ap_block_pp0_stage0_11001;
reg   [17:0] x_1_val_read_reg_1317_pp0_iter1_reg;
reg   [17:0] x_1_val_read_reg_1317_pp0_iter2_reg;
...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_63_5_12_1_1_x10 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 12 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_63_5_12_1_1_x10_U1577(
    .din0(12'd1663),
    .din1(12'd191),
    .din2(12'd4092),
    .din3(12'd4033),
...
assign icmp_ln86_61_fu_328_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260523)) ? 1'b1 : 1'b0);

assign icmp_ln86_62_fu_334_p2 = (($signed(x_6_val_int_reg) < $signed(18'd9)) ? 1'b1 : 1'b0);

assign icmp_ln86_63_fu_340_p2 = (($signed(x_6_val_int_reg) < $signed(18'd129)) ? 1'b1 : 1'b0);

assign icmp_ln86_64_fu_346_p2 = (($signed(x_7_val_int_reg) < $signed(18'd1943)) ? 1'b1 : 1'b0);

assign icmp_ln86_65_fu_352_p2 = (($signed(x_1_val_int_reg) < $signed(18'd908)) ? 1'b1 : 1'b0);

assign icmp_ln86_66_fu_358_p2 = (($signed(x_9_val_int_reg) < $signed(18'd1252)) ? 1'b1 : 1'b0);

assign icmp_ln86_67_fu_364_p2 = (($signed(x_7_val_int_reg) < $signed(18'd261809)) ? 1'b1 : 1'b0);

assign icmp_ln86_68_fu_370_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1583)) ? 1'b1 : 1'b0);

assign icmp_ln86_69_fu_376_p2 = (($signed(x_6_val_int_reg) < $signed(18'd1023)) ? 1'b1 : 1'b0);

assign icmp_ln86_70_fu_382_p2 = (($signed(x_6_val_int_reg) < $signed(18'd3764)) ? 1'b1 : 1'b0);

assign icmp_ln86_71_fu_398_p2 = (($signed(tmp_fu_388_p4) < $signed(15'd1)) ? 1'b1 : 1'b0);

assign icmp_ln86_72_fu_404_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2007)) ? 1'b1 : 1'b0);

assign icmp_ln86_73_fu_410_p2 = (($signed(x_14_val_int_reg) < $signed(18'd196)) ? 1'b1 : 1'b0);

assign icmp_ln86_74_fu_416_p2 = (($signed(x_9_val_int_reg) < $signed(18'd1253)) ? 1'b1 : 1'b0);

assign icmp_ln86_75_fu_422_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1339)) ? 1'b1 : 1'b0);

assign icmp_ln86_76_fu_428_p2 = (($signed(x_11_val_int_reg) < $signed(18'd1309)) ? 1'b1 : 1'b0);

assign icmp_ln86_77_fu_434_p2 = (($signed(x_15_val_int_reg) < $signed(18'd3004)) ? 1'b1 : 1'b0);

assign icmp_ln86_78_fu_544_p2 = (($signed(x_1_val_read_reg_1317_pp0_iter1_reg) < $signed(18'd869)) ? 1'b1 : 1'b0);

assign icmp_ln86_79_fu_440_p2 = (($signed(x_7_val_int_reg) < $signed(18'd994)) ? 1'b1 : 1'b0);

assign icmp_ln86_80_fu_446_p2 = (($signed(x_7_val_int_reg) < $signed(18'd3437)) ? 1'b1 : 1'b0);

assign icmp_ln86_81_fu_452_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261553)) ? 1'b1 : 1'b0);

assign icmp_ln86_82_fu_691_p2 = (($signed(x_1_val_read_reg_1317_pp0_iter2_reg) < $signed(18'd885)) ? 1'b1 : 1'b0);

assign icmp_ln86_83_fu_458_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1632)) ? 1'b1 : 1'b0);

assign icmp_ln86_84_fu_464_p2 = (($signed(x_3_val_int_reg) < $signed(18'd3694)) ? 1'b1 : 1'b0);

assign icmp_ln86_85_fu_470_p2 = (($signed(x_11_val_int_reg) < $signed(18'd1540)) ? 1'b1 : 1'b0);

assign icmp_ln86_86_fu_476_p2 = (($signed(x_0_val_int_reg) < $signed(18'd260307)) ? 1'b1 : 1'b0);

assign icmp_ln86_87_fu_482_p2 = (($signed(x_11_val_int_reg) < $signed(18'd906)) ? 1'b1 : 1'b0);

assign icmp_ln86_88_fu_488_p2 = (($signed(x_12_val_int_reg) < $signed(18'd1051)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_322_p2 = (($signed(x_12_val_int_reg) < $signed(18'd1041)) ? 1'b1 : 1'b0);
...
assign tmp_1_fu_684_p3 = x_1_val_read_reg_1317_pp0_iter2_reg[32'd17];

assign tmp_fu_388_p4 = {{x_6_val_int_reg[17:3]}};
