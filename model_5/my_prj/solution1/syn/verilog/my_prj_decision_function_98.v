...
(* dissolve_hierarchy = "yes" *) my_prj_sparsemux_65_5_11_1_1_x29 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 11 ))
sparsemux_65_5_11_1_1_x29_U1561(
    .din0(11'd1),
    .din1(11'd1972),
    .din2(11'd1862),
    .din3(11'd213),
...
assign icmp_ln86_31_fu_350_p2 = (($signed(x_6_val_int_reg) < $signed(18'd379)) ? 1'b1 : 1'b0);

assign icmp_ln86_32_fu_356_p2 = (($signed(x_12_val_int_reg) < $signed(18'd1242)) ? 1'b1 : 1'b0);

assign icmp_ln86_33_fu_362_p2 = (($signed(x_15_val_int_reg) < $signed(18'd1918)) ? 1'b1 : 1'b0);

assign icmp_ln86_34_fu_368_p2 = (($signed(x_4_val_int_reg) < $signed(18'd1515)) ? 1'b1 : 1'b0);

assign icmp_ln86_35_fu_374_p2 = (($signed(x_0_val_int_reg) < $signed(18'd851)) ? 1'b1 : 1'b0);

assign icmp_ln86_36_fu_380_p2 = (($signed(x_2_val_int_reg) < $signed(18'd261371)) ? 1'b1 : 1'b0);

assign icmp_ln86_37_fu_386_p2 = (($signed(x_3_val_int_reg) < $signed(18'd3025)) ? 1'b1 : 1'b0);

assign icmp_ln86_38_fu_392_p2 = (($signed(x_14_val_int_reg) < $signed(18'd527)) ? 1'b1 : 1'b0);

assign icmp_ln86_39_fu_398_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1251)) ? 1'b1 : 1'b0);

assign icmp_ln86_40_fu_404_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1495)) ? 1'b1 : 1'b0);

assign icmp_ln86_41_fu_410_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261953)) ? 1'b1 : 1'b0);

assign icmp_ln86_42_fu_416_p2 = (($signed(x_12_val_int_reg) < $signed(18'd262056)) ? 1'b1 : 1'b0);

assign icmp_ln86_43_fu_422_p2 = (($signed(x_14_val_int_reg) < $signed(18'd261006)) ? 1'b1 : 1'b0);

assign icmp_ln86_44_fu_428_p2 = (($signed(x_12_val_int_reg) < $signed(18'd1277)) ? 1'b1 : 1'b0);

assign icmp_ln86_45_fu_434_p2 = (($signed(x_14_val_int_reg) < $signed(18'd1750)) ? 1'b1 : 1'b0);

assign icmp_ln86_46_fu_440_p2 = (($signed(x_14_val_int_reg) < $signed(18'd2121)) ? 1'b1 : 1'b0);

assign icmp_ln86_47_fu_446_p2 = (($signed(x_5_val_int_reg) < $signed(18'd261880)) ? 1'b1 : 1'b0);

assign icmp_ln86_48_fu_452_p2 = (($signed(x_2_val_int_reg) < $signed(18'd1668)) ? 1'b1 : 1'b0);

assign icmp_ln86_49_fu_458_p2 = (($signed(x_12_val_int_reg) < $signed(18'd1606)) ? 1'b1 : 1'b0);

assign icmp_ln86_50_fu_464_p2 = (($signed(x_3_val_int_reg) < $signed(18'd1584)) ? 1'b1 : 1'b0);

assign icmp_ln86_51_fu_470_p2 = (($signed(x_11_val_int_reg) < $signed(18'd261351)) ? 1'b1 : 1'b0);

assign icmp_ln86_52_fu_476_p2 = (($signed(x_1_val_int_reg) < $signed(18'd261917)) ? 1'b1 : 1'b0);

assign icmp_ln86_53_fu_482_p2 = (($signed(x_7_val_int_reg) < $signed(18'd2503)) ? 1'b1 : 1'b0);

assign icmp_ln86_54_fu_488_p2 = (($signed(x_0_val_int_reg) < $signed(18'd838)) ? 1'b1 : 1'b0);

assign icmp_ln86_55_fu_494_p2 = (($signed(x_1_val_int_reg) < $signed(18'd259986)) ? 1'b1 : 1'b0);

assign icmp_ln86_56_fu_500_p2 = (($signed(x_9_val_int_reg) < $signed(18'd1552)) ? 1'b1 : 1'b0);

assign icmp_ln86_57_fu_506_p2 = (($signed(x_13_val_int_reg) < $signed(18'd1342)) ? 1'b1 : 1'b0);

assign icmp_ln86_58_fu_512_p2 = (($signed(x_3_val_int_reg) < $signed(18'd261296)) ? 1'b1 : 1'b0);

assign icmp_ln86_59_fu_518_p2 = (($signed(x_9_val_int_reg) < $signed(18'd1467)) ? 1'b1 : 1'b0);

assign icmp_ln86_60_fu_524_p2 = (($signed(x_12_val_int_reg) < $signed(18'd1288)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_344_p2 = (($signed(x_7_val_int_reg) < $signed(18'd906)) ? 1'b1 : 1'b0);
