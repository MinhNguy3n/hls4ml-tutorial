...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_13_1_1_x17 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_13_1_1_x17_U987 : component my_prj_sparsemux_65_5_13_1_1_x17
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_622_fu_316_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC8C)) else "0";
    icmp_ln86_623_fu_322_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC35)) else "0";
    icmp_ln86_624_fu_328_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_316)) else "0";
    icmp_ln86_625_fu_334_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2C1)) else "0";
    icmp_ln86_626_fu_340_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_956)) else "0";
    icmp_ln86_627_fu_346_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF76)) else "0";
    icmp_ln86_628_fu_352_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC08)) else "0";
    icmp_ln86_629_fu_358_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_A7)) else "0";
    icmp_ln86_630_fu_364_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FD95)) else "0";
    icmp_ln86_631_fu_370_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_66)) else "0";
    icmp_ln86_632_fu_376_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FD)) else "0";
    icmp_ln86_633_fu_382_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_94F)) else "0";
    icmp_ln86_634_fu_388_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2C6)) else "0";
    icmp_ln86_635_fu_394_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_2B2)) else "0";
    icmp_ln86_636_fu_400_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_315)) else "0";
    icmp_ln86_637_fu_406_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_642)) else "0";
    icmp_ln86_638_fu_412_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FBF2)) else "0";
    icmp_ln86_639_fu_418_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_AD)) else "0";
    icmp_ln86_640_fu_424_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD92)) else "0";
    icmp_ln86_641_fu_430_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_256)) else "0";
    icmp_ln86_642_fu_436_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2FC)) else "0";
    icmp_ln86_643_fu_442_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FD0D)) else "0";
    icmp_ln86_644_fu_448_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FED2)) else "0";
    icmp_ln86_645_fu_454_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_80C)) else "0";
    icmp_ln86_646_fu_460_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_9F4)) else "0";
    icmp_ln86_647_fu_466_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_97F)) else "0";
    icmp_ln86_648_fu_472_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_310)) else "0";
    icmp_ln86_649_fu_478_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_48)) else "0";
    icmp_ln86_650_fu_484_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_4B)) else "0";
    icmp_ln86_651_fu_490_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_DC)) else "0";
    icmp_ln86_fu_310_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_1C6)) else "0";
