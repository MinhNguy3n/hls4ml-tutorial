...
begin
    sparsemux_63_5_13_1_1_x_U958 : component my_prj_sparsemux_63_5_13_1_1_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_681_fu_324_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_3D7)) else "0";
    icmp_ln86_682_fu_330_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3F84A)) else "0";
    icmp_ln86_683_fu_336_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_303)) else "0";
    icmp_ln86_684_fu_342_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_373)) else "0";
    icmp_ln86_685_fu_348_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3F1)) else "0";
    icmp_ln86_686_fu_354_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB3A)) else "0";
    icmp_ln86_687_fu_360_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_750)) else "0";
    icmp_ln86_688_fu_366_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_C9)) else "0";
    icmp_ln86_689_fu_372_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_935)) else "0";
    icmp_ln86_690_fu_378_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_79B)) else "0";
    icmp_ln86_691_fu_384_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3E4)) else "0";
    icmp_ln86_692_fu_390_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCA3)) else "0";
    icmp_ln86_693_fu_396_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FBA1)) else "0";
    icmp_ln86_694_fu_402_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6DE)) else "0";
    icmp_ln86_695_fu_408_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_7F6)) else "0";
    icmp_ln86_696_fu_414_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_D8)) else "0";
    icmp_ln86_697_fu_420_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF5D)) else "0";
    icmp_ln86_698_fu_426_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_167)) else "0";
    icmp_ln86_699_fu_432_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1B7)) else "0";
    icmp_ln86_700_fu_438_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FBC6)) else "0";
    icmp_ln86_701_fu_444_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_706)) else "0";
    icmp_ln86_702_fu_450_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_5B3)) else "0";
    icmp_ln86_703_fu_456_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_1639)) else "0";
    icmp_ln86_704_fu_462_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD87)) else "0";
    icmp_ln86_705_fu_468_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCA4)) else "0";
    icmp_ln86_706_fu_474_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FBBA)) else "0";
    icmp_ln86_707_fu_480_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB50)) else "0";
    icmp_ln86_fu_318_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_562)) else "0";
