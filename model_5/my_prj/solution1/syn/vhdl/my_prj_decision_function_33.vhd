...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_13_1_1_x16 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_13_1_1_x16_U851 : component my_prj_sparsemux_65_5_13_1_1_x16
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_926_fu_358_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_AF2)) else "0";
    icmp_ln86_927_fu_364_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_33)) else "0";
    icmp_ln86_928_fu_370_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_12C)) else "0";
    icmp_ln86_929_fu_376_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3E822)) else "0";
    icmp_ln86_930_fu_382_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_37E)) else "0";
    icmp_ln86_931_fu_388_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FD87)) else "0";
    icmp_ln86_932_fu_394_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_EB)) else "0";
    icmp_ln86_933_fu_400_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FF81)) else "0";
    icmp_ln86_934_fu_406_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB1B)) else "0";
    icmp_ln86_935_fu_412_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FA13)) else "0";
    icmp_ln86_936_fu_418_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_23A)) else "0";
    icmp_ln86_937_fu_424_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FFEE)) else "0";
    icmp_ln86_938_fu_430_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_12E)) else "0";
    icmp_ln86_939_fu_436_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE72)) else "0";
    icmp_ln86_940_fu_442_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF30)) else "0";
    icmp_ln86_941_fu_448_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FF9C)) else "0";
    icmp_ln86_942_fu_454_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF60)) else "0";
    icmp_ln86_943_fu_460_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_82)) else "0";
    icmp_ln86_944_fu_466_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAC9)) else "0";
    icmp_ln86_945_fu_472_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FAF3)) else "0";
    icmp_ln86_946_fu_478_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_3F973)) else "0";
    icmp_ln86_947_fu_484_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FE91)) else "0";
    icmp_ln86_948_fu_490_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_581)) else "0";
    icmp_ln86_949_fu_496_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_2E)) else "0";
    icmp_ln86_950_fu_502_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_9E6)) else "0";
    icmp_ln86_951_fu_508_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_7B)) else "0";
    icmp_ln86_952_fu_514_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_342)) else "0";
    icmp_ln86_953_fu_520_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_57D)) else "0";
    icmp_ln86_955_fu_542_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB16)) else "0";
    icmp_ln86_fu_352_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_56D)) else "0";
    ...
    select_ln117_fu_667_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_526_p4 <= x_3_val_int_reg(17 downto 2);
