...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_13_1_1_x15 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_13_1_1_x15_U841 : component my_prj_sparsemux_65_5_13_1_1_x15
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_956_fu_302_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FDD6)) else "0";
    icmp_ln86_957_fu_308_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FB97)) else "0";
    icmp_ln86_958_fu_314_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_289)) else "0";
    icmp_ln86_959_fu_320_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_223)) else "0";
    icmp_ln86_960_fu_326_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_2E1)) else "0";
    icmp_ln86_961_fu_332_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_A8)) else "0";
    icmp_ln86_962_fu_338_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF8F)) else "0";
    icmp_ln86_963_fu_344_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6)) else "0";
    icmp_ln86_964_fu_350_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FFA8)) else "0";
    icmp_ln86_965_fu_356_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEA5)) else "0";
    icmp_ln86_966_fu_362_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_31B)) else "0";
    icmp_ln86_967_fu_368_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_83B)) else "0";
    icmp_ln86_968_fu_374_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE08)) else "0";
    icmp_ln86_969_fu_380_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_10A)) else "0";
    icmp_ln86_970_fu_386_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FC28)) else "0";
    icmp_ln86_971_fu_392_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_A2)) else "0";
    icmp_ln86_972_fu_398_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC33)) else "0";
    icmp_ln86_973_fu_404_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FF07)) else "0";
    icmp_ln86_974_fu_410_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE15)) else "0";
    icmp_ln86_975_fu_416_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_6E)) else "0";
    icmp_ln86_976_fu_422_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE4F)) else "0";
    icmp_ln86_977_fu_428_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_75D)) else "0";
    icmp_ln86_978_fu_434_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FB14)) else "0";
    icmp_ln86_979_fu_440_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FAE6)) else "0";
    icmp_ln86_980_fu_446_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3F90D)) else "0";
    icmp_ln86_981_fu_452_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_4EC)) else "0";
    icmp_ln86_982_fu_458_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2B4)) else "0";
    icmp_ln86_983_fu_464_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3C)) else "0";
    icmp_ln86_984_fu_470_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FD0F)) else "0";
    icmp_ln86_985_fu_476_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FC78)) else "0";
    icmp_ln86_fu_296_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_DA)) else "0";
