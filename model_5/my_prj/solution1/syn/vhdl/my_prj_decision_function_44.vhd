...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_11_1_1_x15 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x15_U714 : component my_prj_sparsemux_65_5_11_1_1_x15
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1251_fu_318_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FF2B)) else "0";
    icmp_ln86_1252_fu_324_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FD78)) else "0";
    icmp_ln86_1253_fu_330_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1EF)) else "0";
    icmp_ln86_1254_fu_336_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_195)) else "0";
    icmp_ln86_1255_fu_342_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_285)) else "0";
    icmp_ln86_1256_fu_348_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_177)) else "0";
    icmp_ln86_1257_fu_354_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FEA3)) else "0";
    icmp_ln86_1258_fu_360_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_70)) else "0";
    icmp_ln86_1259_fu_366_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FFFC)) else "0";
    icmp_ln86_1260_fu_372_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_6E)) else "0";
    icmp_ln86_1261_fu_378_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF54)) else "0";
    icmp_ln86_1262_fu_384_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FBF1)) else "0";
    icmp_ln86_1263_fu_390_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_2B2)) else "0";
    icmp_ln86_1264_fu_396_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FCBC)) else "0";
    icmp_ln86_1265_fu_402_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FC35)) else "0";
    icmp_ln86_1266_fu_408_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCAA)) else "0";
    icmp_ln86_1267_fu_414_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FDE4)) else "0";
    icmp_ln86_1268_fu_420_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FC3F)) else "0";
    icmp_ln86_1269_fu_426_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_1270_fu_432_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FD87)) else "0";
    icmp_ln86_1271_fu_438_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCBC)) else "0";
    icmp_ln86_1272_fu_444_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FA82)) else "0";
    icmp_ln86_1273_fu_450_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FDA8)) else "0";
    icmp_ln86_1274_fu_456_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_64)) else "0";
    icmp_ln86_1275_fu_462_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FEA4)) else "0";
    icmp_ln86_1276_fu_468_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FFF2)) else "0";
    icmp_ln86_1277_fu_474_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_165)) else "0";
    icmp_ln86_1278_fu_480_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_10E)) else "0";
    icmp_ln86_1279_fu_486_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_43)) else "0";
    icmp_ln86_1280_fu_492_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FEBB)) else "0";
    icmp_ln86_fu_312_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_AA)) else "0";
