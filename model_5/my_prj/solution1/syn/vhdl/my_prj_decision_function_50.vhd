...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_11_1_1_x11 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x11_U628 : component my_prj_sparsemux_65_5_11_1_1_x11
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1428_fu_344_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF76)) else "0";
    icmp_ln86_1429_fu_350_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCAE)) else "0";
    icmp_ln86_1430_fu_356_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FF09)) else "0";
    icmp_ln86_1431_fu_362_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF86)) else "0";
    icmp_ln86_1432_fu_368_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB69)) else "0";
    icmp_ln86_1433_fu_374_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FE57)) else "0";
    icmp_ln86_1434_fu_380_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_1E8)) else "0";
    icmp_ln86_1435_fu_386_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_178)) else "0";
    icmp_ln86_1436_fu_392_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FDE2)) else "0";
    icmp_ln86_1437_fu_398_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_2B)) else "0";
    icmp_ln86_1438_fu_404_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCA4)) else "0";
    icmp_ln86_1439_fu_410_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FBB9)) else "0";
    icmp_ln86_1440_fu_416_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_D8)) else "0";
    icmp_ln86_1441_fu_422_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_5D5)) else "0";
    icmp_ln86_1442_fu_428_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FC59)) else "0";
    icmp_ln86_1443_fu_434_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_42)) else "0";
    icmp_ln86_1444_fu_440_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FFF0)) else "0";
    icmp_ln86_1445_fu_446_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE22)) else "0";
    icmp_ln86_1446_fu_452_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FDDD)) else "0";
    icmp_ln86_1447_fu_458_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_3FF1E)) else "0";
    icmp_ln86_1448_fu_464_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_173)) else "0";
    icmp_ln86_1449_fu_470_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_73)) else "0";
    icmp_ln86_1450_fu_476_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAFE)) else "0";
    icmp_ln86_1451_fu_482_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_78D)) else "0";
    icmp_ln86_1452_fu_488_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_604)) else "0";
    icmp_ln86_1453_fu_494_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB86)) else "0";
    icmp_ln86_1454_fu_500_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FF83)) else "0";
    icmp_ln86_1455_fu_506_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_20D)) else "0";
    icmp_ln86_1456_fu_512_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3F9C4)) else "0";
    icmp_ln86_1457_fu_518_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_393)) else "0";
    icmp_ln86_fu_338_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FFED)) else "0";
