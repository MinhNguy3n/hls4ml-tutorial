...
begin
    sparsemux_57_5_12_1_1_U616 : component my_prj_sparsemux_57_5_12_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_1410_fu_298_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_A08)) else "0";
    icmp_ln86_1411_fu_304_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_1009)) else "0";
    icmp_ln86_1412_fu_310_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_885)) else "0";
    icmp_ln86_1413_fu_316_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_CC6)) else "0";
    icmp_ln86_1414_fu_322_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_560)) else "0";
    icmp_ln86_1415_fu_328_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_56B)) else "0";
    icmp_ln86_1416_fu_334_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_AE6)) else "0";
    icmp_ln86_1417_fu_340_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_96B)) else "0";
    icmp_ln86_1418_fu_346_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_57)) else "0";
    icmp_ln86_1419_fu_352_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_C6C)) else "0";
    icmp_ln86_1420_fu_358_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_758)) else "0";
    icmp_ln86_1421_fu_364_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_617)) else "0";
    icmp_ln86_1422_fu_370_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_1192)) else "0";
    icmp_ln86_1423_fu_376_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_736)) else "0";
    icmp_ln86_1424_fu_382_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_612)) else "0";
    icmp_ln86_1425_fu_388_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_90E)) else "0";
    icmp_ln86_1426_fu_394_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_D3)) else "0";
    icmp_ln86_1427_fu_400_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_4C)) else "0";
    icmp_ln86_1428_fu_406_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_77E)) else "0";
    icmp_ln86_1429_fu_412_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_17F)) else "0";
    icmp_ln86_1430_fu_418_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_BE5)) else "0";
    icmp_ln86_1431_fu_424_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_604)) else "0";
    icmp_ln86_1432_fu_430_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_4A0)) else "0";
    icmp_ln86_1433_fu_436_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_BE1)) else "0";
    icmp_ln86_1434_fu_442_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_50E)) else "0";
    icmp_ln86_1435_fu_448_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_4EB)) else "0";
    icmp_ln86_fu_292_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_101B)) else "0";
