...
begin
    sparsemux_59_5_12_1_1_U575 : component my_prj_sparsemux_59_5_12_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1294_fu_308_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_604)) else "0";
    icmp_ln86_1295_fu_314_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB16)) else "0";
    icmp_ln86_1296_fu_320_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FA2E)) else "0";
    icmp_ln86_1297_fu_326_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_387)) else "0";
    icmp_ln86_1298_fu_332_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCA1)) else "0";
    icmp_ln86_1299_fu_338_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FBF9)) else "0";
    icmp_ln86_1300_fu_344_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_241)) else "0";
    icmp_ln86_1301_fu_350_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FB80)) else "0";
    icmp_ln86_1302_fu_356_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_71F)) else "0";
    icmp_ln86_1303_fu_362_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_394)) else "0";
    icmp_ln86_1304_fu_368_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB11)) else "0";
    icmp_ln86_1305_fu_374_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FEC6)) else "0";
    icmp_ln86_1306_fu_380_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD88)) else "0";
    icmp_ln86_1307_fu_386_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_340)) else "0";
    icmp_ln86_1308_fu_392_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_51A)) else "0";
    icmp_ln86_1309_fu_398_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FFAF)) else "0";
    icmp_ln86_1310_fu_404_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_4C9)) else "0";
    icmp_ln86_1311_fu_410_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEB9)) else "0";
    icmp_ln86_1312_fu_416_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_30E)) else "0";
    icmp_ln86_1313_fu_422_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FFB9)) else "0";
    icmp_ln86_1314_fu_428_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FEA5)) else "0";
    icmp_ln86_1315_fu_434_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_DA)) else "0";
    icmp_ln86_1316_fu_440_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FFBA)) else "0";
    icmp_ln86_1317_fu_446_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_6E6)) else "0";
    icmp_ln86_1318_fu_452_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_64E)) else "0";
    icmp_ln86_1319_fu_458_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_189)) else "0";
    icmp_ln86_fu_302_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_649)) else "0";
