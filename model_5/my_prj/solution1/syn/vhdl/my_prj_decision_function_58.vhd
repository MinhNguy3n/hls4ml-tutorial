...
attribute shreg_extract : string;
    ...
    component my_prj_sparsemux_65_5_11_1_1_x8 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x8_U535 : component my_prj_sparsemux_65_5_11_1_1_x8
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1206_fu_342_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_29)) else "0";
    icmp_ln86_1207_fu_348_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_1208_fu_354_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_1209_fu_360_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_F3)) else "0";
    icmp_ln86_1210_fu_366_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FFCE)) else "0";
    icmp_ln86_1211_fu_372_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FE9A)) else "0";
    icmp_ln86_1212_fu_378_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB32)) else "0";
    icmp_ln86_1213_fu_384_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3C2)) else "0";
    icmp_ln86_1214_fu_390_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_432)) else "0";
    icmp_ln86_1215_fu_396_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FFDB)) else "0";
    icmp_ln86_1216_fu_402_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_488)) else "0";
    icmp_ln86_1217_fu_408_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FFAB)) else "0";
    icmp_ln86_1218_fu_414_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAF4)) else "0";
    icmp_ln86_1219_fu_420_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FE85)) else "0";
    icmp_ln86_1220_fu_426_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_1221_fu_432_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_4C)) else "0";
    icmp_ln86_1222_fu_438_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_1A5)) else "0";
    icmp_ln86_1223_fu_444_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_1F6)) else "0";
    icmp_ln86_1224_fu_450_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_170)) else "0";
    icmp_ln86_1225_fu_456_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_3FDC8)) else "0";
    icmp_ln86_1226_fu_462_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_121)) else "0";
    icmp_ln86_1227_fu_468_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3FE36)) else "0";
    icmp_ln86_1228_fu_474_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F843)) else "0";
    icmp_ln86_1229_fu_480_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEB4)) else "0";
    icmp_ln86_1230_fu_486_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_BD)) else "0";
    icmp_ln86_1231_fu_492_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9A)) else "0";
    icmp_ln86_1232_fu_498_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FFD6)) else "0";
    icmp_ln86_1233_fu_504_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FC19)) else "0";
    icmp_ln86_1234_fu_510_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_1C8)) else "0";
    icmp_ln86_fu_336_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_1E9)) else "0";
