...
begin
    sparsemux_65_5_12_1_1_x15_U526 : component my_prj_sparsemux_65_5_12_1_1_x15
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1176_fu_294_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FE12)) else "0";
    icmp_ln86_1177_fu_300_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FEE0)) else "0";
    icmp_ln86_1178_fu_306_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD21)) else "0";
    icmp_ln86_1179_fu_312_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD80)) else "0";
    icmp_ln86_1180_fu_318_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FD90)) else "0";
    icmp_ln86_1181_fu_324_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE05)) else "0";
    icmp_ln86_1182_fu_330_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FD2A)) else "0";
    icmp_ln86_1183_fu_336_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FDA8)) else "0";
    icmp_ln86_1184_fu_342_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF4D)) else "0";
    icmp_ln86_1185_fu_348_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FE4D)) else "0";
    icmp_ln86_1186_fu_354_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_196)) else "0";
    icmp_ln86_1187_fu_360_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE57)) else "0";
    icmp_ln86_1188_fu_366_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_8E)) else "0";
    icmp_ln86_1189_fu_372_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_1BC)) else "0";
    icmp_ln86_1190_fu_378_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCFA)) else "0";
    icmp_ln86_1191_fu_384_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FC94)) else "0";
    icmp_ln86_1192_fu_390_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FCD3)) else "0";
    icmp_ln86_1193_fu_396_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD5D)) else "0";
    icmp_ln86_1194_fu_402_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_1195_fu_408_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_29)) else "0";
    icmp_ln86_1196_fu_414_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FD93)) else "0";
    icmp_ln86_1197_fu_420_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_9)) else "0";
    icmp_ln86_1198_fu_426_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FEBF)) else "0";
    icmp_ln86_1199_fu_432_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FFD8)) else "0";
    icmp_ln86_1200_fu_438_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FDC9)) else "0";
    icmp_ln86_1201_fu_444_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_604)) else "0";
    icmp_ln86_1202_fu_450_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF01)) else "0";
    icmp_ln86_1203_fu_456_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_2ED)) else "0";
    icmp_ln86_1204_fu_462_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_19E)) else "0";
    icmp_ln86_1205_fu_468_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_E1)) else "0";
    icmp_ln86_fu_288_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD9A)) else "0";
