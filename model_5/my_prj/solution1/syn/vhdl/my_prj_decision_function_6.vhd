...
begin
    sparsemux_57_5_12_1_1_x_U1182 : component my_prj_sparsemux_57_5_12_1_1_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_170_fu_306_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6A7)) else "0";
    icmp_ln86_171_fu_312_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_253)) else "0";
    icmp_ln86_172_fu_318_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_5EC)) else "0";
    icmp_ln86_173_fu_324_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_7D7)) else "0";
    icmp_ln86_174_fu_330_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3FF98)) else "0";
    icmp_ln86_175_fu_336_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_4CF)) else "0";
    icmp_ln86_176_fu_342_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_428)) else "0";
    icmp_ln86_177_fu_348_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_409)) else "0";
    icmp_ln86_178_fu_354_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_683)) else "0";
    icmp_ln86_179_fu_360_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_83D)) else "0";
    icmp_ln86_180_fu_366_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FA)) else "0";
    icmp_ln86_181_fu_372_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_A2)) else "0";
    icmp_ln86_182_fu_378_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_EEA)) else "0";
    icmp_ln86_183_fu_384_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_A14)) else "0";
    icmp_ln86_184_fu_390_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_450)) else "0";
    icmp_ln86_185_fu_396_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_546)) else "0";
    icmp_ln86_186_fu_402_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_5FB)) else "0";
    icmp_ln86_187_fu_408_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_257)) else "0";
    icmp_ln86_188_fu_414_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_12F)) else "0";
    icmp_ln86_189_fu_420_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_7DD)) else "0";
    icmp_ln86_190_fu_426_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FCD7)) else "0";
    icmp_ln86_191_fu_432_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FE3E)) else "0";
    icmp_ln86_192_fu_438_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FE89)) else "0";
    icmp_ln86_193_fu_444_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_9EC)) else "0";
    icmp_ln86_194_fu_450_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_389)) else "0";
    icmp_ln86_195_fu_456_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_E39)) else "0";
    icmp_ln86_fu_300_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_822)) else "0";
