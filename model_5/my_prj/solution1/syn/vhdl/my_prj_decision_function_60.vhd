...
entity my_prj_decision_function_60 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_60 is 
...
begin
    sparsemux_65_5_12_1_1_x14_U515 : component my_prj_sparsemux_65_5_12_1_1_x14
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1146_fu_312_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC8C)) else "0";
    icmp_ln86_1147_fu_318_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FFFA)) else "0";
    icmp_ln86_1148_fu_324_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2E9)) else "0";
    icmp_ln86_1149_fu_330_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FFBE)) else "0";
    icmp_ln86_1150_fu_336_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FCFE)) else "0";
    icmp_ln86_1151_fu_342_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FC99)) else "0";
    icmp_ln86_1152_fu_348_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_253)) else "0";
    icmp_ln86_1153_fu_354_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_FA)) else "0";
    icmp_ln86_1154_fu_360_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_5A)) else "0";
    icmp_ln86_1155_fu_366_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF84)) else "0";
    icmp_ln86_1156_fu_372_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE3F)) else "0";
    icmp_ln86_1157_fu_378_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_3FE5E)) else "0";
    icmp_ln86_1158_fu_384_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC0E)) else "0";
    icmp_ln86_1159_fu_400_p2 <= "1" when (signed(tmp_fu_390_p4) < signed(ap_const_lv17_1)) else "0";
    icmp_ln86_1160_fu_406_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC52)) else "0";
    icmp_ln86_1161_fu_412_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FBFA)) else "0";
    icmp_ln86_1162_fu_418_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_32A)) else "0";
    icmp_ln86_1163_fu_424_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_164)) else "0";
    icmp_ln86_1164_fu_430_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_166)) else "0";
    icmp_ln86_1165_fu_436_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_82)) else "0";
    icmp_ln86_1166_fu_442_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FDB5)) else "0";
    icmp_ln86_1167_fu_448_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FDCC)) else "0";
    icmp_ln86_1168_fu_454_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_102)) else "0";
    icmp_ln86_1169_fu_460_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FD95)) else "0";
    icmp_ln86_1170_fu_466_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FF50)) else "0";
    icmp_ln86_1171_fu_472_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_5A6)) else "0";
    icmp_ln86_1172_fu_478_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_106)) else "0";
    icmp_ln86_1173_fu_484_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FABE)) else "0";
    icmp_ln86_1174_fu_490_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_83B)) else "0";
    icmp_ln86_1175_fu_496_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_8CB)) else "0";
    icmp_ln86_fu_306_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_36F)) else "0";
    ...
    select_ln117_fu_621_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_390_p4 <= x_3_val_int_reg(17 downto 1);
