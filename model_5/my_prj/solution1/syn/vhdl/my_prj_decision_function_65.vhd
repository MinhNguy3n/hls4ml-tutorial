...
begin
    sparsemux_65_5_13_1_1_x1_U38 : component my_prj_sparsemux_65_5_13_1_1_x1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv13_0;
    icmp_ln86_1001_fu_270_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_7)) else "0";
    icmp_ln86_1002_fu_276_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_4D)) else "0";
    icmp_ln86_1003_fu_282_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_167)) else "0";
    icmp_ln86_1004_fu_288_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_8D)) else "0";
    icmp_ln86_1005_fu_294_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_2B2)) else "0";
    icmp_ln86_1006_fu_300_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_79)) else "0";
    icmp_ln86_1007_fu_306_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_539)) else "0";
    icmp_ln86_1008_fu_312_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FDC8)) else "0";
    icmp_ln86_1009_fu_318_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF30)) else "0";
    icmp_ln86_1010_fu_324_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF61)) else "0";
    icmp_ln86_1011_fu_330_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_DD)) else "0";
    icmp_ln86_1012_fu_336_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_153)) else "0";
    icmp_ln86_1013_fu_342_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF8F)) else "0";
    icmp_ln86_1014_fu_348_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_CE)) else "0";
    icmp_ln86_1015_fu_354_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FAC3)) else "0";
    icmp_ln86_1016_fu_360_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF01)) else "0";
    icmp_ln86_1017_fu_366_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_36F)) else "0";
    icmp_ln86_1018_fu_372_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_42C)) else "0";
    icmp_ln86_1019_fu_378_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_76)) else "0";
    icmp_ln86_1020_fu_384_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE73)) else "0";
    icmp_ln86_1021_fu_390_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FFCF)) else "0";
    icmp_ln86_1022_fu_396_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF6A)) else "0";
    icmp_ln86_1023_fu_402_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_1E7)) else "0";
    icmp_ln86_1024_fu_408_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_4E9)) else "0";
    icmp_ln86_1025_fu_414_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_18C)) else "0";
    icmp_ln86_1026_fu_420_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_1027_fu_426_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_224)) else "0";
    icmp_ln86_1028_fu_432_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_1029_fu_438_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_150)) else "0";
    icmp_ln86_fu_264_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_AF)) else "0";
