...
begin
    sparsemux_65_5_12_1_1_x10_U401 : component my_prj_sparsemux_65_5_12_1_1_x10
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_855_fu_314_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_3FBB7)) else "0";
    icmp_ln86_856_fu_320_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9D)) else "0";
    icmp_ln86_857_fu_326_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAD0)) else "0";
    icmp_ln86_858_fu_332_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB5A)) else "0";
    icmp_ln86_859_fu_338_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FCCA)) else "0";
    icmp_ln86_860_fu_344_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB12)) else "0";
    icmp_ln86_861_fu_350_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_167)) else "0";
    icmp_ln86_862_fu_356_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_863_fu_362_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD86)) else "0";
    icmp_ln86_864_fu_368_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_1D)) else "0";
    icmp_ln86_865_fu_374_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB0B)) else "0";
    icmp_ln86_866_fu_380_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD83)) else "0";
    icmp_ln86_867_fu_386_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FCA2)) else "0";
    icmp_ln86_868_fu_392_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9F)) else "0";
    icmp_ln86_869_fu_398_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_3F8C1)) else "0";
    icmp_ln86_870_fu_404_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FBDE)) else "0";
    icmp_ln86_871_fu_410_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_230)) else "0";
    icmp_ln86_872_fu_416_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAD3)) else "0";
    icmp_ln86_873_fu_422_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_874_fu_428_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB62)) else "0";
    icmp_ln86_875_fu_434_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9C)) else "0";
    icmp_ln86_876_fu_440_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_71E)) else "0";
    icmp_ln86_877_fu_446_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FF49)) else "0";
    icmp_ln86_878_fu_452_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB1B)) else "0";
    icmp_ln86_879_fu_458_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_4DB)) else "0";
    icmp_ln86_880_fu_464_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FF01)) else "0";
    icmp_ln86_881_fu_470_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB1A)) else "0";
    icmp_ln86_882_fu_476_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FEB7)) else "0";
    icmp_ln86_fu_308_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAFC)) else "0";
