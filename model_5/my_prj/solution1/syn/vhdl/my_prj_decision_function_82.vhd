...
entity my_prj_decision_function_82 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of my_prj_decision_function_82 is 
...
begin
    sparsemux_65_5_12_1_1_x5_U264 : component my_prj_sparsemux_65_5_12_1_1_x5
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_498_fu_326_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_6C1)) else "0";
    icmp_ln86_499_fu_332_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FE8B)) else "0";
    icmp_ln86_500_fu_348_p2 <= "1" when (signed(tmp_fu_338_p4) < signed(ap_const_lv10_1)) else "0";
    icmp_ln86_501_fu_354_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_395)) else "0";
    icmp_ln86_502_fu_360_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_87A)) else "0";
    icmp_ln86_503_fu_366_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FC88)) else "0";
    icmp_ln86_504_fu_372_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FEA3)) else "0";
    icmp_ln86_505_fu_378_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_1D)) else "0";
    icmp_ln86_506_fu_384_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_77E)) else "0";
    icmp_ln86_507_fu_390_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_899)) else "0";
    icmp_ln86_508_fu_396_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_17E)) else "0";
    icmp_ln86_509_fu_402_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_2CF)) else "0";
    icmp_ln86_510_fu_408_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_94E)) else "0";
    icmp_ln86_511_fu_414_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_80A)) else "0";
    icmp_ln86_512_fu_420_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_114)) else "0";
    icmp_ln86_513_fu_426_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_BE)) else "0";
    icmp_ln86_514_fu_432_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_F9)) else "0";
    icmp_ln86_515_fu_438_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_111)) else "0";
    icmp_ln86_516_fu_444_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_2F7)) else "0";
    icmp_ln86_517_fu_450_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_2D0)) else "0";
    icmp_ln86_518_fu_456_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_CE)) else "0";
    icmp_ln86_519_fu_462_p2 <= "1" when (signed(x_1_val_int_reg) < signed(ap_const_lv18_411)) else "0";
    icmp_ln86_520_fu_468_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_170)) else "0";
    icmp_ln86_521_fu_474_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_96)) else "0";
    icmp_ln86_522_fu_480_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_128)) else "0";
    icmp_ln86_523_fu_486_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_524_fu_492_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_684)) else "0";
    icmp_ln86_525_fu_498_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_A76)) else "0";
    icmp_ln86_526_fu_504_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_653)) else "0";
    icmp_ln86_527_fu_510_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_45B)) else "0";
    icmp_ln86_fu_320_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_E1)) else "0";
    ...
    select_ln117_fu_635_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_338_p4 <= x_2_val_int_reg(17 downto 8);
