...
begin
    sparsemux_65_5_13_1_1_x_U20 : component my_prj_sparsemux_65_5_13_1_1_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_349_fu_296_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_35)) else "0";
    icmp_ln86_350_fu_302_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_77E)) else "0";
    icmp_ln86_351_fu_308_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FD57)) else "0";
    icmp_ln86_352_fu_314_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_110)) else "0";
    icmp_ln86_353_fu_320_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_56A)) else "0";
    icmp_ln86_354_fu_326_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_655)) else "0";
    icmp_ln86_355_fu_332_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FD87)) else "0";
    icmp_ln86_356_fu_338_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_E7)) else "0";
    icmp_ln86_357_fu_344_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_13A)) else "0";
    icmp_ln86_358_fu_350_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_2F4)) else "0";
    icmp_ln86_359_fu_356_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_340)) else "0";
    icmp_ln86_360_fu_362_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_82C)) else "0";
    icmp_ln86_361_fu_368_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_4F5)) else "0";
    icmp_ln86_362_fu_374_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_890)) else "0";
    icmp_ln86_363_fu_380_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FBAF)) else "0";
    icmp_ln86_364_fu_386_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_311)) else "0";
    icmp_ln86_365_fu_392_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF66)) else "0";
    icmp_ln86_366_fu_398_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_367_fu_404_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_FA)) else "0";
    icmp_ln86_368_fu_410_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3B)) else "0";
    icmp_ln86_369_fu_416_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_88)) else "0";
    icmp_ln86_370_fu_422_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_283)) else "0";
    icmp_ln86_371_fu_428_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_7BD)) else "0";
    icmp_ln86_372_fu_434_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FE)) else "0";
    icmp_ln86_373_fu_440_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_3FEAB)) else "0";
    icmp_ln86_374_fu_446_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_D7)) else "0";
    icmp_ln86_375_fu_452_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_417)) else "0";
    icmp_ln86_376_fu_458_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_76B)) else "0";
    icmp_ln86_377_fu_464_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_AFF)) else "0";
    icmp_ln86_378_fu_470_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_394)) else "0";
    icmp_ln86_fu_290_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_231)) else "0";
