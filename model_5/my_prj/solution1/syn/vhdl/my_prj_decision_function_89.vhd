...
begin
    sparsemux_63_5_11_1_1_U194 : component my_prj_sparsemux_63_5_11_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv11_0;
    icmp_ln86_290_fu_316_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_291_fu_322_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_97)) else "0";
    icmp_ln86_292_fu_328_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_41)) else "0";
    icmp_ln86_293_fu_334_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FF7B)) else "0";
    icmp_ln86_294_fu_340_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FFB9)) else "0";
    icmp_ln86_295_fu_346_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FFEC)) else "0";
    icmp_ln86_296_fu_352_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAED)) else "0";
    icmp_ln86_297_fu_358_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_71)) else "0";
    icmp_ln86_298_fu_364_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FF3F)) else "0";
    icmp_ln86_299_fu_370_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FD88)) else "0";
    icmp_ln86_300_fu_376_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_C2)) else "0";
    icmp_ln86_301_fu_382_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_3FD5C)) else "0";
    icmp_ln86_302_fu_388_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_B3F)) else "0";
    icmp_ln86_303_fu_394_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FD5F)) else "0";
    icmp_ln86_304_fu_400_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_45D)) else "0";
    icmp_ln86_305_fu_406_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FE96)) else "0";
    icmp_ln86_306_fu_412_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF4E)) else "0";
    icmp_ln86_307_fu_418_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FF02)) else "0";
    icmp_ln86_308_fu_424_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FE6E)) else "0";
    icmp_ln86_309_fu_430_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_109)) else "0";
    icmp_ln86_310_fu_436_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FC)) else "0";
    icmp_ln86_311_fu_442_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_7E)) else "0";
    icmp_ln86_312_fu_448_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FF3A)) else "0";
    icmp_ln86_313_fu_454_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_3FA40)) else "0";
    icmp_ln86_314_fu_460_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_96)) else "0";
    icmp_ln86_315_fu_466_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FFD7)) else "0";
    icmp_ln86_316_fu_472_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_8F8)) else "0";
    icmp_ln86_317_fu_478_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_6A7)) else "0";
    icmp_ln86_318_fu_484_p2 <= "1" when (signed(x_4_val_int_reg) < signed(ap_const_lv18_20E)) else "0";
    icmp_ln86_fu_310_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FFB1)) else "0";
