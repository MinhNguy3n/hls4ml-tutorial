...
begin
    sparsemux_63_5_12_1_1_x4_U1141 : component my_prj_sparsemux_63_5_12_1_1_x4
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_256_fu_336_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FB1F)) else "0";
    icmp_ln86_257_fu_342_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_AA6)) else "0";
    icmp_ln86_258_fu_348_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB69)) else "0";
    icmp_ln86_259_fu_354_p2 <= "1" when (signed(x_6_val_int_reg) < signed(ap_const_lv18_B0A)) else "0";
    icmp_ln86_260_fu_360_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_3FC9A)) else "0";
    icmp_ln86_261_fu_366_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_3FB45)) else "0";
    icmp_ln86_262_fu_372_p2 <= "1" when (signed(x_5_val_int_reg) < signed(ap_const_lv18_3FD87)) else "0";
    icmp_ln86_263_fu_378_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB8B)) else "0";
    icmp_ln86_264_fu_384_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_8EB)) else "0";
    icmp_ln86_265_fu_390_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3FB4B)) else "0";
    icmp_ln86_266_fu_396_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAC7)) else "0";
    icmp_ln86_267_fu_402_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAC2)) else "0";
    icmp_ln86_268_fu_408_p2 <= "1" when (signed(x_3_val_int_reg) < signed(ap_const_lv18_5CB)) else "0";
    icmp_ln86_269_fu_414_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FBD6)) else "0";
    icmp_ln86_270_fu_420_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_52E)) else "0";
    icmp_ln86_271_fu_426_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_55A)) else "0";
    icmp_ln86_272_fu_432_p2 <= "1" when (signed(x_0_val_int_reg) < signed(ap_const_lv18_331)) else "0";
    icmp_ln86_273_fu_438_p2 <= "1" when (signed(x_9_val_int_reg) < signed(ap_const_lv18_3BE)) else "0";
    icmp_ln86_274_fu_444_p2 <= "1" when (signed(x_10_val_int_reg) < signed(ap_const_lv18_3F9B6)) else "0";
    icmp_ln86_275_fu_450_p2 <= "1" when (signed(x_11_val_int_reg) < signed(ap_const_lv18_93B)) else "0";
    icmp_ln86_276_fu_456_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_166)) else "0";
    icmp_ln86_277_fu_462_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAD3)) else "0";
    icmp_ln86_278_fu_468_p2 <= "1" when (signed(x_14_val_int_reg) < signed(ap_const_lv18_3FAD6)) else "0";
    icmp_ln86_279_fu_474_p2 <= "1" when (signed(x_12_val_int_reg) < signed(ap_const_lv18_6CC)) else "0";
    icmp_ln86_280_fu_480_p2 <= "1" when (signed(x_13_val_int_reg) < signed(ap_const_lv18_76B)) else "0";
    icmp_ln86_281_fu_486_p2 <= "1" when (signed(x_2_val_int_reg) < signed(ap_const_lv18_3FB2A)) else "0";
    icmp_ln86_282_fu_492_p2 <= "1" when (signed(x_7_val_int_reg) < signed(ap_const_lv18_D27)) else "0";
    icmp_ln86_fu_330_p2 <= "1" when (signed(x_15_val_int_reg) < signed(ap_const_lv18_3FBAF)) else "0";
