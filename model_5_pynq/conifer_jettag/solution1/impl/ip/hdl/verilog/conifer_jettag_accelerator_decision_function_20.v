...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x18 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 13 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 13 ))
sparsemux_65_5_13_1_1_x18_U1052(
    .din0(13'd79),
    .din1(13'd8020),
    .din2(13'd484),
    .din3(13'd8155),
...
assign icmp_ln86_566_fu_332_p2 = (($signed(p_read12_int_reg) < $signed(18'd260804)) ? 1'b1 : 1'b0);

assign icmp_ln86_567_fu_338_p2 = (($signed(p_read12_int_reg) < $signed(18'd260821)) ? 1'b1 : 1'b0);

assign icmp_ln86_568_fu_344_p2 = (($signed(p_read3_int_reg) < $signed(18'd260852)) ? 1'b1 : 1'b0);

assign icmp_ln86_569_fu_350_p2 = (($signed(p_read8_int_reg) < $signed(18'd262113)) ? 1'b1 : 1'b0);

assign icmp_ln86_570_fu_356_p2 = (($signed(p_read4_int_reg) < $signed(18'd261276)) ? 1'b1 : 1'b0);

assign icmp_ln86_571_fu_362_p2 = (($signed(p_read4_int_reg) < $signed(18'd261275)) ? 1'b1 : 1'b0);

assign icmp_ln86_572_fu_368_p2 = (($signed(p_read12_int_reg) < $signed(18'd260793)) ? 1'b1 : 1'b0);

assign icmp_ln86_573_fu_374_p2 = (($signed(p_read7_int_reg) < $signed(18'd261821)) ? 1'b1 : 1'b0);

assign icmp_ln86_574_fu_380_p2 = (($signed(p_read2_int_reg) < $signed(18'd260439)) ? 1'b1 : 1'b0);

assign icmp_ln86_575_fu_386_p2 = (($signed(p_read12_int_reg) < $signed(18'd260792)) ? 1'b1 : 1'b0);

assign icmp_ln86_576_fu_392_p2 = (($signed(p_read5_int_reg) < $signed(18'd261510)) ? 1'b1 : 1'b0);

assign icmp_ln86_577_fu_398_p2 = (($signed(p_read13_int_reg) < $signed(18'd260897)) ? 1'b1 : 1'b0);

assign icmp_ln86_578_fu_404_p2 = (($signed(p_read12_int_reg) < $signed(18'd260846)) ? 1'b1 : 1'b0);

assign icmp_ln86_579_fu_410_p2 = (($signed(p_read5_int_reg) < $signed(18'd261504)) ? 1'b1 : 1'b0);

assign icmp_ln86_580_fu_416_p2 = (($signed(p_read4_int_reg) < $signed(18'd261274)) ? 1'b1 : 1'b0);

assign icmp_ln86_581_fu_422_p2 = (($signed(p_read6_int_reg) < $signed(18'd260108)) ? 1'b1 : 1'b0);

assign icmp_ln86_582_fu_428_p2 = (($signed(p_read6_int_reg) < $signed(18'd261936)) ? 1'b1 : 1'b0);

assign icmp_ln86_583_fu_434_p2 = (($signed(p_read11_int_reg) < $signed(18'd1655)) ? 1'b1 : 1'b0);

assign icmp_ln86_584_fu_440_p2 = (($signed(p_read12_int_reg) < $signed(18'd260838)) ? 1'b1 : 1'b0);

assign icmp_ln86_585_fu_446_p2 = (($signed(p_read9_int_reg) < $signed(18'd119)) ? 1'b1 : 1'b0);

assign icmp_ln86_586_fu_452_p2 = (($signed(p_read10_int_reg) < $signed(18'd1412)) ? 1'b1 : 1'b0);

assign icmp_ln86_587_fu_458_p2 = (($signed(p_read13_int_reg) < $signed(18'd261795)) ? 1'b1 : 1'b0);

assign icmp_ln86_588_fu_464_p2 = (($signed(p_read1_int_reg) < $signed(18'd399)) ? 1'b1 : 1'b0);

assign icmp_ln86_589_fu_470_p2 = (($signed(p_read12_int_reg) < $signed(18'd260856)) ? 1'b1 : 1'b0);

assign icmp_ln86_590_fu_476_p2 = (($signed(p_read1_int_reg) < $signed(18'd2205)) ? 1'b1 : 1'b0);

assign icmp_ln86_591_fu_482_p2 = (($signed(p_read3_int_reg) < $signed(18'd260938)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_326_p2 = (($signed(p_read3_int_reg) < $signed(18'd260864)) ? 1'b1 : 1'b0);
