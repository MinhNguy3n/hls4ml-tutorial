...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x6 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_63_5_12_1_1_x6_U1274(
    .din0(12'd751),
    .din1(12'd3811),
    .din2(12'd3267),
    .din3(12'd3915),
...
assign icmp_ln86_100_fu_418_p2 = (($signed(p_read13_int_reg) < $signed(18'd2327)) ? 1'b1 : 1'b0);

assign icmp_ln86_101_fu_424_p2 = (($signed(p_read11_int_reg) < $signed(18'd1735)) ? 1'b1 : 1'b0);

assign icmp_ln86_102_fu_430_p2 = (($signed(p_read1_int_reg) < $signed(18'd996)) ? 1'b1 : 1'b0);

assign icmp_ln86_103_fu_436_p2 = (($signed(p_read3_int_reg) < $signed(18'd261274)) ? 1'b1 : 1'b0);

assign icmp_ln86_104_fu_442_p2 = (($signed(p_read8_int_reg) < $signed(18'd260260)) ? 1'b1 : 1'b0);

assign icmp_ln86_105_fu_448_p2 = (($signed(p_read13_int_reg) < $signed(18'd260782)) ? 1'b1 : 1'b0);

assign icmp_ln86_106_fu_454_p2 = (($signed(p_read12_int_reg) < $signed(18'd1171)) ? 1'b1 : 1'b0);

assign icmp_ln86_107_fu_460_p2 = (($signed(p_read13_int_reg) < $signed(18'd260780)) ? 1'b1 : 1'b0);

assign icmp_ln86_108_fu_466_p2 = (($signed(p_read6_int_reg) < $signed(18'd866)) ? 1'b1 : 1'b0);

assign icmp_ln86_109_fu_472_p2 = (($signed(p_read4_int_reg) < $signed(18'd260974)) ? 1'b1 : 1'b0);

assign icmp_ln86_110_fu_478_p2 = (($signed(p_read8_int_reg) < $signed(18'd261376)) ? 1'b1 : 1'b0);

assign icmp_ln86_111_fu_484_p2 = (($signed(p_read7_int_reg) < $signed(18'd389)) ? 1'b1 : 1'b0);

assign icmp_ln86_112_fu_490_p2 = (($signed(p_read7_int_reg) < $signed(18'd261152)) ? 1'b1 : 1'b0);

assign icmp_ln86_113_fu_496_p2 = (($signed(p_read3_int_reg) < $signed(18'd5345)) ? 1'b1 : 1'b0);

assign icmp_ln86_114_fu_502_p2 = (($signed(p_read9_int_reg) < $signed(18'd2417)) ? 1'b1 : 1'b0);

assign icmp_ln86_115_fu_508_p2 = (($signed(p_read8_int_reg) < $signed(18'd2008)) ? 1'b1 : 1'b0);

assign icmp_ln86_116_fu_514_p2 = (($signed(p_read7_int_reg) < $signed(18'd746)) ? 1'b1 : 1'b0);

assign icmp_ln86_88_fu_346_p2 = (($signed(p_read2_int_reg) < $signed(18'd259852)) ? 1'b1 : 1'b0);

assign icmp_ln86_89_fu_352_p2 = (($signed(p_read9_int_reg) < $signed(18'd2076)) ? 1'b1 : 1'b0);

assign icmp_ln86_90_fu_358_p2 = (($signed(p_read1_int_reg) < $signed(18'd1076)) ? 1'b1 : 1'b0);

assign icmp_ln86_91_fu_364_p2 = (($signed(p_read5_int_reg) < $signed(18'd261504)) ? 1'b1 : 1'b0);

assign icmp_ln86_92_fu_370_p2 = (($signed(p_read13_int_reg) < $signed(18'd3077)) ? 1'b1 : 1'b0);

assign icmp_ln86_93_fu_376_p2 = (($signed(p_read1_int_reg) < $signed(18'd260071)) ? 1'b1 : 1'b0);

assign icmp_ln86_94_fu_382_p2 = (($signed(p_read14_int_reg) < $signed(18'd261747)) ? 1'b1 : 1'b0);

assign icmp_ln86_95_fu_388_p2 = (($signed(p_read2_int_reg) < $signed(18'd257108)) ? 1'b1 : 1'b0);

assign icmp_ln86_96_fu_394_p2 = (($signed(p_read10_int_reg) < $signed(18'd1809)) ? 1'b1 : 1'b0);

assign icmp_ln86_97_fu_400_p2 = (($signed(p_read10_int_reg) < $signed(18'd1367)) ? 1'b1 : 1'b0);

assign icmp_ln86_98_fu_406_p2 = (($signed(p_read10_int_reg) < $signed(18'd261290)) ? 1'b1 : 1'b0);

assign icmp_ln86_99_fu_412_p2 = (($signed(p_read3_int_reg) < $signed(18'd5236)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_340_p2 = (($signed(p_read13_int_reg) < $signed(18'd260785)) ? 1'b1 : 1'b0);
