...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x13 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 13 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 13 ))
sparsemux_65_5_13_1_1_x13_U865(
    .din0(13'd8079),
    .din1(13'd606),
    .din2(13'd22),
    .din3(13'd274),
...
assign icmp_ln86_1015_fu_350_p2 = (($signed(p_read3_int_reg) < $signed(18'd261275)) ? 1'b1 : 1'b0);

assign icmp_ln86_1016_fu_356_p2 = (($signed(p_read5_int_reg) < $signed(18'd261506)) ? 1'b1 : 1'b0);

assign icmp_ln86_1017_fu_362_p2 = (($signed(p_read10_int_reg) < $signed(18'd1854)) ? 1'b1 : 1'b0);

assign icmp_ln86_1018_fu_368_p2 = (($signed(p_read5_int_reg) < $signed(18'd261507)) ? 1'b1 : 1'b0);

assign icmp_ln86_1019_fu_374_p2 = (($signed(p_read1_int_reg) < $signed(18'd367)) ? 1'b1 : 1'b0);

assign icmp_ln86_1020_fu_380_p2 = (($signed(p_read8_int_reg) < $signed(18'd260149)) ? 1'b1 : 1'b0);

assign icmp_ln86_1021_fu_386_p2 = (($signed(p_read1_int_reg) < $signed(18'd280)) ? 1'b1 : 1'b0);

assign icmp_ln86_1022_fu_392_p2 = (($signed(p_read14_int_reg) < $signed(18'd261842)) ? 1'b1 : 1'b0);

assign icmp_ln86_1023_fu_398_p2 = (($signed(p_read13_int_reg) < $signed(18'd260829)) ? 1'b1 : 1'b0);

assign icmp_ln86_1024_fu_404_p2 = (($signed(p_read11_int_reg) < $signed(18'd1622)) ? 1'b1 : 1'b0);

assign icmp_ln86_1025_fu_410_p2 = (($signed(p_read6_int_reg) < $signed(18'd788)) ? 1'b1 : 1'b0);

assign icmp_ln86_1026_fu_416_p2 = (($signed(p_read6_int_reg) < $signed(18'd219)) ? 1'b1 : 1'b0);

assign icmp_ln86_1027_fu_422_p2 = (($signed(p_read7_int_reg) < $signed(18'd261020)) ? 1'b1 : 1'b0);

assign icmp_ln86_1028_fu_428_p2 = (($signed(p_read9_int_reg) < $signed(18'd218)) ? 1'b1 : 1'b0);

assign icmp_ln86_1029_fu_434_p2 = (($signed(p_read10_int_reg) < $signed(18'd1840)) ? 1'b1 : 1'b0);

assign icmp_ln86_1030_fu_440_p2 = (($signed(p_read2_int_reg) < $signed(18'd260905)) ? 1'b1 : 1'b0);

assign icmp_ln86_1031_fu_446_p2 = (($signed(p_read7_int_reg) < $signed(18'd736)) ? 1'b1 : 1'b0);

assign icmp_ln86_1032_fu_452_p2 = (($signed(p_read12_int_reg) < $signed(18'd1642)) ? 1'b1 : 1'b0);

assign icmp_ln86_1033_fu_458_p2 = (($signed(p_read1_int_reg) < $signed(18'd558)) ? 1'b1 : 1'b0);

assign icmp_ln86_1034_fu_464_p2 = (($signed(p_read4_int_reg) < $signed(18'd261043)) ? 1'b1 : 1'b0);

assign icmp_ln86_1035_fu_470_p2 = (($signed(p_read1_int_reg) < $signed(18'd262018)) ? 1'b1 : 1'b0);

assign icmp_ln86_1036_fu_476_p2 = (($signed(p_read6_int_reg) < $signed(18'd820)) ? 1'b1 : 1'b0);

assign icmp_ln86_1037_fu_482_p2 = (($signed(p_read7_int_reg) < $signed(18'd1404)) ? 1'b1 : 1'b0);

assign icmp_ln86_1038_fu_488_p2 = (($signed(p_read14_int_reg) < $signed(18'd170)) ? 1'b1 : 1'b0);

assign icmp_ln86_1039_fu_494_p2 = (($signed(p_read7_int_reg) < $signed(18'd1189)) ? 1'b1 : 1'b0);

assign icmp_ln86_1040_fu_500_p2 = (($signed(p_read2_int_reg) < $signed(18'd261508)) ? 1'b1 : 1'b0);

assign icmp_ln86_1041_fu_506_p2 = (($signed(p_read7_int_reg) < $signed(18'd261414)) ? 1'b1 : 1'b0);

assign icmp_ln86_1042_fu_512_p2 = (($signed(p_read7_int_reg) < $signed(18'd261405)) ? 1'b1 : 1'b0);

assign icmp_ln86_1043_fu_518_p2 = (($signed(p_read12_int_reg) < $signed(18'd261847)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_344_p2 = (($signed(p_read13_int_reg) < $signed(18'd260835)) ? 1'b1 : 1'b0);
