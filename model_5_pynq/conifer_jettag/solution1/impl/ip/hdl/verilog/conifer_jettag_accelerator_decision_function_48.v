...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x18 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x18_U710(
    .din0(12'd4088),
    .din1(12'd355),
    .din2(12'd3880),
    .din3(12'd4037),
...
assign icmp_ln86_1369_fu_342_p2 = (($signed(p_read4_int_reg) < $signed(18'd261709)) ? 1'b1 : 1'b0);

assign icmp_ln86_1370_fu_348_p2 = (($signed(p_read6_int_reg) < $signed(18'd1801)) ? 1'b1 : 1'b0);

assign icmp_ln86_1371_fu_354_p2 = (($signed(p_read12_int_reg) < $signed(18'd261295)) ? 1'b1 : 1'b0);

assign icmp_ln86_1372_fu_360_p2 = (($signed(p_read3_int_reg) < $signed(18'd47)) ? 1'b1 : 1'b0);

assign icmp_ln86_1373_fu_366_p2 = (($signed(p_read2_int_reg) < $signed(18'd261293)) ? 1'b1 : 1'b0);

assign icmp_ln86_1374_fu_372_p2 = (($signed(p_read13_int_reg) < $signed(18'd973)) ? 1'b1 : 1'b0);

assign icmp_ln86_1375_fu_378_p2 = (($signed(p_read4_int_reg) < $signed(18'd261332)) ? 1'b1 : 1'b0);

assign icmp_ln86_1376_fu_384_p2 = (($signed(p_read3_int_reg) < $signed(18'd261362)) ? 1'b1 : 1'b0);

assign icmp_ln86_1377_fu_390_p2 = (($signed(p_read7_int_reg) < $signed(18'd1180)) ? 1'b1 : 1'b0);

assign icmp_ln86_1378_fu_396_p2 = (($signed(p_read12_int_reg) < $signed(18'd275)) ? 1'b1 : 1'b0);

assign icmp_ln86_1379_fu_402_p2 = (($signed(p_read12_int_reg) < $signed(18'd261216)) ? 1'b1 : 1'b0);

assign icmp_ln86_1380_fu_408_p2 = (($signed(p_read12_int_reg) < $signed(18'd261291)) ? 1'b1 : 1'b0);

assign icmp_ln86_1381_fu_414_p2 = (($signed(p_read7_int_reg) < $signed(18'd1519)) ? 1'b1 : 1'b0);

assign icmp_ln86_1382_fu_420_p2 = (($signed(p_read11_int_reg) < $signed(18'd702)) ? 1'b1 : 1'b0);

assign icmp_ln86_1383_fu_426_p2 = (($signed(p_read12_int_reg) < $signed(18'd261135)) ? 1'b1 : 1'b0);

assign icmp_ln86_1384_fu_432_p2 = (($signed(p_read8_int_reg) < $signed(18'd516)) ? 1'b1 : 1'b0);

assign icmp_ln86_1385_fu_438_p2 = (($signed(p_read11_int_reg) < $signed(18'd60)) ? 1'b1 : 1'b0);

assign icmp_ln86_1386_fu_444_p2 = (($signed(p_read5_int_reg) < $signed(18'd261669)) ? 1'b1 : 1'b0);

assign icmp_ln86_1387_fu_450_p2 = (($signed(p_read9_int_reg) < $signed(18'd260676)) ? 1'b1 : 1'b0);

assign icmp_ln86_1388_fu_456_p2 = (($signed(p_read12_int_reg) < $signed(18'd261376)) ? 1'b1 : 1'b0);

assign icmp_ln86_1389_fu_462_p2 = (($signed(p_read10_int_reg) < $signed(18'd261716)) ? 1'b1 : 1'b0);

assign icmp_ln86_1390_fu_468_p2 = (($signed(p_read3_int_reg) < $signed(18'd261321)) ? 1'b1 : 1'b0);

assign icmp_ln86_1391_fu_474_p2 = (($signed(p_read3_int_reg) < $signed(18'd261336)) ? 1'b1 : 1'b0);

assign icmp_ln86_1392_fu_480_p2 = (($signed(p_read3_int_reg) < $signed(18'd261388)) ? 1'b1 : 1'b0);

assign icmp_ln86_1393_fu_486_p2 = (($signed(p_read3_int_reg) < $signed(18'd261361)) ? 1'b1 : 1'b0);

assign icmp_ln86_1394_fu_492_p2 = (($signed(p_read13_int_reg) < $signed(18'd832)) ? 1'b1 : 1'b0);

assign icmp_ln86_1395_fu_498_p2 = (($signed(p_read12_int_reg) < $signed(18'd261209)) ? 1'b1 : 1'b0);

assign icmp_ln86_1396_fu_504_p2 = (($signed(p_read12_int_reg) < $signed(18'd262143)) ? 1'b1 : 1'b0);

assign icmp_ln86_1397_fu_510_p2 = (($signed(p_read7_int_reg) < $signed(18'd2930)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_336_p2 = (($signed(p_read1_int_reg) < $signed(18'd42)) ? 1'b1 : 1'b0);
