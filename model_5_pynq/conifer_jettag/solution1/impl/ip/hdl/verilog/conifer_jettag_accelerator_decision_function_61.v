...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x7 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
...
assign icmp_ln86_1116_fu_310_p2 = (($signed(p_read1_int_reg) < $signed(18'd261476)) ? 1'b1 : 1'b0);

assign icmp_ln86_1117_fu_316_p2 = (($signed(p_read5_int_reg) < $signed(18'd432)) ? 1'b1 : 1'b0);

assign icmp_ln86_1118_fu_322_p2 = (($signed(p_read2_int_reg) < $signed(18'd613)) ? 1'b1 : 1'b0);

assign icmp_ln86_1119_fu_328_p2 = (($signed(p_read2_int_reg) < $signed(18'd543)) ? 1'b1 : 1'b0);

assign icmp_ln86_1120_fu_334_p2 = (($signed(p_read8_int_reg) < $signed(18'd261448)) ? 1'b1 : 1'b0);

assign icmp_ln86_1121_fu_340_p2 = (($signed(p_read3_int_reg) < $signed(18'd261629)) ? 1'b1 : 1'b0);

assign icmp_ln86_1122_fu_346_p2 = (($signed(p_read3_int_reg) < $signed(18'd261725)) ? 1'b1 : 1'b0);

assign icmp_ln86_1123_fu_352_p2 = (($signed(p_read9_int_reg) < $signed(18'd170)) ? 1'b1 : 1'b0);

assign icmp_ln86_1124_fu_358_p2 = (($signed(p_read1_int_reg) < $signed(18'd261797)) ? 1'b1 : 1'b0);

assign icmp_ln86_1125_fu_364_p2 = (($signed(p_read8_int_reg) < $signed(18'd20)) ? 1'b1 : 1'b0);

assign icmp_ln86_1126_fu_370_p2 = (($signed(p_read1_int_reg) < $signed(18'd262034)) ? 1'b1 : 1'b0);

assign icmp_ln86_1127_fu_376_p2 = (($signed(p_read3_int_reg) < $signed(18'd261467)) ? 1'b1 : 1'b0);

assign icmp_ln86_1128_fu_382_p2 = (($signed(p_read8_int_reg) < $signed(18'd261794)) ? 1'b1 : 1'b0);

assign icmp_ln86_1129_fu_388_p2 = (($signed(p_read9_int_reg) < $signed(18'd1823)) ? 1'b1 : 1'b0);

assign icmp_ln86_1130_fu_394_p2 = (($signed(p_read4_int_reg) < $signed(18'd261520)) ? 1'b1 : 1'b0);

assign icmp_ln86_1131_fu_400_p2 = (($signed(p_read5_int_reg) < $signed(18'd717)) ? 1'b1 : 1'b0);

assign icmp_ln86_1132_fu_406_p2 = (($signed(p_read8_int_reg) < $signed(18'd55)) ? 1'b1 : 1'b0);

assign icmp_ln86_1133_fu_412_p2 = (($signed(p_read1_int_reg) < $signed(18'd261197)) ? 1'b1 : 1'b0);

assign icmp_ln86_1134_fu_418_p2 = (($signed(p_read3_int_reg) < $signed(18'd261796)) ? 1'b1 : 1'b0);

assign icmp_ln86_1135_fu_424_p2 = (($signed(p_read2_int_reg) < $signed(18'd325)) ? 1'b1 : 1'b0);

assign icmp_ln86_1136_fu_430_p2 = (($signed(p_read2_int_reg) < $signed(18'd620)) ? 1'b1 : 1'b0);

assign icmp_ln86_1137_fu_436_p2 = (($signed(p_read3_int_reg) < $signed(18'd261970)) ? 1'b1 : 1'b0);

assign icmp_ln86_1138_fu_442_p2 = (($signed(p_read7_int_reg) < $signed(18'd262077)) ? 1'b1 : 1'b0);

assign icmp_ln86_1139_fu_448_p2 = (($signed(p_read5_int_reg) < $signed(18'd261310)) ? 1'b1 : 1'b0);

assign icmp_ln86_1140_fu_454_p2 = (($signed(p_read8_int_reg) < $signed(18'd261461)) ? 1'b1 : 1'b0);

assign icmp_ln86_1141_fu_460_p2 = (($signed(p_read8_int_reg) < $signed(18'd262115)) ? 1'b1 : 1'b0);

assign icmp_ln86_1142_fu_466_p2 = (($signed(p_read3_int_reg) < $signed(18'd261506)) ? 1'b1 : 1'b0);

assign icmp_ln86_1143_fu_472_p2 = (($signed(p_read2_int_reg) < $signed(18'd262127)) ? 1'b1 : 1'b0);

assign icmp_ln86_1144_fu_478_p2 = (($signed(p_read8_int_reg) < $signed(18'd261760)) ? 1'b1 : 1'b0);

assign icmp_ln86_1145_fu_484_p2 = (($signed(p_read6_int_reg) < $signed(18'd1092)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_304_p2 = (($signed(p_read9_int_reg) < $signed(18'd501)) ? 1'b1 : 1'b0);
