...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x11 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x11_U480(
    .din0(12'd3906),
    .din1(12'd3794),
    .din2(12'd4010),
    .din3(12'd3772),
...
assign icmp_ln86_912_fu_350_p2 = (($signed(p_read12_int_reg) < $signed(18'd196)) ? 1'b1 : 1'b0);

assign icmp_ln86_913_fu_356_p2 = (($signed(p_read11_int_reg) < $signed(18'd447)) ? 1'b1 : 1'b0);

assign icmp_ln86_914_fu_362_p2 = (($signed(p_read3_int_reg) < $signed(18'd261986)) ? 1'b1 : 1'b0);

assign icmp_ln86_915_fu_378_p2 = (($signed(tmp_fu_368_p4) < $signed(13'd1)) ? 1'b1 : 1'b0);

assign icmp_ln86_916_fu_384_p2 = (($signed(p_read8_int_reg) < $signed(18'd245)) ? 1'b1 : 1'b0);

assign icmp_ln86_917_fu_390_p2 = (($signed(p_read12_int_reg) < $signed(18'd1632)) ? 1'b1 : 1'b0);

assign icmp_ln86_918_fu_396_p2 = (($signed(p_read13_int_reg) < $signed(18'd260944)) ? 1'b1 : 1'b0);

assign icmp_ln86_919_fu_402_p2 = (($signed(p_read1_int_reg) < $signed(18'd229)) ? 1'b1 : 1'b0);

assign icmp_ln86_920_fu_408_p2 = (($signed(p_read1_int_reg) < $signed(18'd995)) ? 1'b1 : 1'b0);

assign icmp_ln86_921_fu_414_p2 = (($signed(p_read9_int_reg) < $signed(18'd260197)) ? 1'b1 : 1'b0);

assign icmp_ln86_922_fu_420_p2 = (($signed(p_read7_int_reg) < $signed(18'd444)) ? 1'b1 : 1'b0);

assign icmp_ln86_923_fu_426_p2 = (($signed(p_read7_int_reg) < $signed(18'd1487)) ? 1'b1 : 1'b0);

assign icmp_ln86_924_fu_432_p2 = (($signed(p_read3_int_reg) < $signed(18'd2604)) ? 1'b1 : 1'b0);

assign icmp_ln86_925_fu_438_p2 = (($signed(p_read12_int_reg) < $signed(18'd1884)) ? 1'b1 : 1'b0);

assign icmp_ln86_926_fu_444_p2 = (($signed(p_read5_int_reg) < $signed(18'd261014)) ? 1'b1 : 1'b0);

assign icmp_ln86_927_fu_450_p2 = (($signed(p_read7_int_reg) < $signed(18'd1479)) ? 1'b1 : 1'b0);

assign icmp_ln86_928_fu_456_p2 = (($signed(p_read7_int_reg) < $signed(18'd260383)) ? 1'b1 : 1'b0);

assign icmp_ln86_929_fu_462_p2 = (($signed(p_read5_int_reg) < $signed(18'd261345)) ? 1'b1 : 1'b0);

assign icmp_ln86_930_fu_468_p2 = (($signed(p_read12_int_reg) < $signed(18'd548)) ? 1'b1 : 1'b0);

assign icmp_ln86_931_fu_474_p2 = (($signed(p_read10_int_reg) < $signed(18'd260764)) ? 1'b1 : 1'b0);

assign icmp_ln86_932_fu_480_p2 = (($signed(p_read10_int_reg) < $signed(18'd260592)) ? 1'b1 : 1'b0);

assign icmp_ln86_933_fu_486_p2 = (($signed(p_read2_int_reg) < $signed(18'd123)) ? 1'b1 : 1'b0);

assign icmp_ln86_934_fu_492_p2 = (($signed(p_read8_int_reg) < $signed(18'd261732)) ? 1'b1 : 1'b0);

assign icmp_ln86_935_fu_498_p2 = (($signed(p_read12_int_reg) < $signed(18'd252)) ? 1'b1 : 1'b0);

assign icmp_ln86_936_fu_504_p2 = (($signed(p_read2_int_reg) < $signed(18'd261757)) ? 1'b1 : 1'b0);

assign icmp_ln86_937_fu_510_p2 = (($signed(p_read8_int_reg) < $signed(18'd1650)) ? 1'b1 : 1'b0);

assign icmp_ln86_938_fu_516_p2 = (($signed(p_read13_int_reg) < $signed(18'd1729)) ? 1'b1 : 1'b0);

assign icmp_ln86_939_fu_522_p2 = (($signed(p_read6_int_reg) < $signed(18'd3802)) ? 1'b1 : 1'b0);

assign icmp_ln86_940_fu_528_p2 = (($signed(p_read3_int_reg) < $signed(18'd2781)) ? 1'b1 : 1'b0);

assign icmp_ln86_941_fu_534_p2 = (($signed(p_read10_int_reg) < $signed(18'd1443)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_344_p2 = (($signed(p_read13_int_reg) < $signed(18'd261322)) ? 1'b1 : 1'b0);
...
assign tmp_fu_368_p4 = {{p_read4_int_reg[17:5]}};
