...
begin
    sparsemux_63_5_12_1_1_U140 : component conifer_jettag_accelerator_sparsemux_63_5_12_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_283_fu_308_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_99)) else "0";
    icmp_ln86_284_fu_314_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FD29)) else "0";
    icmp_ln86_285_fu_320_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF9A)) else "0";
    icmp_ln86_286_fu_326_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF58)) else "0";
    icmp_ln86_287_fu_332_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_246)) else "0";
    icmp_ln86_288_fu_338_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_23E)) else "0";
    icmp_ln86_289_fu_344_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_26)) else "0";
    icmp_ln86_290_fu_350_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_25)) else "0";
    icmp_ln86_291_fu_356_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_292_fu_362_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_29)) else "0";
    icmp_ln86_293_fu_368_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_D2)) else "0";
    icmp_ln86_294_fu_374_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_1CB)) else "0";
    icmp_ln86_295_fu_380_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FE73)) else "0";
    icmp_ln86_296_fu_386_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FE28)) else "0";
    icmp_ln86_297_fu_392_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFBE)) else "0";
    icmp_ln86_298_fu_398_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FF9D)) else "0";
    icmp_ln86_299_fu_404_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_283)) else "0";
    icmp_ln86_300_fu_410_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_7C)) else "0";
    icmp_ln86_301_fu_416_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FEEE)) else "0";
    icmp_ln86_302_fu_422_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_65)) else "0";
    icmp_ln86_303_fu_428_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FF8F)) else "0";
    icmp_ln86_304_fu_434_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FF30)) else "0";
    icmp_ln86_305_fu_440_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_1E8)) else "0";
    icmp_ln86_306_fu_446_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FFF9)) else "0";
    icmp_ln86_307_fu_452_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_251)) else "0";
    icmp_ln86_308_fu_458_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_EE)) else "0";
    icmp_ln86_309_fu_464_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF98)) else "0";
    icmp_ln86_310_fu_470_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_86)) else "0";
    icmp_ln86_311_fu_476_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FDEF)) else "0";
    icmp_ln86_fu_302_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_1B7)) else "0";
