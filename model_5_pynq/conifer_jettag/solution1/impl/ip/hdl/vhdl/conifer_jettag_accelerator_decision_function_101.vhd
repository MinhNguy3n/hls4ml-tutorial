...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x27 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x27_U1584 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x27
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_2123_fu_336_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFEC)) else "0";
    icmp_ln86_2124_fu_342_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_96)) else "0";
    icmp_ln86_2125_fu_348_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_77)) else "0";
    icmp_ln86_2126_fu_354_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FE68)) else "0";
    icmp_ln86_2127_fu_360_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_12C)) else "0";
    icmp_ln86_2128_fu_366_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_2A3)) else "0";
    icmp_ln86_2129_fu_372_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_1F3)) else "0";
    icmp_ln86_2130_fu_378_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FF55)) else "0";
    icmp_ln86_2131_fu_384_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FDE5)) else "0";
    icmp_ln86_2132_fu_390_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_2A)) else "0";
    icmp_ln86_2133_fu_396_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF06)) else "0";
    icmp_ln86_2134_fu_402_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FBED)) else "0";
    icmp_ln86_2135_fu_408_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_199)) else "0";
    icmp_ln86_2136_fu_414_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_1D6)) else "0";
    icmp_ln86_2137_fu_420_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FF02)) else "0";
    icmp_ln86_2138_fu_426_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FE0A)) else "0";
    icmp_ln86_2139_fu_432_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FEBC)) else "0";
    icmp_ln86_2140_fu_438_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE53)) else "0";
    icmp_ln86_2141_fu_444_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_AF)) else "0";
    icmp_ln86_2142_fu_450_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FADC)) else "0";
    icmp_ln86_2143_fu_456_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_109)) else "0";
    icmp_ln86_2144_fu_462_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_121)) else "0";
    icmp_ln86_2145_fu_468_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FFF5)) else "0";
    icmp_ln86_2146_fu_474_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_35)) else "0";
    icmp_ln86_2147_fu_480_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FEBA)) else "0";
    icmp_ln86_2148_fu_486_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_1F6)) else "0";
    icmp_ln86_2149_fu_492_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FF29)) else "0";
    icmp_ln86_2150_fu_498_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE4F)) else "0";
    icmp_ln86_2151_fu_504_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_B7)) else "0";
    icmp_ln86_2152_fu_510_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3B6)) else "0";
    icmp_ln86_fu_330_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_112)) else "0";
