...
begin
    sparsemux_57_5_13_1_1_U1527 : component conifer_jettag_accelerator_sparsemux_57_5_13_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv13_0;
    icmp_ln86_2015_fu_328_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_158)) else "0";
    icmp_ln86_2016_fu_334_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_1B1)) else "0";
    icmp_ln86_2017_fu_340_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_582)) else "0";
    icmp_ln86_2018_fu_346_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_99B)) else "0";
    icmp_ln86_2019_fu_352_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_775)) else "0";
    icmp_ln86_2020_fu_358_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD82)) else "0";
    icmp_ln86_2021_fu_364_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_728)) else "0";
    icmp_ln86_2022_fu_370_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_531)) else "0";
    icmp_ln86_2023_fu_376_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF41)) else "0";
    icmp_ln86_2024_fu_382_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FDDD)) else "0";
    icmp_ln86_2025_fu_388_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_1DD)) else "0";
    icmp_ln86_2026_fu_394_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FADC)) else "0";
    icmp_ln86_2027_fu_400_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FAF4)) else "0";
    icmp_ln86_2028_fu_406_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_447)) else "0";
    icmp_ln86_2029_fu_412_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FEE9)) else "0";
    icmp_ln86_2030_fu_418_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3F92B)) else "0";
    icmp_ln86_2031_fu_424_p2 <= "1" when (signed(p_read14_int_reg) < signed(ap_const_lv18_45B)) else "0";
    icmp_ln86_2032_fu_430_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FCF6)) else "0";
    icmp_ln86_2033_fu_436_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_15F)) else "0";
    icmp_ln86_2034_fu_442_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FF71)) else "0";
    icmp_ln86_2035_fu_448_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FB7A)) else "0";
    icmp_ln86_2036_fu_454_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_2F6)) else "0";
    icmp_ln86_2037_fu_460_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FA02)) else "0";
    icmp_ln86_2038_fu_466_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FA06)) else "0";
    icmp_ln86_2039_fu_472_p2 <= "1" when (signed(p_read14_int_reg) < signed(ap_const_lv18_3FF8F)) else "0";
    icmp_ln86_2040_fu_478_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FBDA)) else "0";
    icmp_ln86_fu_322_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_1C4)) else "0";
