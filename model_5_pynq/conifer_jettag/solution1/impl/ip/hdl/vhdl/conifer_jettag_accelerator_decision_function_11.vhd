...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_53_5_13_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_53_5_13_1_1_U1182 : component conifer_jettag_accelerator_sparsemux_53_5_13_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_312_fu_284_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3F9C2)) else "0";
    icmp_ln86_313_fu_290_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FC0B)) else "0";
    icmp_ln86_314_fu_296_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FD1E)) else "0";
    icmp_ln86_315_fu_302_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD02)) else "0";
    icmp_ln86_316_fu_308_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FC3E)) else "0";
    icmp_ln86_317_fu_314_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_1FE)) else "0";
    icmp_ln86_318_fu_320_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_BE)) else "0";
    icmp_ln86_319_fu_326_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_2C)) else "0";
    icmp_ln86_320_fu_332_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_2C6)) else "0";
    icmp_ln86_321_fu_338_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_26A)) else "0";
    icmp_ln86_322_fu_344_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FC56)) else "0";
    icmp_ln86_323_fu_350_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FA07)) else "0";
    icmp_ln86_324_fu_356_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_62B)) else "0";
    icmp_ln86_325_fu_362_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_4E9)) else "0";
    icmp_ln86_326_fu_368_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_14)) else "0";
    icmp_ln86_327_fu_374_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FEE0)) else "0";
    icmp_ln86_328_fu_380_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_538)) else "0";
    icmp_ln86_329_fu_386_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FD17)) else "0";
    icmp_ln86_330_fu_392_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FEE5)) else "0";
    icmp_ln86_331_fu_398_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFF3)) else "0";
    icmp_ln86_332_fu_404_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_131)) else "0";
    icmp_ln86_333_fu_410_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_359)) else "0";
    icmp_ln86_334_fu_416_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_604)) else "0";
    icmp_ln86_335_fu_422_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFEA)) else "0";
    icmp_ln86_fu_278_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_5A6)) else "0";
