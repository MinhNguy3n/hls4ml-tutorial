...
begin
    sparsemux_65_5_12_1_1_x27_U1451 : component conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x27
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_1810_fu_330_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FAC3)) else "0";
    icmp_ln86_1811_fu_336_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FB77)) else "0";
    icmp_ln86_1812_fu_342_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_139)) else "0";
    icmp_ln86_1813_fu_348_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_694)) else "0";
    icmp_ln86_1814_fu_354_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_130)) else "0";
    icmp_ln86_1815_fu_360_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_150)) else "0";
    icmp_ln86_1816_fu_366_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FE74)) else "0";
    icmp_ln86_1817_fu_372_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_A8)) else "0";
    icmp_ln86_1818_fu_378_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBC7)) else "0";
    icmp_ln86_1819_fu_384_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FC9A)) else "0";
    icmp_ln86_1820_fu_390_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_AFF)) else "0";
    icmp_ln86_1821_fu_396_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FB6F)) else "0";
    icmp_ln86_1822_fu_402_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFE4)) else "0";
    icmp_ln86_1823_fu_408_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_234)) else "0";
    icmp_ln86_1824_fu_414_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_5AB)) else "0";
    icmp_ln86_1825_fu_420_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_768)) else "0";
    icmp_ln86_1826_fu_426_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F3BC)) else "0";
    icmp_ln86_1827_fu_432_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_14)) else "0";
    icmp_ln86_1828_fu_438_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FD2A)) else "0";
    icmp_ln86_1829_fu_444_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3A5)) else "0";
    icmp_ln86_1830_fu_450_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3F7A3)) else "0";
    icmp_ln86_1831_fu_456_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F634)) else "0";
    icmp_ln86_1832_fu_462_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3F91F)) else "0";
    icmp_ln86_1833_fu_468_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3D)) else "0";
    icmp_ln86_1834_fu_474_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_946)) else "0";
    icmp_ln86_1835_fu_480_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_33F)) else "0";
    icmp_ln86_1836_fu_486_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_11F)) else "0";
    icmp_ln86_1837_fu_492_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FE7F)) else "0";
    icmp_ln86_1838_fu_498_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE27)) else "0";
    icmp_ln86_1839_fu_504_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3B6)) else "0";
    icmp_ln86_fu_324_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_36F)) else "0";
