...
begin
    sparsemux_61_5_12_1_1_x0_U1387 : component conifer_jettag_accelerator_sparsemux_61_5_12_1_1_x0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_1665_fu_342_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_2E1)) else "0";
    icmp_ln86_1666_fu_348_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FF41)) else "0";
    icmp_ln86_1667_fu_354_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_4D)) else "0";
    icmp_ln86_1668_fu_360_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_4A0)) else "0";
    icmp_ln86_1669_fu_366_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_814)) else "0";
    icmp_ln86_1670_fu_372_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_2A6)) else "0";
    icmp_ln86_1671_fu_378_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_39)) else "0";
    icmp_ln86_1672_fu_384_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3F9B3)) else "0";
    icmp_ln86_1673_fu_390_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_13C)) else "0";
    icmp_ln86_1674_fu_396_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3DC)) else "0";
    icmp_ln86_1675_fu_402_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FF71)) else "0";
    icmp_ln86_1676_fu_408_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FFB8)) else "0";
    icmp_ln86_1677_fu_414_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_201)) else "0";
    icmp_ln86_1678_fu_420_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_35C)) else "0";
    icmp_ln86_1679_fu_426_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_1A5)) else "0";
    icmp_ln86_1680_fu_432_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_44)) else "0";
    icmp_ln86_1681_fu_438_p2 <= "1" when (signed(p_read14_int_reg) < signed(ap_const_lv18_3FFBE)) else "0";
    icmp_ln86_1682_fu_444_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_5A)) else "0";
    icmp_ln86_1683_fu_450_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FB86)) else "0";
    icmp_ln86_1684_fu_456_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_2A9)) else "0";
    icmp_ln86_1685_fu_462_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_7C)) else "0";
    icmp_ln86_1686_fu_468_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_32E)) else "0";
    icmp_ln86_1687_fu_474_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_280)) else "0";
    icmp_ln86_1688_fu_480_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FB2F)) else "0";
    icmp_ln86_1689_fu_486_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FF4C)) else "0";
    icmp_ln86_1690_fu_492_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_1ED)) else "0";
    icmp_ln86_1691_fu_498_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3B6)) else "0";
    icmp_ln86_1692_fu_504_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_4CD)) else "0";
    icmp_ln86_fu_336_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_150)) else "0";
