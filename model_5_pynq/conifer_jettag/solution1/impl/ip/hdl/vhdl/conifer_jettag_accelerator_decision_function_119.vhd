...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x8 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_63_5_12_1_1_x8_U1359 : component conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x8
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1606_fu_336_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FFE2)) else "0";
    icmp_ln86_1607_fu_342_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_765)) else "0";
    icmp_ln86_1608_fu_348_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FA94)) else "0";
    icmp_ln86_1609_fu_354_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FEF3)) else "0";
    icmp_ln86_1610_fu_360_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_658)) else "0";
    icmp_ln86_1611_fu_366_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_CF4)) else "0";
    icmp_ln86_1612_fu_372_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_56C)) else "0";
    icmp_ln86_1613_fu_378_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FC00)) else "0";
    icmp_ln86_1614_fu_384_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB08)) else "0";
    icmp_ln86_1615_fu_390_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FE7E)) else "0";
    icmp_ln86_1616_fu_396_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_9B3)) else "0";
    icmp_ln86_1617_fu_402_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_DFE)) else "0";
    icmp_ln86_1618_fu_408_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_E81)) else "0";
    icmp_ln86_1619_fu_414_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_66C)) else "0";
    icmp_ln86_1620_fu_420_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FDC5)) else "0";
    icmp_ln86_1621_fu_426_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_1DF)) else "0";
    icmp_ln86_1622_fu_432_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FFE2)) else "0";
    icmp_ln86_1623_fu_438_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FC4C)) else "0";
    icmp_ln86_1624_fu_444_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FABA)) else "0";
    icmp_ln86_1625_fu_450_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FAC0)) else "0";
    icmp_ln86_1626_fu_456_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_D8)) else "0";
    icmp_ln86_1627_fu_462_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FF9E)) else "0";
    icmp_ln86_1628_fu_468_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3F97E)) else "0";
    icmp_ln86_1629_fu_474_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_1320)) else "0";
    icmp_ln86_1630_fu_480_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FFE9)) else "0";
    icmp_ln86_1631_fu_486_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_723)) else "0";
    icmp_ln86_1632_fu_492_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_581)) else "0";
    icmp_ln86_1633_fu_498_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_C8F)) else "0";
    icmp_ln86_1634_fu_504_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_A72)) else "0";
    icmp_ln86_fu_330_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_657)) else "0";
