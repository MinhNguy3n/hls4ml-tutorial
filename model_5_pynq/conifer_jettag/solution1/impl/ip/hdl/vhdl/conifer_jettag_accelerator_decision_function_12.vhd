...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x22 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x22_U1166 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x22
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_336_fu_352_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FEF5)) else "0";
    icmp_ln86_337_fu_358_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF53)) else "0";
    icmp_ln86_338_fu_364_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_54C)) else "0";
    icmp_ln86_339_fu_370_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_2F3)) else "0";
    icmp_ln86_340_fu_376_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_2E8)) else "0";
    icmp_ln86_341_fu_382_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FE75)) else "0";
    icmp_ln86_342_fu_388_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FFDC)) else "0";
    icmp_ln86_343_fu_394_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_817)) else "0";
    icmp_ln86_344_fu_400_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FF71)) else "0";
    icmp_ln86_345_fu_406_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_19B)) else "0";
    icmp_ln86_346_fu_412_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD2D)) else "0";
    icmp_ln86_347_fu_418_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FBC8)) else "0";
    icmp_ln86_348_fu_424_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_749)) else "0";
    icmp_ln86_349_fu_430_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FEC6)) else "0";
    icmp_ln86_350_fu_436_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FE9E)) else "0";
    icmp_ln86_351_fu_442_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_13)) else "0";
    icmp_ln86_352_fu_448_p2 <= "1" when (signed(p_read14_int_reg) < signed(ap_const_lv18_3FFED)) else "0";
    icmp_ln86_353_fu_454_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_2C2)) else "0";
    icmp_ln86_354_fu_460_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF74)) else "0";
    icmp_ln86_355_fu_466_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_6A)) else "0";
    icmp_ln86_356_fu_472_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFA4)) else "0";
    icmp_ln86_357_fu_478_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FFBE)) else "0";
    icmp_ln86_358_fu_484_p2 <= "1" when (signed(p_read14_int_reg) < signed(ap_const_lv18_196)) else "0";
    icmp_ln86_359_fu_490_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_240)) else "0";
    icmp_ln86_360_fu_496_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_348)) else "0";
    icmp_ln86_361_fu_502_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FEA7)) else "0";
    icmp_ln86_362_fu_508_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_80B)) else "0";
    icmp_ln86_363_fu_514_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_384)) else "0";
    icmp_ln86_364_fu_520_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_58)) else "0";
    icmp_ln86_365_fu_526_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FFCE)) else "0";
    icmp_ln86_fu_346_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_E3)) else "0";
