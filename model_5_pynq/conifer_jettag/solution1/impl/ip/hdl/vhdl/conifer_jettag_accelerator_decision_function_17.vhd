...
begin
    sparsemux_63_5_12_1_1_x3_U1096 : component conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x3
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_481_fu_334_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_72E)) else "0";
    icmp_ln86_482_fu_340_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_4D7)) else "0";
    icmp_ln86_483_fu_346_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FC33)) else "0";
    icmp_ln86_484_fu_352_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FA7C)) else "0";
    icmp_ln86_485_fu_358_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF39)) else "0";
    icmp_ln86_486_fu_364_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FF84)) else "0";
    icmp_ln86_487_fu_370_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_30E)) else "0";
    icmp_ln86_488_fu_376_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_2B2)) else "0";
    icmp_ln86_489_fu_382_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_327)) else "0";
    icmp_ln86_490_fu_388_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB66)) else "0";
    icmp_ln86_491_fu_394_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FA1C)) else "0";
    icmp_ln86_492_fu_400_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FF6A)) else "0";
    icmp_ln86_493_fu_406_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_4DD)) else "0";
    icmp_ln86_494_fu_412_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_39)) else "0";
    icmp_ln86_495_fu_418_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FECE)) else "0";
    icmp_ln86_496_fu_424_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_C)) else "0";
    icmp_ln86_497_fu_430_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_50A)) else "0";
    icmp_ln86_498_fu_436_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FA9A)) else "0";
    icmp_ln86_499_fu_442_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_665)) else "0";
    icmp_ln86_500_fu_448_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF71)) else "0";
    icmp_ln86_501_fu_454_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FEFD)) else "0";
    icmp_ln86_502_fu_460_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FE99)) else "0";
    icmp_ln86_503_fu_466_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_34E)) else "0";
    icmp_ln86_504_fu_472_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FFE2)) else "0";
    icmp_ln86_505_fu_478_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_50B)) else "0";
    icmp_ln86_506_fu_484_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_6C1)) else "0";
    icmp_ln86_507_fu_490_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FFE9)) else "0";
    icmp_ln86_508_fu_496_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_CA9)) else "0";
    icmp_ln86_fu_328_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_518)) else "0";
