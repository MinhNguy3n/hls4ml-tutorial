...
begin
    sparsemux_63_5_12_1_1_x2_U1000 : component conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x2
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_708_fu_306_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F977)) else "0";
    icmp_ln86_709_fu_312_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD59)) else "0";
    icmp_ln86_710_fu_318_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FAC6)) else "0";
    icmp_ln86_711_fu_324_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FACA)) else "0";
    icmp_ln86_712_fu_330_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FB50)) else "0";
    icmp_ln86_713_fu_336_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD81)) else "0";
    icmp_ln86_714_fu_342_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F96F)) else "0";
    icmp_ln86_715_fu_348_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_1D)) else "0";
    icmp_ln86_716_fu_354_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FC9A)) else "0";
    icmp_ln86_717_fu_360_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FC3D)) else "0";
    icmp_ln86_718_fu_366_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_C49)) else "0";
    icmp_ln86_719_fu_372_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FAFB)) else "0";
    icmp_ln86_720_fu_378_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3F9D7)) else "0";
    icmp_ln86_721_fu_384_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_4DB)) else "0";
    icmp_ln86_722_fu_390_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB05)) else "0";
    icmp_ln86_723_fu_396_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FAB7)) else "0";
    icmp_ln86_724_fu_402_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FAFE)) else "0";
    icmp_ln86_725_fu_408_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB22)) else "0";
    icmp_ln86_726_fu_414_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FABF)) else "0";
    icmp_ln86_727_fu_420_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_1AA)) else "0";
    icmp_ln86_728_fu_426_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB83)) else "0";
    icmp_ln86_729_fu_432_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_2BE)) else "0";
    icmp_ln86_730_fu_438_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3EB33)) else "0";
    icmp_ln86_731_fu_444_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F0D7)) else "0";
    icmp_ln86_732_fu_450_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB28)) else "0";
    icmp_ln86_733_fu_456_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F64F)) else "0";
    icmp_ln86_734_fu_462_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD9A)) else "0";
    icmp_ln86_735_fu_468_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FB80)) else "0";
    icmp_ln86_736_fu_474_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_8B8)) else "0";
    icmp_ln86_fu_300_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_575)) else "0";
