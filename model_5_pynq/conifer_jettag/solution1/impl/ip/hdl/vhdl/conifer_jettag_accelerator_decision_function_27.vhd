...
begin
    sparsemux_63_5_12_1_1_x1_U970 : component conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_765_fu_336_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_213)) else "0";
    icmp_ln86_766_fu_342_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FFC6)) else "0";
    icmp_ln86_767_fu_348_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFAA)) else "0";
    icmp_ln86_768_fu_354_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FE95)) else "0";
    icmp_ln86_769_fu_360_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_19E)) else "0";
    icmp_ln86_770_fu_366_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FEC9)) else "0";
    icmp_ln86_771_fu_372_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFA4)) else "0";
    icmp_ln86_772_fu_378_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF87)) else "0";
    icmp_ln86_773_fu_384_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FACB)) else "0";
    icmp_ln86_774_fu_390_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_5AD)) else "0";
    icmp_ln86_775_fu_396_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF51)) else "0";
    icmp_ln86_776_fu_402_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FE72)) else "0";
    icmp_ln86_777_fu_408_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF71)) else "0";
    icmp_ln86_778_fu_414_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FE7B)) else "0";
    icmp_ln86_779_fu_420_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF82)) else "0";
    icmp_ln86_780_fu_426_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_71)) else "0";
    icmp_ln86_781_fu_432_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FDE2)) else "0";
    icmp_ln86_782_fu_438_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FCDE)) else "0";
    icmp_ln86_783_fu_444_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF99)) else "0";
    icmp_ln86_784_fu_450_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_260)) else "0";
    icmp_ln86_785_fu_456_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBDA)) else "0";
    icmp_ln86_786_fu_462_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_10F)) else "0";
    icmp_ln86_787_fu_468_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_4E)) else "0";
    icmp_ln86_788_fu_474_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_297)) else "0";
    icmp_ln86_789_fu_480_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FED2)) else "0";
    icmp_ln86_790_fu_486_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_DE)) else "0";
    icmp_ln86_791_fu_492_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_1D8)) else "0";
    icmp_ln86_792_fu_498_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_319)) else "0";
    icmp_ln86_793_fu_504_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_fu_330_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FC6C)) else "0";
