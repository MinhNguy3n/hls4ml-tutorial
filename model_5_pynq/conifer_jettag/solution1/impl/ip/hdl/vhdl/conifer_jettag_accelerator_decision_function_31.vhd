...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x17 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x17_U920 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x17
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_866_fu_296_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FC29)) else "0";
    icmp_ln86_867_fu_302_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD69)) else "0";
    icmp_ln86_868_fu_308_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCC2)) else "0";
    icmp_ln86_869_fu_314_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCCE)) else "0";
    icmp_ln86_870_fu_320_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD62)) else "0";
    icmp_ln86_871_fu_326_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD3C)) else "0";
    icmp_ln86_872_fu_332_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FBF5)) else "0";
    icmp_ln86_873_fu_338_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FBD7)) else "0";
    icmp_ln86_874_fu_344_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FC38)) else "0";
    icmp_ln86_875_fu_350_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FC7B)) else "0";
    icmp_ln86_876_fu_356_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD0E)) else "0";
    icmp_ln86_877_fu_362_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_45B)) else "0";
    icmp_ln86_878_fu_368_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD2B)) else "0";
    icmp_ln86_879_fu_374_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FDD1)) else "0";
    icmp_ln86_880_fu_380_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCB4)) else "0";
    icmp_ln86_881_fu_386_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FCC6)) else "0";
    icmp_ln86_882_fu_392_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_167)) else "0";
    icmp_ln86_883_fu_398_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCE1)) else "0";
    icmp_ln86_884_fu_404_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCC5)) else "0";
    icmp_ln86_885_fu_410_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FE7D)) else "0";
    icmp_ln86_886_fu_416_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCD9)) else "0";
    icmp_ln86_887_fu_422_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCE4)) else "0";
    icmp_ln86_888_fu_428_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FCE6)) else "0";
    icmp_ln86_889_fu_434_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FCBB)) else "0";
    icmp_ln86_890_fu_440_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD49)) else "0";
    icmp_ln86_891_fu_446_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_2DD)) else "0";
    icmp_ln86_892_fu_452_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FE62)) else "0";
    icmp_ln86_893_fu_458_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD39)) else "0";
    icmp_ln86_894_fu_464_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FDC1)) else "0";
    icmp_ln86_895_fu_470_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD6B)) else "0";
    icmp_ln86_fu_290_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FDB7)) else "0";
