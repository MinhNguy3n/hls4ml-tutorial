...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x12 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x12_U725 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x12
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1340_fu_330_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB0C)) else "0";
    icmp_ln86_1341_fu_336_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_1342_fu_342_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FAC4)) else "0";
    icmp_ln86_1343_fu_348_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FACA)) else "0";
    icmp_ln86_1344_fu_354_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_CB)) else "0";
    icmp_ln86_1345_fu_360_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FFE1)) else "0";
    icmp_ln86_1346_fu_366_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FC9A)) else "0";
    icmp_ln86_1347_fu_372_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_2A7)) else "0";
    icmp_ln86_1348_fu_378_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FE15)) else "0";
    icmp_ln86_1349_fu_384_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FBAB)) else "0";
    icmp_ln86_1350_fu_390_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_D4)) else "0";
    icmp_ln86_1351_fu_396_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FFD9)) else "0";
    icmp_ln86_1352_fu_402_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FC5D)) else "0";
    icmp_ln86_1353_fu_408_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_1354_fu_414_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FAB8)) else "0";
    icmp_ln86_1355_fu_420_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB08)) else "0";
    icmp_ln86_1356_fu_426_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD26)) else "0";
    icmp_ln86_1357_fu_432_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_1358_fu_438_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_489)) else "0";
    icmp_ln86_1359_fu_444_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB1B)) else "0";
    icmp_ln86_1360_fu_450_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FB67)) else "0";
    icmp_ln86_1361_fu_456_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCA7)) else "0";
    icmp_ln86_1362_fu_462_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FE5E)) else "0";
    icmp_ln86_1363_fu_468_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_358)) else "0";
    icmp_ln86_1364_fu_474_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_1A)) else "0";
    icmp_ln86_1365_fu_480_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FB4F)) else "0";
    icmp_ln86_1366_fu_486_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FC8D)) else "0";
    icmp_ln86_1367_fu_492_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD81)) else "0";
    icmp_ln86_1368_fu_498_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_28)) else "0";
    icmp_ln86_fu_324_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FAD6)) else "0";
