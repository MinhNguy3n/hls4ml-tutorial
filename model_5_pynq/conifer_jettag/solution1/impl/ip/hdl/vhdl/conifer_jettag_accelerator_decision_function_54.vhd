...
begin
    sparsemux_65_5_13_1_1_x2_U97 : component conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x2
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1320_fu_286_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FE14)) else "0";
    icmp_ln86_1321_fu_292_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_956)) else "0";
    icmp_ln86_1322_fu_298_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FAF4)) else "0";
    icmp_ln86_1323_fu_304_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_20C)) else "0";
    icmp_ln86_1324_fu_310_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FF97)) else "0";
    icmp_ln86_1325_fu_316_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_A11)) else "0";
    icmp_ln86_1326_fu_322_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FC9E)) else "0";
    icmp_ln86_1327_fu_328_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FC3D)) else "0";
    icmp_ln86_1328_fu_334_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FEB7)) else "0";
    icmp_ln86_1329_fu_340_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3F9EA)) else "0";
    icmp_ln86_1330_fu_346_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_81)) else "0";
    icmp_ln86_1331_fu_352_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_14B)) else "0";
    icmp_ln86_1332_fu_358_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_CA9)) else "0";
    icmp_ln86_1333_fu_364_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_E52)) else "0";
    icmp_ln86_1334_fu_370_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD29)) else "0";
    icmp_ln86_1335_fu_376_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FEA3)) else "0";
    icmp_ln86_1336_fu_382_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCA2)) else "0";
    icmp_ln86_1337_fu_388_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FCA3)) else "0";
    icmp_ln86_1338_fu_394_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_186)) else "0";
    icmp_ln86_1339_fu_400_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FF31)) else "0";
    icmp_ln86_1340_fu_406_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_5BE)) else "0";
    icmp_ln86_1341_fu_412_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_8E)) else "0";
    icmp_ln86_1342_fu_418_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FC88)) else "0";
    icmp_ln86_1343_fu_424_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_1D)) else "0";
    icmp_ln86_1344_fu_430_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_1F5)) else "0";
    icmp_ln86_1345_fu_436_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_8C)) else "0";
    icmp_ln86_1346_fu_442_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_17A)) else "0";
    icmp_ln86_1347_fu_448_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_5F8)) else "0";
    icmp_ln86_1348_fu_454_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_1C3)) else "0";
    icmp_ln86_1349_fu_460_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_B8D)) else "0";
    icmp_ln86_fu_280_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF30)) else "0";
