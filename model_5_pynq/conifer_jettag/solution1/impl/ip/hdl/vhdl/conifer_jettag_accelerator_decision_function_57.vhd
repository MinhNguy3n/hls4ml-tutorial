...
begin
    sparsemux_65_5_12_1_1_x16_U603 : component conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x16
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1235_fu_326_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FB34)) else "0";
    icmp_ln86_1236_fu_332_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FEF2)) else "0";
    icmp_ln86_1237_fu_338_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FCCA)) else "0";
    icmp_ln86_1238_fu_344_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_C3)) else "0";
    icmp_ln86_1239_fu_350_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FE09)) else "0";
    icmp_ln86_1240_fu_356_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FE58)) else "0";
    icmp_ln86_1241_fu_362_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_97)) else "0";
    icmp_ln86_1242_fu_368_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF65)) else "0";
    icmp_ln86_1243_fu_374_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FC94)) else "0";
    icmp_ln86_1244_fu_380_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FF8F)) else "0";
    icmp_ln86_1245_fu_386_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FE5F)) else "0";
    icmp_ln86_1246_fu_392_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF13)) else "0";
    icmp_ln86_1247_fu_398_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_2F)) else "0";
    icmp_ln86_1248_fu_404_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FF4C)) else "0";
    icmp_ln86_1249_fu_410_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FEB2)) else "0";
    icmp_ln86_1250_fu_426_p2 <= "1" when (signed(tmp_fu_416_p4) < signed(ap_const_lv12_1)) else "0";
    icmp_ln86_1251_fu_432_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3F907)) else "0";
    icmp_ln86_1252_fu_438_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FA6D)) else "0";
    icmp_ln86_1253_fu_444_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FC0D)) else "0";
    icmp_ln86_1254_fu_450_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FD62)) else "0";
    icmp_ln86_1255_fu_456_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_14D)) else "0";
    icmp_ln86_1256_fu_462_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_194)) else "0";
    icmp_ln86_1257_fu_468_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FDC5)) else "0";
    icmp_ln86_1258_fu_474_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FDBD)) else "0";
    icmp_ln86_1259_fu_480_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FE3B)) else "0";
    icmp_ln86_1260_fu_486_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE32)) else "0";
    icmp_ln86_1261_fu_492_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_101)) else "0";
    icmp_ln86_1262_fu_498_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF59)) else "0";
    icmp_ln86_1263_fu_504_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF31)) else "0";
    icmp_ln86_1264_fu_510_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF71)) else "0";
    icmp_ln86_fu_320_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FE51)) else "0";
    ...
    select_ln117_fu_635_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_416_p4 <= p_read3_int_reg(17 downto 6);
