...
begin
    sparsemux_65_5_11_1_1_x1_U282 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_409_fu_318_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_309)) else "0";
    icmp_ln86_410_fu_324_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_B3)) else "0";
    icmp_ln86_411_fu_330_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FED1)) else "0";
    icmp_ln86_412_fu_336_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD59)) else "0";
    icmp_ln86_413_fu_342_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_4B0)) else "0";
    icmp_ln86_414_fu_348_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_415_fu_354_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_241)) else "0";
    icmp_ln86_416_fu_360_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_B)) else "0";
    icmp_ln86_417_fu_366_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_4F8)) else "0";
    icmp_ln86_418_fu_372_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FFC5)) else "0";
    icmp_ln86_419_fu_378_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_D80)) else "0";
    icmp_ln86_420_fu_384_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_224)) else "0";
    icmp_ln86_421_fu_390_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_413)) else "0";
    icmp_ln86_422_fu_396_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FD3E)) else "0";
    icmp_ln86_423_fu_402_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_424_fu_408_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD56)) else "0";
    icmp_ln86_425_fu_414_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_1F7)) else "0";
    icmp_ln86_426_fu_420_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_156)) else "0";
    icmp_ln86_427_fu_426_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FC0D)) else "0";
    icmp_ln86_428_fu_432_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F656)) else "0";
    icmp_ln86_429_fu_438_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFA9)) else "0";
    icmp_ln86_430_fu_444_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD9F)) else "0";
    icmp_ln86_431_fu_450_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_38A)) else "0";
    icmp_ln86_432_fu_456_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FBEC)) else "0";
    icmp_ln86_433_fu_462_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FD36)) else "0";
    icmp_ln86_434_fu_468_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFD6)) else "0";
    icmp_ln86_435_fu_474_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FAFC)) else "0";
    icmp_ln86_436_fu_480_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FDA0)) else "0";
    icmp_ln86_437_fu_486_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD5A)) else "0";
    icmp_ln86_fu_312_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FE73)) else "0";
