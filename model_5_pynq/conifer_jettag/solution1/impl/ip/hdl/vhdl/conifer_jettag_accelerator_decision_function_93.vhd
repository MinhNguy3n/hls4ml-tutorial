...
entity conifer_jettag_accelerator_decision_function_93 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conifer_jettag_accelerator_decision_function_93 is 
...
begin
    sparsemux_65_5_11_1_1_x0_U197 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv11_0;
    icmp_ln86_171_fu_310_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_104)) else "0";
    icmp_ln86_172_fu_316_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FDB7)) else "0";
    icmp_ln86_173_fu_322_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFEE)) else "0";
    icmp_ln86_174_fu_328_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_4C)) else "0";
    icmp_ln86_175_fu_334_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_176_fu_340_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_150)) else "0";
    icmp_ln86_177_fu_346_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FAFF)) else "0";
    icmp_ln86_178_fu_352_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF89)) else "0";
    icmp_ln86_179_fu_358_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FF68)) else "0";
    icmp_ln86_180_fu_364_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_26C)) else "0";
    icmp_ln86_181_fu_370_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FECD)) else "0";
    icmp_ln86_182_fu_376_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_7B)) else "0";
    icmp_ln86_183_fu_382_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_946)) else "0";
    icmp_ln86_184_fu_388_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_185_fu_394_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF4B)) else "0";
    icmp_ln86_186_fu_400_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_CF)) else "0";
    icmp_ln86_187_fu_406_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_14B)) else "0";
    icmp_ln86_188_fu_412_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_140)) else "0";
    icmp_ln86_189_fu_418_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFFF)) else "0";
    icmp_ln86_190_fu_424_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FE36)) else "0";
    icmp_ln86_191_fu_430_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_140)) else "0";
    icmp_ln86_192_fu_436_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF14)) else "0";
    icmp_ln86_193_fu_442_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_983)) else "0";
    icmp_ln86_194_fu_448_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_856)) else "0";
    icmp_ln86_195_fu_454_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_EE)) else "0";
    icmp_ln86_196_fu_460_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FCCD)) else "0";
    icmp_ln86_197_fu_466_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_43)) else "0";
    icmp_ln86_198_fu_472_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_92)) else "0";
    icmp_ln86_199_fu_478_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCC1)) else "0";
    icmp_ln86_fu_304_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_19A)) else "0";
