...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x28 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x28_U1464(
    .din0(12'd4),
    .din1(12'd3999),
    .din2(12'd83),
    .din3(12'd262),
...
assign icmp_ln86_1870_fu_312_p2 = (($signed(p_read8_int_reg) < $signed(18'd262048)) ? 1'b1 : 1'b0);

assign icmp_ln86_1871_fu_318_p2 = (($signed(p_read8_int_reg) < $signed(18'd262132)) ? 1'b1 : 1'b0);

assign icmp_ln86_1872_fu_324_p2 = (($signed(p_read2_int_reg) < $signed(18'd261614)) ? 1'b1 : 1'b0);

assign icmp_ln86_1873_fu_330_p2 = (($signed(p_read2_int_reg) < $signed(18'd261772)) ? 1'b1 : 1'b0);

assign icmp_ln86_1874_fu_336_p2 = (($signed(p_read9_int_reg) < $signed(18'd454)) ? 1'b1 : 1'b0);

assign icmp_ln86_1875_fu_342_p2 = (($signed(p_read8_int_reg) < $signed(18'd290)) ? 1'b1 : 1'b0);

assign icmp_ln86_1876_fu_348_p2 = (($signed(p_read8_int_reg) < $signed(18'd261774)) ? 1'b1 : 1'b0);

assign icmp_ln86_1877_fu_354_p2 = (($signed(p_read8_int_reg) < $signed(18'd261726)) ? 1'b1 : 1'b0);

assign icmp_ln86_1878_fu_360_p2 = (($signed(p_read8_int_reg) < $signed(18'd49)) ? 1'b1 : 1'b0);

assign icmp_ln86_1879_fu_366_p2 = (($signed(p_read8_int_reg) < $signed(18'd62)) ? 1'b1 : 1'b0);

assign icmp_ln86_1880_fu_372_p2 = (($signed(p_read8_int_reg) < $signed(18'd261965)) ? 1'b1 : 1'b0);

assign icmp_ln86_1881_fu_378_p2 = (($signed(p_read2_int_reg) < $signed(18'd261909)) ? 1'b1 : 1'b0);

assign icmp_ln86_1882_fu_384_p2 = (($signed(p_read2_int_reg) < $signed(18'd53)) ? 1'b1 : 1'b0);

assign icmp_ln86_1883_fu_390_p2 = (($signed(p_read2_int_reg) < $signed(18'd262096)) ? 1'b1 : 1'b0);

assign icmp_ln86_1884_fu_396_p2 = (($signed(p_read2_int_reg) < $signed(18'd261497)) ? 1'b1 : 1'b0);

assign icmp_ln86_1885_fu_402_p2 = (($signed(p_read9_int_reg) < $signed(18'd548)) ? 1'b1 : 1'b0);

assign icmp_ln86_1886_fu_408_p2 = (($signed(p_read9_int_reg) < $signed(18'd1020)) ? 1'b1 : 1'b0);

assign icmp_ln86_1887_fu_414_p2 = (($signed(p_read2_int_reg) < $signed(18'd261835)) ? 1'b1 : 1'b0);

assign icmp_ln86_1888_fu_420_p2 = (($signed(p_read2_int_reg) < $signed(18'd261593)) ? 1'b1 : 1'b0);

assign icmp_ln86_1889_fu_426_p2 = (($signed(p_read5_int_reg) < $signed(18'd260937)) ? 1'b1 : 1'b0);

assign icmp_ln86_1890_fu_432_p2 = (($signed(p_read7_int_reg) < $signed(18'd1179)) ? 1'b1 : 1'b0);

assign icmp_ln86_1891_fu_438_p2 = (($signed(p_read4_int_reg) < $signed(18'd260922)) ? 1'b1 : 1'b0);

assign icmp_ln86_1892_fu_444_p2 = (($signed(p_read2_int_reg) < $signed(18'd243)) ? 1'b1 : 1'b0);

assign icmp_ln86_1893_fu_450_p2 = (($signed(p_read2_int_reg) < $signed(18'd262081)) ? 1'b1 : 1'b0);

assign icmp_ln86_1894_fu_456_p2 = (($signed(p_read6_int_reg) < $signed(18'd1510)) ? 1'b1 : 1'b0);

assign icmp_ln86_1895_fu_462_p2 = (($signed(p_read3_int_reg) < $signed(18'd2185)) ? 1'b1 : 1'b0);

assign icmp_ln86_1896_fu_468_p2 = (($signed(p_read2_int_reg) < $signed(18'd262070)) ? 1'b1 : 1'b0);

assign icmp_ln86_1897_fu_474_p2 = (($signed(p_read9_int_reg) < $signed(18'd832)) ? 1'b1 : 1'b0);

assign icmp_ln86_1898_fu_480_p2 = (($signed(p_read1_int_reg) < $signed(18'd43)) ? 1'b1 : 1'b0);

assign icmp_ln86_1899_fu_486_p2 = (($signed(p_read8_int_reg) < $signed(18'd492)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_306_p2 = (($signed(p_read2_int_reg) < $signed(18'd261888)) ? 1'b1 : 1'b0);
