...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_61_5_12_1_1_x1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 12 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_61_5_12_1_1_x1_U1439(
    .din0(12'd252),
    .din1(12'd3602),
    .din2(12'd234),
    .din3(12'd9),
...
assign icmp_ln86_1782_fu_310_p2 = (($signed(p_read1_int_reg) < $signed(18'd901)) ? 1'b1 : 1'b0);

assign icmp_ln86_1783_fu_316_p2 = (($signed(p_read7_int_reg) < $signed(18'd1189)) ? 1'b1 : 1'b0);

assign icmp_ln86_1784_fu_322_p2 = (($signed(p_read2_int_reg) < $signed(18'd261853)) ? 1'b1 : 1'b0);

assign icmp_ln86_1785_fu_328_p2 = (($signed(p_read2_int_reg) < $signed(18'd261339)) ? 1'b1 : 1'b0);

assign icmp_ln86_1786_fu_334_p2 = (($signed(p_read10_int_reg) < $signed(18'd2579)) ? 1'b1 : 1'b0);

assign icmp_ln86_1787_fu_340_p2 = (($signed(p_read4_int_reg) < $signed(18'd261595)) ? 1'b1 : 1'b0);

assign icmp_ln86_1788_fu_346_p2 = (($signed(p_read5_int_reg) < $signed(18'd173)) ? 1'b1 : 1'b0);

assign icmp_ln86_1789_fu_352_p2 = (($signed(p_read1_int_reg) < $signed(18'd696)) ? 1'b1 : 1'b0);

assign icmp_ln86_1790_fu_358_p2 = (($signed(p_read8_int_reg) < $signed(18'd702)) ? 1'b1 : 1'b0);

assign icmp_ln86_1791_fu_364_p2 = (($signed(p_read9_int_reg) < $signed(18'd194)) ? 1'b1 : 1'b0);

assign icmp_ln86_1792_fu_370_p2 = (($signed(p_read1_int_reg) < $signed(18'd260060)) ? 1'b1 : 1'b0);

assign icmp_ln86_1793_fu_376_p2 = (($signed(p_read6_int_reg) < $signed(18'd1638)) ? 1'b1 : 1'b0);

assign icmp_ln86_1794_fu_382_p2 = (($signed(p_read4_int_reg) < $signed(18'd261578)) ? 1'b1 : 1'b0);

assign icmp_ln86_1795_fu_388_p2 = (($signed(p_read2_int_reg) < $signed(18'd262125)) ? 1'b1 : 1'b0);

assign icmp_ln86_1796_fu_394_p2 = (($signed(p_read10_int_reg) < $signed(18'd260992)) ? 1'b1 : 1'b0);

assign icmp_ln86_1797_fu_400_p2 = (($signed(p_read6_int_reg) < $signed(18'd820)) ? 1'b1 : 1'b0);

assign icmp_ln86_1798_fu_406_p2 = (($signed(p_read10_int_reg) < $signed(18'd261464)) ? 1'b1 : 1'b0);

assign icmp_ln86_1799_fu_412_p2 = (($signed(p_read7_int_reg) < $signed(18'd2318)) ? 1'b1 : 1'b0);

assign icmp_ln86_1800_fu_418_p2 = (($signed(p_read7_int_reg) < $signed(18'd1727)) ? 1'b1 : 1'b0);

assign icmp_ln86_1801_fu_424_p2 = (($signed(p_read10_int_reg) < $signed(18'd260519)) ? 1'b1 : 1'b0);

assign icmp_ln86_1802_fu_430_p2 = (($signed(p_read10_int_reg) < $signed(18'd260803)) ? 1'b1 : 1'b0);

assign icmp_ln86_1803_fu_436_p2 = (($signed(p_read3_int_reg) < $signed(18'd261913)) ? 1'b1 : 1'b0);

assign icmp_ln86_1804_fu_442_p2 = (($signed(p_read2_int_reg) < $signed(18'd1011)) ? 1'b1 : 1'b0);

assign icmp_ln86_1805_fu_448_p2 = (($signed(p_read5_int_reg) < $signed(18'd4036)) ? 1'b1 : 1'b0);

assign icmp_ln86_1806_fu_454_p2 = (($signed(p_read4_int_reg) < $signed(18'd261775)) ? 1'b1 : 1'b0);

assign icmp_ln86_1807_fu_460_p2 = (($signed(p_read4_int_reg) < $signed(18'd261577)) ? 1'b1 : 1'b0);

assign icmp_ln86_1808_fu_466_p2 = (($signed(p_read4_int_reg) < $signed(18'd206)) ? 1'b1 : 1'b0);

assign icmp_ln86_1809_fu_472_p2 = (($signed(p_read2_int_reg) < $signed(18'd787)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_304_p2 = (($signed(p_read10_int_reg) < $signed(18'd832)) ? 1'b1 : 1'b0);
