...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x8 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 12 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_63_5_12_1_1_x8_U1359(
    .din0(12'd3965),
    .din1(12'd4059),
    .din2(12'd425),
    .din3(12'd423),
...
assign icmp_ln86_1606_fu_336_p2 = (($signed(p_read1_int_reg) < $signed(18'd262114)) ? 1'b1 : 1'b0);

assign icmp_ln86_1607_fu_342_p2 = (($signed(p_read10_int_reg) < $signed(18'd1893)) ? 1'b1 : 1'b0);

assign icmp_ln86_1608_fu_348_p2 = (($signed(p_read10_int_reg) < $signed(18'd260756)) ? 1'b1 : 1'b0);

assign icmp_ln86_1609_fu_354_p2 = (($signed(p_read5_int_reg) < $signed(18'd261875)) ? 1'b1 : 1'b0);

assign icmp_ln86_1610_fu_360_p2 = (($signed(p_read9_int_reg) < $signed(18'd1624)) ? 1'b1 : 1'b0);

assign icmp_ln86_1611_fu_366_p2 = (($signed(p_read4_int_reg) < $signed(18'd3316)) ? 1'b1 : 1'b0);

assign icmp_ln86_1612_fu_372_p2 = (($signed(p_read12_int_reg) < $signed(18'd1388)) ? 1'b1 : 1'b0);

assign icmp_ln86_1613_fu_378_p2 = (($signed(p_read8_int_reg) < $signed(18'd261120)) ? 1'b1 : 1'b0);

assign icmp_ln86_1614_fu_384_p2 = (($signed(p_read3_int_reg) < $signed(18'd260872)) ? 1'b1 : 1'b0);

assign icmp_ln86_1615_fu_390_p2 = (($signed(p_read4_int_reg) < $signed(18'd261758)) ? 1'b1 : 1'b0);

assign icmp_ln86_1616_fu_396_p2 = (($signed(p_read3_int_reg) < $signed(18'd2483)) ? 1'b1 : 1'b0);

assign icmp_ln86_1617_fu_402_p2 = (($signed(p_read3_int_reg) < $signed(18'd3582)) ? 1'b1 : 1'b0);

assign icmp_ln86_1618_fu_408_p2 = (($signed(p_read6_int_reg) < $signed(18'd3713)) ? 1'b1 : 1'b0);

assign icmp_ln86_1619_fu_414_p2 = (($signed(p_read9_int_reg) < $signed(18'd1644)) ? 1'b1 : 1'b0);

assign icmp_ln86_1620_fu_420_p2 = (($signed(p_read6_int_reg) < $signed(18'd261573)) ? 1'b1 : 1'b0);

assign icmp_ln86_1621_fu_426_p2 = (($signed(p_read2_int_reg) < $signed(18'd479)) ? 1'b1 : 1'b0);

assign icmp_ln86_1622_fu_432_p2 = (($signed(p_read12_int_reg) < $signed(18'd262114)) ? 1'b1 : 1'b0);

assign icmp_ln86_1623_fu_438_p2 = (($signed(p_read11_int_reg) < $signed(18'd261196)) ? 1'b1 : 1'b0);

assign icmp_ln86_1624_fu_444_p2 = (($signed(p_read12_int_reg) < $signed(18'd260794)) ? 1'b1 : 1'b0);

assign icmp_ln86_1625_fu_450_p2 = (($signed(p_read12_int_reg) < $signed(18'd260800)) ? 1'b1 : 1'b0);

assign icmp_ln86_1626_fu_456_p2 = (($signed(p_read2_int_reg) < $signed(18'd216)) ? 1'b1 : 1'b0);

assign icmp_ln86_1627_fu_462_p2 = (($signed(p_read12_int_reg) < $signed(18'd262046)) ? 1'b1 : 1'b0);

assign icmp_ln86_1628_fu_468_p2 = (($signed(p_read1_int_reg) < $signed(18'd260478)) ? 1'b1 : 1'b0);

assign icmp_ln86_1629_fu_474_p2 = (($signed(p_read6_int_reg) < $signed(18'd4896)) ? 1'b1 : 1'b0);

assign icmp_ln86_1630_fu_480_p2 = (($signed(p_read7_int_reg) < $signed(18'd262121)) ? 1'b1 : 1'b0);

assign icmp_ln86_1631_fu_486_p2 = (($signed(p_read6_int_reg) < $signed(18'd1827)) ? 1'b1 : 1'b0);

assign icmp_ln86_1632_fu_492_p2 = (($signed(p_read11_int_reg) < $signed(18'd1409)) ? 1'b1 : 1'b0);

assign icmp_ln86_1633_fu_498_p2 = (($signed(p_read5_int_reg) < $signed(18'd3215)) ? 1'b1 : 1'b0);

assign icmp_ln86_1634_fu_504_p2 = (($signed(p_read13_int_reg) < $signed(18'd2674)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_330_p2 = (($signed(p_read9_int_reg) < $signed(18'd1623)) ? 1'b1 : 1'b0);
