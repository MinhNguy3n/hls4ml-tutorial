...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x3 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_63_5_12_1_1_x3_U1096(
    .din0(12'd2037),
    .din1(12'd244),
    .din2(12'd4082),
    .din3(12'd3988),
...
assign icmp_ln86_481_fu_334_p2 = (($signed(p_read8_int_reg) < $signed(18'd1838)) ? 1'b1 : 1'b0);

assign icmp_ln86_482_fu_340_p2 = (($signed(p_read9_int_reg) < $signed(18'd1239)) ? 1'b1 : 1'b0);

assign icmp_ln86_483_fu_346_p2 = (($signed(p_read1_int_reg) < $signed(18'd261171)) ? 1'b1 : 1'b0);

assign icmp_ln86_484_fu_352_p2 = (($signed(p_read1_int_reg) < $signed(18'd260732)) ? 1'b1 : 1'b0);

assign icmp_ln86_485_fu_358_p2 = (($signed(p_read4_int_reg) < $signed(18'd261945)) ? 1'b1 : 1'b0);

assign icmp_ln86_486_fu_364_p2 = (($signed(p_read7_int_reg) < $signed(18'd262020)) ? 1'b1 : 1'b0);

assign icmp_ln86_487_fu_370_p2 = (($signed(p_read2_int_reg) < $signed(18'd782)) ? 1'b1 : 1'b0);

assign icmp_ln86_488_fu_376_p2 = (($signed(p_read13_int_reg) < $signed(18'd690)) ? 1'b1 : 1'b0);

assign icmp_ln86_489_fu_382_p2 = (($signed(p_read2_int_reg) < $signed(18'd807)) ? 1'b1 : 1'b0);

assign icmp_ln86_490_fu_388_p2 = (($signed(p_read3_int_reg) < $signed(18'd260966)) ? 1'b1 : 1'b0);

assign icmp_ln86_491_fu_394_p2 = (($signed(p_read1_int_reg) < $signed(18'd260636)) ? 1'b1 : 1'b0);

assign icmp_ln86_492_fu_400_p2 = (($signed(p_read5_int_reg) < $signed(18'd261994)) ? 1'b1 : 1'b0);

assign icmp_ln86_493_fu_406_p2 = (($signed(p_read10_int_reg) < $signed(18'd1245)) ? 1'b1 : 1'b0);

assign icmp_ln86_494_fu_412_p2 = (($signed(p_read6_int_reg) < $signed(18'd57)) ? 1'b1 : 1'b0);

assign icmp_ln86_495_fu_418_p2 = (($signed(p_read4_int_reg) < $signed(18'd261838)) ? 1'b1 : 1'b0);

assign icmp_ln86_496_fu_424_p2 = (($signed(p_read12_int_reg) < $signed(18'd12)) ? 1'b1 : 1'b0);

assign icmp_ln86_497_fu_430_p2 = (($signed(p_read5_int_reg) < $signed(18'd1290)) ? 1'b1 : 1'b0);

assign icmp_ln86_498_fu_436_p2 = (($signed(p_read6_int_reg) < $signed(18'd260762)) ? 1'b1 : 1'b0);

assign icmp_ln86_499_fu_442_p2 = (($signed(p_read11_int_reg) < $signed(18'd1637)) ? 1'b1 : 1'b0);

assign icmp_ln86_500_fu_448_p2 = (($signed(p_read2_int_reg) < $signed(18'd262001)) ? 1'b1 : 1'b0);

assign icmp_ln86_501_fu_454_p2 = (($signed(p_read4_int_reg) < $signed(18'd261885)) ? 1'b1 : 1'b0);

assign icmp_ln86_502_fu_460_p2 = (($signed(p_read4_int_reg) < $signed(18'd261785)) ? 1'b1 : 1'b0);

assign icmp_ln86_503_fu_466_p2 = (($signed(p_read2_int_reg) < $signed(18'd846)) ? 1'b1 : 1'b0);

assign icmp_ln86_504_fu_472_p2 = (($signed(p_read2_int_reg) < $signed(18'd262114)) ? 1'b1 : 1'b0);

assign icmp_ln86_505_fu_478_p2 = (($signed(p_read9_int_reg) < $signed(18'd1291)) ? 1'b1 : 1'b0);

assign icmp_ln86_506_fu_484_p2 = (($signed(p_read13_int_reg) < $signed(18'd1729)) ? 1'b1 : 1'b0);

assign icmp_ln86_507_fu_490_p2 = (($signed(p_read6_int_reg) < $signed(18'd262121)) ? 1'b1 : 1'b0);

assign icmp_ln86_508_fu_496_p2 = (($signed(p_read13_int_reg) < $signed(18'd3241)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_328_p2 = (($signed(p_read13_int_reg) < $signed(18'd1304)) ? 1'b1 : 1'b0);
