...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x21 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x21_U956(
    .din0(12'd136),
    .din1(12'd24),
    .din2(12'd3614),
    .din3(12'd219),
...
assign icmp_ln86_794_fu_334_p2 = (($signed(p_read1_int_reg) < $signed(18'd1023)) ? 1'b1 : 1'b0);

assign icmp_ln86_795_fu_340_p2 = (($signed(p_read1_int_reg) < $signed(18'd260905)) ? 1'b1 : 1'b0);

assign icmp_ln86_796_fu_346_p2 = (($signed(p_read2_int_reg) < $signed(18'd261582)) ? 1'b1 : 1'b0);

assign icmp_ln86_797_fu_352_p2 = (($signed(p_read2_int_reg) < $signed(18'd261073)) ? 1'b1 : 1'b0);

assign icmp_ln86_798_fu_358_p2 = (($signed(p_read11_int_reg) < $signed(18'd153)) ? 1'b1 : 1'b0);

assign icmp_ln86_799_fu_364_p2 = (($signed(p_read11_int_reg) < $signed(18'd137)) ? 1'b1 : 1'b0);

assign icmp_ln86_800_fu_370_p2 = (($signed(p_read5_int_reg) < $signed(18'd1507)) ? 1'b1 : 1'b0);

assign icmp_ln86_801_fu_376_p2 = (($signed(p_read12_int_reg) < $signed(18'd260897)) ? 1'b1 : 1'b0);

assign icmp_ln86_802_fu_382_p2 = (($signed(p_read1_int_reg) < $signed(18'd1624)) ? 1'b1 : 1'b0);

assign icmp_ln86_803_fu_388_p2 = (($signed(p_read12_int_reg) < $signed(18'd260850)) ? 1'b1 : 1'b0);

assign icmp_ln86_804_fu_394_p2 = (($signed(p_read11_int_reg) < $signed(18'd262138)) ? 1'b1 : 1'b0);

assign icmp_ln86_805_fu_400_p2 = (($signed(p_read11_int_reg) < $signed(18'd1210)) ? 1'b1 : 1'b0);

assign icmp_ln86_806_fu_406_p2 = (($signed(p_read3_int_reg) < $signed(18'd118)) ? 1'b1 : 1'b0);

assign icmp_ln86_807_fu_412_p2 = (($signed(p_read8_int_reg) < $signed(18'd261023)) ? 1'b1 : 1'b0);

assign icmp_ln86_808_fu_418_p2 = (($signed(p_read1_int_reg) < $signed(18'd548)) ? 1'b1 : 1'b0);

assign icmp_ln86_809_fu_424_p2 = (($signed(p_read6_int_reg) < $signed(18'd78)) ? 1'b1 : 1'b0);

assign icmp_ln86_810_fu_430_p2 = (($signed(p_read11_int_reg) < $signed(18'd165)) ? 1'b1 : 1'b0);

assign icmp_ln86_811_fu_436_p2 = (($signed(p_read1_int_reg) < $signed(18'd619)) ? 1'b1 : 1'b0);

assign icmp_ln86_812_fu_442_p2 = (($signed(p_read7_int_reg) < $signed(18'd311)) ? 1'b1 : 1'b0);

assign icmp_ln86_813_fu_448_p2 = (($signed(p_read7_int_reg) < $signed(18'd260965)) ? 1'b1 : 1'b0);

assign icmp_ln86_814_fu_454_p2 = (($signed(p_read5_int_reg) < $signed(18'd260384)) ? 1'b1 : 1'b0);

assign icmp_ln86_815_fu_460_p2 = (($signed(p_read10_int_reg) < $signed(18'd259844)) ? 1'b1 : 1'b0);

assign icmp_ln86_816_fu_466_p2 = (($signed(p_read4_int_reg) < $signed(18'd261822)) ? 1'b1 : 1'b0);

assign icmp_ln86_817_fu_472_p2 = (($signed(p_read2_int_reg) < $signed(18'd940)) ? 1'b1 : 1'b0);

assign icmp_ln86_818_fu_478_p2 = (($signed(p_read2_int_reg) < $signed(18'd816)) ? 1'b1 : 1'b0);

assign icmp_ln86_819_fu_484_p2 = (($signed(p_read4_int_reg) < $signed(18'd1307)) ? 1'b1 : 1'b0);

assign icmp_ln86_820_fu_490_p2 = (($signed(p_read3_int_reg) < $signed(18'd262002)) ? 1'b1 : 1'b0);

assign icmp_ln86_821_fu_496_p2 = (($signed(p_read6_int_reg) < $signed(18'd261201)) ? 1'b1 : 1'b0);

assign icmp_ln86_822_fu_502_p2 = (($signed(p_read9_int_reg) < $signed(18'd261021)) ? 1'b1 : 1'b0);

assign icmp_ln86_823_fu_508_p2 = (($signed(p_read3_int_reg) < $signed(18'd1729)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_328_p2 = (($signed(p_read12_int_reg) < $signed(18'd832)) ? 1'b1 : 1'b0);
