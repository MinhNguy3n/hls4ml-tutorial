...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x16 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 11 ))
sparsemux_65_5_11_1_1_x16_U808(
    .din0(11'd2035),
    .din1(11'd166),
    .din2(11'd1539),
    .din3(11'd1944),
...
assign icmp_ln86_1132_fu_342_p2 = (($signed(p_read3_int_reg) < $signed(18'd2568)) ? 1'b1 : 1'b0);

assign icmp_ln86_1133_fu_348_p2 = (($signed(p_read9_int_reg) < $signed(18'd261496)) ? 1'b1 : 1'b0);

assign icmp_ln86_1134_fu_354_p2 = (($signed(p_read9_int_reg) < $signed(18'd260807)) ? 1'b1 : 1'b0);

assign icmp_ln86_1135_fu_360_p2 = (($signed(p_read8_int_reg) < $signed(18'd260990)) ? 1'b1 : 1'b0);

assign icmp_ln86_1136_fu_366_p2 = (($signed(p_read11_int_reg) < $signed(18'd1543)) ? 1'b1 : 1'b0);

assign icmp_ln86_1137_fu_372_p2 = (($signed(p_read6_int_reg) < $signed(18'd261945)) ? 1'b1 : 1'b0);

assign icmp_ln86_1138_fu_378_p2 = (($signed(p_read11_int_reg) < $signed(18'd1514)) ? 1'b1 : 1'b0);

assign icmp_ln86_1139_fu_384_p2 = (($signed(p_read11_int_reg) < $signed(18'd1720)) ? 1'b1 : 1'b0);

assign icmp_ln86_1140_fu_390_p2 = (($signed(p_read11_int_reg) < $signed(18'd1978)) ? 1'b1 : 1'b0);

assign icmp_ln86_1141_fu_396_p2 = (($signed(p_read12_int_reg) < $signed(18'd262078)) ? 1'b1 : 1'b0);

assign icmp_ln86_1142_fu_402_p2 = (($signed(p_read3_int_reg) < $signed(18'd262073)) ? 1'b1 : 1'b0);

assign icmp_ln86_1143_fu_408_p2 = (($signed(p_read3_int_reg) < $signed(18'd1739)) ? 1'b1 : 1'b0);

assign icmp_ln86_1145_fu_430_p2 = (($signed(p_read9_int_reg) < $signed(18'd184)) ? 1'b1 : 1'b0);

assign icmp_ln86_1146_fu_436_p2 = (($signed(p_read12_int_reg) < $signed(18'd262031)) ? 1'b1 : 1'b0);

assign icmp_ln86_1147_fu_442_p2 = (($signed(p_read4_int_reg) < $signed(18'd35)) ? 1'b1 : 1'b0);

assign icmp_ln86_1148_fu_448_p2 = (($signed(p_read11_int_reg) < $signed(18'd191)) ? 1'b1 : 1'b0);

assign icmp_ln86_1149_fu_454_p2 = (($signed(p_read12_int_reg) < $signed(18'd643)) ? 1'b1 : 1'b0);

assign icmp_ln86_1150_fu_460_p2 = (($signed(p_read2_int_reg) < $signed(18'd691)) ? 1'b1 : 1'b0);

assign icmp_ln86_1151_fu_466_p2 = (($signed(p_read11_int_reg) < $signed(18'd2017)) ? 1'b1 : 1'b0);

assign icmp_ln86_1152_fu_472_p2 = (($signed(p_read11_int_reg) < $signed(18'd1051)) ? 1'b1 : 1'b0);

assign icmp_ln86_1153_fu_478_p2 = (($signed(p_read11_int_reg) < $signed(18'd1708)) ? 1'b1 : 1'b0);

assign icmp_ln86_1154_fu_484_p2 = (($signed(p_read8_int_reg) < $signed(18'd261236)) ? 1'b1 : 1'b0);

assign icmp_ln86_1155_fu_490_p2 = (($signed(p_read11_int_reg) < $signed(18'd374)) ? 1'b1 : 1'b0);

assign icmp_ln86_1156_fu_496_p2 = (($signed(p_read7_int_reg) < $signed(18'd261538)) ? 1'b1 : 1'b0);

assign icmp_ln86_1157_fu_502_p2 = (($signed(p_read1_int_reg) < $signed(18'd260878)) ? 1'b1 : 1'b0);

assign icmp_ln86_1158_fu_508_p2 = (($signed(p_read3_int_reg) < $signed(18'd2091)) ? 1'b1 : 1'b0);

assign icmp_ln86_1159_fu_514_p2 = (($signed(p_read11_int_reg) < $signed(18'd170)) ? 1'b1 : 1'b0);

assign icmp_ln86_1160_fu_520_p2 = (($signed(p_read2_int_reg) < $signed(18'd406)) ? 1'b1 : 1'b0);

assign icmp_ln86_1161_fu_526_p2 = (($signed(p_read10_int_reg) < $signed(18'd308)) ? 1'b1 : 1'b0);

assign icmp_ln86_1458_fu_424_p2 = (($signed(tmp_fu_414_p4) < $signed(11'd1)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_336_p2 = (($signed(p_read6_int_reg) < $signed(18'd261218)) ? 1'b1 : 1'b0);
...
assign tmp_fu_414_p4 = {{p_read5_int_reg[17:7]}};
