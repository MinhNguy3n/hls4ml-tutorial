...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x9 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 11 ),
...
assign icmp_ln86_1265_fu_324_p2 = (($signed(p_read3_int_reg) < $signed(18'd261913)) ? 1'b1 : 1'b0);

assign icmp_ln86_1266_fu_330_p2 = (($signed(p_read8_int_reg) < $signed(18'd621)) ? 1'b1 : 1'b0);

assign icmp_ln86_1267_fu_336_p2 = (($signed(p_read10_int_reg) < $signed(18'd102)) ? 1'b1 : 1'b0);

assign icmp_ln86_1268_fu_342_p2 = (($signed(p_read10_int_reg) < $signed(18'd73)) ? 1'b1 : 1'b0);

assign icmp_ln86_1269_fu_348_p2 = (($signed(p_read10_int_reg) < $signed(18'd192)) ? 1'b1 : 1'b0);

assign icmp_ln86_1270_fu_354_p2 = (($signed(p_read10_int_reg) < $signed(18'd261970)) ? 1'b1 : 1'b0);

assign icmp_ln86_1271_fu_360_p2 = (($signed(p_read6_int_reg) < $signed(18'd1476)) ? 1'b1 : 1'b0);

assign icmp_ln86_1272_fu_366_p2 = (($signed(p_read4_int_reg) < $signed(18'd165)) ? 1'b1 : 1'b0);

assign icmp_ln86_1273_fu_372_p2 = (($signed(p_read3_int_reg) < $signed(18'd261937)) ? 1'b1 : 1'b0);

assign icmp_ln86_1274_fu_378_p2 = (($signed(p_read3_int_reg) < $signed(18'd261955)) ? 1'b1 : 1'b0);

assign icmp_ln86_1275_fu_384_p2 = (($signed(p_read2_int_reg) < $signed(18'd39)) ? 1'b1 : 1'b0);

assign icmp_ln86_1276_fu_390_p2 = (($signed(p_read3_int_reg) < $signed(18'd261720)) ? 1'b1 : 1'b0);

assign icmp_ln86_1277_fu_396_p2 = (($signed(p_read3_int_reg) < $signed(18'd261943)) ? 1'b1 : 1'b0);

assign icmp_ln86_1278_fu_402_p2 = (($signed(p_read1_int_reg) < $signed(18'd297)) ? 1'b1 : 1'b0);

assign icmp_ln86_1279_fu_408_p2 = (($signed(p_read10_int_reg) < $signed(18'd262042)) ? 1'b1 : 1'b0);

assign icmp_ln86_1280_fu_414_p2 = (($signed(p_read11_int_reg) < $signed(18'd262125)) ? 1'b1 : 1'b0);

assign icmp_ln86_1281_fu_420_p2 = (($signed(p_read11_int_reg) < $signed(18'd784)) ? 1'b1 : 1'b0);

assign icmp_ln86_1282_fu_426_p2 = (($signed(p_read10_int_reg) < $signed(18'd262133)) ? 1'b1 : 1'b0);

assign icmp_ln86_1283_fu_432_p2 = (($signed(p_read11_int_reg) < $signed(18'd261889)) ? 1'b1 : 1'b0);

assign icmp_ln86_1284_fu_438_p2 = (($signed(p_read6_int_reg) < $signed(18'd261426)) ? 1'b1 : 1'b0);

assign icmp_ln86_1285_fu_444_p2 = (($signed(p_read3_int_reg) < $signed(18'd262112)) ? 1'b1 : 1'b0);

assign icmp_ln86_1286_fu_450_p2 = (($signed(p_read7_int_reg) < $signed(18'd261366)) ? 1'b1 : 1'b0);

assign icmp_ln86_1287_fu_456_p2 = (($signed(p_read3_int_reg) < $signed(18'd262006)) ? 1'b1 : 1'b0);

assign icmp_ln86_1288_fu_462_p2 = (($signed(p_read9_int_reg) < $signed(18'd261314)) ? 1'b1 : 1'b0);

assign icmp_ln86_1289_fu_468_p2 = (($signed(p_read10_int_reg) < $signed(18'd2082)) ? 1'b1 : 1'b0);

assign icmp_ln86_1290_fu_474_p2 = (($signed(p_read9_int_reg) < $signed(18'd1212)) ? 1'b1 : 1'b0);

assign icmp_ln86_1291_fu_480_p2 = (($signed(p_read10_int_reg) < $signed(18'd261963)) ? 1'b1 : 1'b0);

assign icmp_ln86_1292_fu_486_p2 = (($signed(p_read2_int_reg) < $signed(18'd262010)) ? 1'b1 : 1'b0);

assign icmp_ln86_1293_fu_492_p2 = (($signed(p_read10_int_reg) < $signed(18'd883)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_318_p2 = (($signed(p_read5_int_reg) < $signed(18'd262132)) ? 1'b1 : 1'b0);
