...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x15 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x15_U579(
    .din0(12'd10),
    .din1(12'd3871),
    .din2(12'd1629),
    .din3(12'd531),
...
assign icmp_ln86_1176_fu_294_p2 = (($signed(p_read6_int_reg) < $signed(18'd261650)) ? 1'b1 : 1'b0);

assign icmp_ln86_1177_fu_300_p2 = (($signed(p_read6_int_reg) < $signed(18'd261856)) ? 1'b1 : 1'b0);

assign icmp_ln86_1178_fu_306_p2 = (($signed(p_read3_int_reg) < $signed(18'd261409)) ? 1'b1 : 1'b0);

assign icmp_ln86_1179_fu_312_p2 = (($signed(p_read3_int_reg) < $signed(18'd261504)) ? 1'b1 : 1'b0);

assign icmp_ln86_1180_fu_318_p2 = (($signed(p_read6_int_reg) < $signed(18'd261520)) ? 1'b1 : 1'b0);

assign icmp_ln86_1181_fu_324_p2 = (($signed(p_read3_int_reg) < $signed(18'd261637)) ? 1'b1 : 1'b0);

assign icmp_ln86_1182_fu_330_p2 = (($signed(p_read6_int_reg) < $signed(18'd261418)) ? 1'b1 : 1'b0);

assign icmp_ln86_1183_fu_336_p2 = (($signed(p_read6_int_reg) < $signed(18'd261544)) ? 1'b1 : 1'b0);

assign icmp_ln86_1184_fu_342_p2 = (($signed(p_read6_int_reg) < $signed(18'd261965)) ? 1'b1 : 1'b0);

assign icmp_ln86_1185_fu_348_p2 = (($signed(p_read6_int_reg) < $signed(18'd261709)) ? 1'b1 : 1'b0);

assign icmp_ln86_1186_fu_354_p2 = (($signed(p_read7_int_reg) < $signed(18'd406)) ? 1'b1 : 1'b0);

assign icmp_ln86_1187_fu_360_p2 = (($signed(p_read3_int_reg) < $signed(18'd261719)) ? 1'b1 : 1'b0);

assign icmp_ln86_1188_fu_366_p2 = (($signed(p_read6_int_reg) < $signed(18'd142)) ? 1'b1 : 1'b0);

assign icmp_ln86_1189_fu_372_p2 = (($signed(p_read6_int_reg) < $signed(18'd444)) ? 1'b1 : 1'b0);

assign icmp_ln86_1190_fu_378_p2 = (($signed(p_read3_int_reg) < $signed(18'd261370)) ? 1'b1 : 1'b0);

assign icmp_ln86_1191_fu_384_p2 = (($signed(p_read4_int_reg) < $signed(18'd261268)) ? 1'b1 : 1'b0);

assign icmp_ln86_1192_fu_390_p2 = (($signed(p_read6_int_reg) < $signed(18'd261331)) ? 1'b1 : 1'b0);

assign icmp_ln86_1193_fu_396_p2 = (($signed(p_read3_int_reg) < $signed(18'd261469)) ? 1'b1 : 1'b0);

assign icmp_ln86_1194_fu_402_p2 = (($signed(p_read7_int_reg) < $signed(18'd312)) ? 1'b1 : 1'b0);

assign icmp_ln86_1195_fu_408_p2 = (($signed(p_read6_int_reg) < $signed(18'd41)) ? 1'b1 : 1'b0);

assign icmp_ln86_1196_fu_414_p2 = (($signed(p_read2_int_reg) < $signed(18'd261523)) ? 1'b1 : 1'b0);

assign icmp_ln86_1197_fu_420_p2 = (($signed(p_read6_int_reg) < $signed(18'd9)) ? 1'b1 : 1'b0);

assign icmp_ln86_1198_fu_426_p2 = (($signed(p_read3_int_reg) < $signed(18'd261823)) ? 1'b1 : 1'b0);

assign icmp_ln86_1199_fu_432_p2 = (($signed(p_read5_int_reg) < $signed(18'd262104)) ? 1'b1 : 1'b0);

assign icmp_ln86_1200_fu_438_p2 = (($signed(p_read3_int_reg) < $signed(18'd261577)) ? 1'b1 : 1'b0);

assign icmp_ln86_1201_fu_444_p2 = (($signed(p_read7_int_reg) < $signed(18'd1540)) ? 1'b1 : 1'b0);

assign icmp_ln86_1202_fu_450_p2 = (($signed(p_read7_int_reg) < $signed(18'd261889)) ? 1'b1 : 1'b0);

assign icmp_ln86_1203_fu_456_p2 = (($signed(p_read1_int_reg) < $signed(18'd749)) ? 1'b1 : 1'b0);

assign icmp_ln86_1204_fu_462_p2 = (($signed(p_read3_int_reg) < $signed(18'd414)) ? 1'b1 : 1'b0);

assign icmp_ln86_1205_fu_468_p2 = (($signed(p_read3_int_reg) < $signed(18'd225)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_288_p2 = (($signed(p_read3_int_reg) < $signed(18'd261530)) ? 1'b1 : 1'b0);
