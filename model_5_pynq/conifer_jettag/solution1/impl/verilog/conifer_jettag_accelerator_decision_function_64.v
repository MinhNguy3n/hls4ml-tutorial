...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x12 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x12_U520(
    .din0(12'd4007),
    .din1(12'd122),
    .din2(12'd3989),
    .din3(12'd3744),
...
assign icmp_ln86_1030_fu_318_p2 = (($signed(p_read9_int_reg) < $signed(18'd337)) ? 1'b1 : 1'b0);

assign icmp_ln86_1031_fu_324_p2 = (($signed(p_read2_int_reg) < $signed(18'd445)) ? 1'b1 : 1'b0);

assign icmp_ln86_1032_fu_330_p2 = (($signed(p_read4_int_reg) < $signed(18'd261845)) ? 1'b1 : 1'b0);

assign icmp_ln86_1033_fu_336_p2 = (($signed(p_read1_int_reg) < $signed(18'd261884)) ? 1'b1 : 1'b0);

assign icmp_ln86_1034_fu_342_p2 = (($signed(p_read10_int_reg) < $signed(18'd312)) ? 1'b1 : 1'b0);

assign icmp_ln86_1035_fu_348_p2 = (($signed(p_read6_int_reg) < $signed(18'd2351)) ? 1'b1 : 1'b0);

assign icmp_ln86_1036_fu_354_p2 = (($signed(p_read8_int_reg) < $signed(18'd261097)) ? 1'b1 : 1'b0);

assign icmp_ln86_1037_fu_360_p2 = (($signed(p_read10_int_reg) < $signed(18'd261795)) ? 1'b1 : 1'b0);

assign icmp_ln86_1038_fu_366_p2 = (($signed(p_read9_int_reg) < $signed(18'd1504)) ? 1'b1 : 1'b0);

assign icmp_ln86_1039_fu_372_p2 = (($signed(p_read6_int_reg) < $signed(18'd260778)) ? 1'b1 : 1'b0);

assign icmp_ln86_1040_fu_378_p2 = (($signed(p_read10_int_reg) < $signed(18'd76)) ? 1'b1 : 1'b0);

assign icmp_ln86_1041_fu_384_p2 = (($signed(p_read4_int_reg) < $signed(18'd261290)) ? 1'b1 : 1'b0);

assign icmp_ln86_1042_fu_390_p2 = (($signed(p_read1_int_reg) < $signed(18'd261169)) ? 1'b1 : 1'b0);

assign icmp_ln86_1043_fu_396_p2 = (($signed(p_read7_int_reg) < $signed(18'd260942)) ? 1'b1 : 1'b0);

assign icmp_ln86_1044_fu_402_p2 = (($signed(p_read5_int_reg) < $signed(18'd261533)) ? 1'b1 : 1'b0);

assign icmp_ln86_1045_fu_408_p2 = (($signed(p_read9_int_reg) < $signed(18'd261897)) ? 1'b1 : 1'b0);

assign icmp_ln86_1046_fu_414_p2 = (($signed(p_read8_int_reg) < $signed(18'd261163)) ? 1'b1 : 1'b0);

assign icmp_ln86_1047_fu_420_p2 = (($signed(p_read8_int_reg) < $signed(18'd261045)) ? 1'b1 : 1'b0);

assign icmp_ln86_1048_fu_426_p2 = (($signed(p_read3_int_reg) < $signed(18'd1715)) ? 1'b1 : 1'b0);

assign icmp_ln86_1049_fu_432_p2 = (($signed(p_read7_int_reg) < $signed(18'd260821)) ? 1'b1 : 1'b0);

assign icmp_ln86_1050_fu_438_p2 = (($signed(p_read8_int_reg) < $signed(18'd260881)) ? 1'b1 : 1'b0);

assign icmp_ln86_1051_fu_444_p2 = (($signed(p_read1_int_reg) < $signed(18'd261843)) ? 1'b1 : 1'b0);

assign icmp_ln86_1052_fu_450_p2 = (($signed(p_read1_int_reg) < $signed(18'd261752)) ? 1'b1 : 1'b0);

assign icmp_ln86_1053_fu_456_p2 = (($signed(p_read9_int_reg) < $signed(18'd260925)) ? 1'b1 : 1'b0);

assign icmp_ln86_1054_fu_462_p2 = (($signed(p_read9_int_reg) < $signed(18'd262020)) ? 1'b1 : 1'b0);

assign icmp_ln86_1055_fu_468_p2 = (($signed(p_read1_int_reg) < $signed(18'd261473)) ? 1'b1 : 1'b0);

assign icmp_ln86_1056_fu_474_p2 = (($signed(p_read1_int_reg) < $signed(18'd261468)) ? 1'b1 : 1'b0);

assign icmp_ln86_1057_fu_480_p2 = (($signed(p_read9_int_reg) < $signed(18'd261450)) ? 1'b1 : 1'b0);

assign icmp_ln86_1058_fu_486_p2 = (($signed(p_read4_int_reg) < $signed(18'd523)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_312_p2 = (($signed(p_read7_int_reg) < $signed(18'd261069)) ? 1'b1 : 1'b0);
