...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x10 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x10_U454(
    .din0(12'd3982),
    .din1(12'd521),
    .din2(12'd3943),
    .din3(12'd3579),
...
assign icmp_ln86_855_fu_314_p2 = (($signed(p_read5_int_reg) < $signed(18'd261047)) ? 1'b1 : 1'b0);

assign icmp_ln86_856_fu_320_p2 = (($signed(p_read4_int_reg) < $signed(18'd261277)) ? 1'b1 : 1'b0);

assign icmp_ln86_857_fu_326_p2 = (($signed(p_read9_int_reg) < $signed(18'd260816)) ? 1'b1 : 1'b0);

assign icmp_ln86_858_fu_332_p2 = (($signed(p_read3_int_reg) < $signed(18'd260954)) ? 1'b1 : 1'b0);

assign icmp_ln86_859_fu_338_p2 = (($signed(p_read10_int_reg) < $signed(18'd261322)) ? 1'b1 : 1'b0);

assign icmp_ln86_860_fu_344_p2 = (($signed(p_read9_int_reg) < $signed(18'd260882)) ? 1'b1 : 1'b0);

assign icmp_ln86_861_fu_350_p2 = (($signed(p_read10_int_reg) < $signed(18'd359)) ? 1'b1 : 1'b0);

assign icmp_ln86_862_fu_356_p2 = (($signed(p_read4_int_reg) < $signed(18'd261275)) ? 1'b1 : 1'b0);

assign icmp_ln86_863_fu_362_p2 = (($signed(p_read6_int_reg) < $signed(18'd261510)) ? 1'b1 : 1'b0);

assign icmp_ln86_864_fu_368_p2 = (($signed(p_read10_int_reg) < $signed(18'd29)) ? 1'b1 : 1'b0);

assign icmp_ln86_865_fu_374_p2 = (($signed(p_read9_int_reg) < $signed(18'd260875)) ? 1'b1 : 1'b0);

assign icmp_ln86_866_fu_380_p2 = (($signed(p_read6_int_reg) < $signed(18'd261507)) ? 1'b1 : 1'b0);

assign icmp_ln86_867_fu_386_p2 = (($signed(p_read4_int_reg) < $signed(18'd261282)) ? 1'b1 : 1'b0);

assign icmp_ln86_868_fu_392_p2 = (($signed(p_read4_int_reg) < $signed(18'd261279)) ? 1'b1 : 1'b0);

assign icmp_ln86_869_fu_398_p2 = (($signed(p_read2_int_reg) < $signed(18'd260289)) ? 1'b1 : 1'b0);

assign icmp_ln86_870_fu_404_p2 = (($signed(p_read10_int_reg) < $signed(18'd261086)) ? 1'b1 : 1'b0);

assign icmp_ln86_871_fu_410_p2 = (($signed(p_read1_int_reg) < $signed(18'd560)) ? 1'b1 : 1'b0);

assign icmp_ln86_872_fu_416_p2 = (($signed(p_read9_int_reg) < $signed(18'd260819)) ? 1'b1 : 1'b0);

assign icmp_ln86_873_fu_422_p2 = (($signed(p_read10_int_reg) < $signed(18'd261700)) ? 1'b1 : 1'b0);

assign icmp_ln86_874_fu_428_p2 = (($signed(p_read3_int_reg) < $signed(18'd260962)) ? 1'b1 : 1'b0);

assign icmp_ln86_875_fu_434_p2 = (($signed(p_read4_int_reg) < $signed(18'd261276)) ? 1'b1 : 1'b0);

assign icmp_ln86_876_fu_440_p2 = (($signed(p_read7_int_reg) < $signed(18'd1822)) ? 1'b1 : 1'b0);

assign icmp_ln86_877_fu_446_p2 = (($signed(p_read7_int_reg) < $signed(18'd261961)) ? 1'b1 : 1'b0);

assign icmp_ln86_878_fu_452_p2 = (($signed(p_read9_int_reg) < $signed(18'd260891)) ? 1'b1 : 1'b0);

assign icmp_ln86_879_fu_458_p2 = (($signed(p_read8_int_reg) < $signed(18'd1243)) ? 1'b1 : 1'b0);

assign icmp_ln86_880_fu_464_p2 = (($signed(p_read10_int_reg) < $signed(18'd261889)) ? 1'b1 : 1'b0);

assign icmp_ln86_881_fu_470_p2 = (($signed(p_read9_int_reg) < $signed(18'd260890)) ? 1'b1 : 1'b0);

assign icmp_ln86_882_fu_476_p2 = (($signed(p_read8_int_reg) < $signed(18'd261815)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_308_p2 = (($signed(p_read9_int_reg) < $signed(18'd260860)) ? 1'b1 : 1'b0);
