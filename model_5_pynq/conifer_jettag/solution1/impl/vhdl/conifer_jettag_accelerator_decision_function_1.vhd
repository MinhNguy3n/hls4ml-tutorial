...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x7 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_63_5_12_1_1_x7_U1305 : component conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x7
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_29_fu_332_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_7DC)) else "0";
    icmp_ln86_30_fu_338_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FE3E)) else "0";
    icmp_ln86_31_fu_344_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_13C)) else "0";
    icmp_ln86_32_fu_350_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3C0)) else "0";
    icmp_ln86_33_fu_356_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FCDC)) else "0";
    icmp_ln86_34_fu_362_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_39E)) else "0";
    icmp_ln86_35_fu_368_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_108)) else "0";
    icmp_ln86_36_fu_374_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FD29)) else "0";
    icmp_ln86_37_fu_380_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_868)) else "0";
    icmp_ln86_38_fu_386_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_60F)) else "0";
    icmp_ln86_39_fu_392_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_814)) else "0";
    icmp_ln86_40_fu_398_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_1152)) else "0";
    icmp_ln86_41_fu_404_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_2DE)) else "0";
    icmp_ln86_42_fu_410_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FDD6)) else "0";
    icmp_ln86_43_fu_416_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F830)) else "0";
    icmp_ln86_44_fu_422_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FF61)) else "0";
    icmp_ln86_45_fu_428_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_46F)) else "0";
    icmp_ln86_46_fu_434_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF50)) else "0";
    icmp_ln86_47_fu_440_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FE1B)) else "0";
    icmp_ln86_48_fu_446_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_38C)) else "0";
    icmp_ln86_49_fu_452_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_50D)) else "0";
    icmp_ln86_50_fu_458_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_406)) else "0";
    icmp_ln86_51_fu_464_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_2B)) else "0";
    icmp_ln86_52_fu_470_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FDB8)) else "0";
    icmp_ln86_53_fu_476_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_22B)) else "0";
    icmp_ln86_54_fu_482_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_EB9)) else "0";
    icmp_ln86_55_fu_488_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_D71)) else "0";
    icmp_ln86_56_fu_494_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_2CB)) else "0";
    icmp_ln86_57_fu_500_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_C10)) else "0";
    icmp_ln86_fu_326_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3EB)) else "0";
