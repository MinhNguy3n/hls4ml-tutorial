...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_55_5_11_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_55_5_11_1_1_U1557 : component conifer_jettag_accelerator_sparsemux_55_5_11_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_2069_fu_314_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_87E)) else "0";
    icmp_ln86_2070_fu_320_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_1009)) else "0";
    icmp_ln86_2071_fu_326_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_4E0)) else "0";
    icmp_ln86_2072_fu_332_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_F3)) else "0";
    icmp_ln86_2073_fu_338_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_1830)) else "0";
    icmp_ln86_2074_fu_344_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_56B)) else "0";
    icmp_ln86_2075_fu_350_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_50D)) else "0";
    icmp_ln86_2076_fu_356_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_EE2)) else "0";
    icmp_ln86_2077_fu_362_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_22F)) else "0";
    icmp_ln86_2078_fu_368_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FF48)) else "0";
    icmp_ln86_2079_fu_374_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_11A)) else "0";
    icmp_ln86_2080_fu_380_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_2FB)) else "0";
    icmp_ln86_2081_fu_386_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_14A7)) else "0";
    icmp_ln86_2082_fu_392_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_42A)) else "0";
    icmp_ln86_2083_fu_398_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBE2)) else "0";
    icmp_ln86_2084_fu_404_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3CB)) else "0";
    icmp_ln86_2085_fu_410_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_62A)) else "0";
    icmp_ln86_2086_fu_416_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_2087_fu_422_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_8F1)) else "0";
    icmp_ln86_2088_fu_428_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FFC1)) else "0";
    icmp_ln86_2089_fu_434_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFBF)) else "0";
    icmp_ln86_2090_fu_440_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_2E1)) else "0";
    icmp_ln86_2091_fu_446_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_2E2)) else "0";
    icmp_ln86_2092_fu_452_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_6EB)) else "0";
    icmp_ln86_2093_fu_458_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_607)) else "0";
    icmp_ln86_fu_308_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_F7A)) else "0";
