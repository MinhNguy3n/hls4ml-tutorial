...
begin
    sparsemux_65_5_12_1_1_x28_U1464 : component conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x28
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1870_fu_312_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FFA0)) else "0";
    icmp_ln86_1871_fu_318_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FFF4)) else "0";
    icmp_ln86_1872_fu_324_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FDEE)) else "0";
    icmp_ln86_1873_fu_330_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FE8C)) else "0";
    icmp_ln86_1874_fu_336_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_1C6)) else "0";
    icmp_ln86_1875_fu_342_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_122)) else "0";
    icmp_ln86_1876_fu_348_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE8E)) else "0";
    icmp_ln86_1877_fu_354_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE5E)) else "0";
    icmp_ln86_1878_fu_360_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_31)) else "0";
    icmp_ln86_1879_fu_366_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3E)) else "0";
    icmp_ln86_1880_fu_372_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FF4D)) else "0";
    icmp_ln86_1881_fu_378_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF15)) else "0";
    icmp_ln86_1882_fu_384_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_35)) else "0";
    icmp_ln86_1883_fu_390_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FFD0)) else "0";
    icmp_ln86_1884_fu_396_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD79)) else "0";
    icmp_ln86_1885_fu_402_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_224)) else "0";
    icmp_ln86_1886_fu_408_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FC)) else "0";
    icmp_ln86_1887_fu_414_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FECB)) else "0";
    icmp_ln86_1888_fu_420_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FDD9)) else "0";
    icmp_ln86_1889_fu_426_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FB49)) else "0";
    icmp_ln86_1890_fu_432_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_49B)) else "0";
    icmp_ln86_1891_fu_438_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FB3A)) else "0";
    icmp_ln86_1892_fu_444_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_F3)) else "0";
    icmp_ln86_1893_fu_450_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FFC1)) else "0";
    icmp_ln86_1894_fu_456_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_5E6)) else "0";
    icmp_ln86_1895_fu_462_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_889)) else "0";
    icmp_ln86_1896_fu_468_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FFB6)) else "0";
    icmp_ln86_1897_fu_474_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_340)) else "0";
    icmp_ln86_1898_fu_480_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_2B)) else "0";
    icmp_ln86_1899_fu_486_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_1EC)) else "0";
    icmp_ln86_fu_306_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF00)) else "0";
