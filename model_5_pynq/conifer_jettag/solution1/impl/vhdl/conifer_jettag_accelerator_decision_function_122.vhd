...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_14_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_14_1_1_U151 : component conifer_jettag_accelerator_sparsemux_65_5_14_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1516_fu_312_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FDD7)) else "0";
    icmp_ln86_1517_fu_318_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_2A1)) else "0";
    icmp_ln86_1518_fu_324_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FAE3)) else "0";
    icmp_ln86_1519_fu_330_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_165)) else "0";
    icmp_ln86_1520_fu_336_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_42C)) else "0";
    icmp_ln86_1521_fu_342_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_145)) else "0";
    icmp_ln86_1522_fu_348_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FB3B)) else "0";
    icmp_ln86_1523_fu_354_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FEAB)) else "0";
    icmp_ln86_1524_fu_360_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FFA5)) else "0";
    icmp_ln86_1525_fu_366_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFA4)) else "0";
    icmp_ln86_1526_fu_372_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_674)) else "0";
    icmp_ln86_1527_fu_378_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_767)) else "0";
    icmp_ln86_1528_fu_384_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_605)) else "0";
    icmp_ln86_1529_fu_390_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FDC0)) else "0";
    icmp_ln86_1530_fu_396_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_1531_fu_402_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_1532_fu_408_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_623)) else "0";
    icmp_ln86_1533_fu_414_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FDAA)) else "0";
    icmp_ln86_1534_fu_420_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FEE8)) else "0";
    icmp_ln86_1535_fu_426_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_2E9)) else "0";
    icmp_ln86_1536_fu_432_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_239)) else "0";
    icmp_ln86_1537_fu_438_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FE73)) else "0";
    icmp_ln86_1538_fu_444_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_1BE)) else "0";
    icmp_ln86_1539_fu_450_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3AD)) else "0";
    icmp_ln86_1540_fu_456_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_77D)) else "0";
    icmp_ln86_1541_fu_462_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_AA4)) else "0";
    icmp_ln86_1542_fu_468_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FEB6)) else "0";
    icmp_ln86_1543_fu_474_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FAEE)) else "0";
    icmp_ln86_1544_fu_480_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FF9A)) else "0";
    icmp_ln86_1545_fu_486_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_503)) else "0";
    icmp_ln86_fu_306_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_224)) else "0";
