...
begin
    sparsemux_65_5_12_1_1_x24_U1290 : component conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x24
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_58_fu_344_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_335)) else "0";
    icmp_ln86_59_fu_350_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FAD6)) else "0";
    icmp_ln86_60_fu_356_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_205)) else "0";
    icmp_ln86_61_fu_362_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_53A)) else "0";
    icmp_ln86_62_fu_368_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_63_fu_374_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FC2C)) else "0";
    icmp_ln86_64_fu_380_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FD7C)) else "0";
    icmp_ln86_65_fu_386_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_4F6)) else "0";
    icmp_ln86_66_fu_392_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_57A)) else "0";
    icmp_ln86_67_fu_398_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_1CB)) else "0";
    icmp_ln86_68_fu_404_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_769)) else "0";
    icmp_ln86_69_fu_410_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FFCB)) else "0";
    icmp_ln86_70_fu_416_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FBD6)) else "0";
    icmp_ln86_71_fu_422_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF7F)) else "0";
    icmp_ln86_72_fu_428_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FD73)) else "0";
    icmp_ln86_73_fu_434_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFCF)) else "0";
    icmp_ln86_74_fu_440_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_1F4)) else "0";
    icmp_ln86_75_fu_446_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_241)) else "0";
    icmp_ln86_76_fu_452_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F87B)) else "0";
    icmp_ln86_77_fu_458_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FF1F)) else "0";
    icmp_ln86_78_fu_464_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FCC5)) else "0";
    icmp_ln86_79_fu_470_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_109)) else "0";
    icmp_ln86_80_fu_476_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_369)) else "0";
    icmp_ln86_81_fu_482_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_91D)) else "0";
    icmp_ln86_82_fu_488_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FACB)) else "0";
    icmp_ln86_83_fu_494_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3F4)) else "0";
    icmp_ln86_84_fu_500_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FC44)) else "0";
    icmp_ln86_85_fu_506_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FF88)) else "0";
    icmp_ln86_86_fu_512_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_CC)) else "0";
    icmp_ln86_87_fu_518_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_63B)) else "0";
    icmp_ln86_fu_338_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F98A)) else "0";
