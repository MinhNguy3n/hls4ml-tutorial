...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x18 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x18_U985 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x18
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_737_fu_338_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_FD)) else "0";
    icmp_ln86_738_fu_344_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FC06)) else "0";
    icmp_ln86_739_fu_350_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD85)) else "0";
    icmp_ln86_740_fu_356_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_4C0)) else "0";
    icmp_ln86_741_fu_362_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FB22)) else "0";
    icmp_ln86_742_fu_368_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FB4C)) else "0";
    icmp_ln86_743_fu_374_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_1E)) else "0";
    icmp_ln86_744_fu_380_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_C4)) else "0";
    icmp_ln86_745_fu_386_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_323)) else "0";
    icmp_ln86_746_fu_392_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_4DD)) else "0";
    icmp_ln86_747_fu_398_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCA1)) else "0";
    icmp_ln86_748_fu_404_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCA8)) else "0";
    icmp_ln86_749_fu_410_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCA6)) else "0";
    icmp_ln86_750_fu_416_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_5A)) else "0";
    icmp_ln86_751_fu_422_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_364)) else "0";
    icmp_ln86_752_fu_428_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FCFA)) else "0";
    icmp_ln86_753_fu_434_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FB78)) else "0";
    icmp_ln86_754_fu_440_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF6E)) else "0";
    icmp_ln86_755_fu_446_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_85C)) else "0";
    icmp_ln86_756_fu_452_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3F84A)) else "0";
    icmp_ln86_757_fu_458_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_602)) else "0";
    icmp_ln86_758_fu_464_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FAEB)) else "0";
    icmp_ln86_759_fu_470_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FB08)) else "0";
    icmp_ln86_760_fu_476_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FB92)) else "0";
    icmp_ln86_761_fu_482_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FB5A)) else "0";
    icmp_ln86_762_fu_488_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_5F6)) else "0";
    icmp_ln86_763_fu_494_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_764_fu_500_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FB7A)) else "0";
    icmp_ln86_fu_332_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FDB7)) else "0";
