...
begin
    sparsemux_65_5_12_1_1_x21_U956 : component conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x21
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_794_fu_334_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FF)) else "0";
    icmp_ln86_795_fu_340_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FB29)) else "0";
    icmp_ln86_796_fu_346_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FDCE)) else "0";
    icmp_ln86_797_fu_352_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBD1)) else "0";
    icmp_ln86_798_fu_358_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_99)) else "0";
    icmp_ln86_799_fu_364_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_89)) else "0";
    icmp_ln86_800_fu_370_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_5E3)) else "0";
    icmp_ln86_801_fu_376_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FB21)) else "0";
    icmp_ln86_802_fu_382_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_658)) else "0";
    icmp_ln86_803_fu_388_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FAF2)) else "0";
    icmp_ln86_804_fu_394_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FFFA)) else "0";
    icmp_ln86_805_fu_400_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_4BA)) else "0";
    icmp_ln86_806_fu_406_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_76)) else "0";
    icmp_ln86_807_fu_412_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FB9F)) else "0";
    icmp_ln86_808_fu_418_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_224)) else "0";
    icmp_ln86_809_fu_424_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_4E)) else "0";
    icmp_ln86_810_fu_430_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_A5)) else "0";
    icmp_ln86_811_fu_436_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_26B)) else "0";
    icmp_ln86_812_fu_442_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_137)) else "0";
    icmp_ln86_813_fu_448_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FB65)) else "0";
    icmp_ln86_814_fu_454_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3F920)) else "0";
    icmp_ln86_815_fu_460_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3F704)) else "0";
    icmp_ln86_816_fu_466_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FEBE)) else "0";
    icmp_ln86_817_fu_472_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3AC)) else "0";
    icmp_ln86_818_fu_478_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_330)) else "0";
    icmp_ln86_819_fu_484_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_51B)) else "0";
    icmp_ln86_820_fu_490_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF72)) else "0";
    icmp_ln86_821_fu_496_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FC51)) else "0";
    icmp_ln86_822_fu_502_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FB9D)) else "0";
    icmp_ln86_823_fu_508_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_6C1)) else "0";
    icmp_ln86_fu_328_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_340)) else "0";
