...
begin
    sparsemux_47_5_12_1_1_U943 : component conifer_jettag_accelerator_sparsemux_47_5_12_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_824_fu_276_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3F6AA)) else "0";
    icmp_ln86_825_fu_282_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3F8C7)) else "0";
    icmp_ln86_826_fu_288_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3F9CF)) else "0";
    icmp_ln86_827_fu_294_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_65C)) else "0";
    icmp_ln86_828_fu_300_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FE2F)) else "0";
    icmp_ln86_829_fu_306_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FEA8)) else "0";
    icmp_ln86_830_fu_312_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3F9DB)) else "0";
    icmp_ln86_831_fu_318_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FFE7)) else "0";
    icmp_ln86_832_fu_324_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_224)) else "0";
    icmp_ln86_833_fu_330_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FAEA)) else "0";
    icmp_ln86_834_fu_336_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FDB1)) else "0";
    icmp_ln86_835_fu_342_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3F737)) else "0";
    icmp_ln86_836_fu_348_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FA12)) else "0";
    icmp_ln86_837_fu_354_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FD6B)) else "0";
    icmp_ln86_838_fu_360_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FED2)) else "0";
    icmp_ln86_839_fu_366_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3F863)) else "0";
    icmp_ln86_840_fu_372_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3F907)) else "0";
    icmp_ln86_841_fu_378_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FB24)) else "0";
    icmp_ln86_842_fu_384_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FC9C)) else "0";
    icmp_ln86_843_fu_390_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD63)) else "0";
    icmp_ln86_844_fu_396_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD88)) else "0";
    icmp_ln86_fu_270_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FA35)) else "0";
