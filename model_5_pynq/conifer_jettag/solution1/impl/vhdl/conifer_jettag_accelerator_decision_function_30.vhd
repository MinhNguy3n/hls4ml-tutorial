...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_47_5_13_1_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_47_5_13_1_1_U929 : component conifer_jettag_accelerator_sparsemux_47_5_13_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_ce))) then
                ...
                tmp_2_reg_1056 <= p_read9_int_reg(17 downto 17);
    ...
    ap_return <= 
        ...
        ap_const_lv13_0;
    icmp_ln86_845_fu_286_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_EF3)) else "0";
    icmp_ln86_846_fu_292_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_6C7)) else "0";
    icmp_ln86_847_fu_298_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_AFF)) else "0";
    icmp_ln86_848_fu_304_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_9E6)) else "0";
    icmp_ln86_850_fu_318_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FDF7)) else "0";
    icmp_ln86_851_fu_324_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_89B)) else "0";
    icmp_ln86_852_fu_330_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_A95)) else "0";
    icmp_ln86_853_fu_336_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FF30)) else "0";
    icmp_ln86_854_fu_342_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_340)) else "0";
    icmp_ln86_855_fu_348_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_122)) else "0";
    icmp_ln86_856_fu_354_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD9A)) else "0";
    icmp_ln86_857_fu_360_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF58)) else "0";
    icmp_ln86_858_fu_366_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FE58)) else "0";
    icmp_ln86_859_fu_372_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_C71)) else "0";
    icmp_ln86_860_fu_378_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_EFE)) else "0";
    icmp_ln86_861_fu_384_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_492)) else "0";
    icmp_ln86_862_fu_390_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_22D)) else "0";
    icmp_ln86_863_fu_396_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_34B)) else "0";
    icmp_ln86_864_fu_402_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_8BA)) else "0";
    icmp_ln86_865_fu_408_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FFF5)) else "0";
    icmp_ln86_fu_280_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_DBD)) else "0";
