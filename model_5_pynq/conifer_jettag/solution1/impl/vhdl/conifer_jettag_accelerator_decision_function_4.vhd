...
begin
    sparsemux_53_5_12_1_1_U1260 : component conifer_jettag_accelerator_sparsemux_53_5_12_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_117_fu_304_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_D09)) else "0";
    icmp_ln86_118_fu_310_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_119_fu_316_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FC48)) else "0";
    icmp_ln86_120_fu_322_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_A41)) else "0";
    icmp_ln86_121_fu_328_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3C9)) else "0";
    icmp_ln86_122_fu_334_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_5D1)) else "0";
    icmp_ln86_123_fu_340_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FBDE)) else "0";
    icmp_ln86_124_fu_346_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FCF4)) else "0";
    icmp_ln86_125_fu_352_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_8B)) else "0";
    icmp_ln86_126_fu_358_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_D9F)) else "0";
    icmp_ln86_127_fu_364_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_2F1)) else "0";
    icmp_ln86_128_fu_370_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3EE)) else "0";
    icmp_ln86_129_fu_376_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FC72)) else "0";
    icmp_ln86_130_fu_382_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FDE5)) else "0";
    icmp_ln86_131_fu_388_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FCCB)) else "0";
    icmp_ln86_132_fu_394_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FDAD)) else "0";
    icmp_ln86_133_fu_400_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_9EF)) else "0";
    icmp_ln86_135_fu_422_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_7FD)) else "0";
    icmp_ln86_136_fu_428_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_DD1)) else "0";
    icmp_ln86_137_fu_434_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_235)) else "0";
    icmp_ln86_138_fu_440_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_71F)) else "0";
    icmp_ln86_139_fu_446_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_392)) else "0";
    icmp_ln86_140_fu_452_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_EE2)) else "0";
    icmp_ln86_1459_fu_416_p2 <= "1" when (signed(tmp_fu_406_p4) < signed(ap_const_lv10_1)) else "0";
    icmp_ln86_fu_298_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_CBD)) else "0";
    ...
    select_ln117_fu_545_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_406_p4 <= p_read5_int_reg(17 downto 8);
