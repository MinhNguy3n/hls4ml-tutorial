...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x10 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x10_U654 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x10
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1380_fu_340_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FC43)) else "0";
    icmp_ln86_1381_fu_346_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_7C)) else "0";
    icmp_ln86_1382_fu_352_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_206)) else "0";
    icmp_ln86_1383_fu_358_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_22F)) else "0";
    icmp_ln86_1384_fu_364_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_7B6)) else "0";
    icmp_ln86_1385_fu_370_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_63B)) else "0";
    icmp_ln86_1386_fu_376_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FC4C)) else "0";
    icmp_ln86_1387_fu_382_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FC72)) else "0";
    icmp_ln86_1388_fu_388_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FCB0)) else "0";
    icmp_ln86_1389_fu_394_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_1F5)) else "0";
    icmp_ln86_1390_fu_400_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FDE8)) else "0";
    icmp_ln86_1391_fu_406_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F480)) else "0";
    icmp_ln86_1392_fu_412_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBBE)) else "0";
    icmp_ln86_1393_fu_418_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F758)) else "0";
    icmp_ln86_1394_fu_424_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FC2F)) else "0";
    icmp_ln86_1395_fu_430_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_42)) else "0";
    icmp_ln86_1396_fu_436_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_6A9)) else "0";
    icmp_ln86_1397_fu_442_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_167)) else "0";
    icmp_ln86_1398_fu_448_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FC24)) else "0";
    icmp_ln86_1399_fu_454_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FB4E)) else "0";
    icmp_ln86_1400_fu_460_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_41B)) else "0";
    icmp_ln86_1401_fu_466_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_B2F)) else "0";
    icmp_ln86_1402_fu_472_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_737)) else "0";
    icmp_ln86_1403_fu_478_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FE3E)) else "0";
    icmp_ln86_1404_fu_484_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F469)) else "0";
    icmp_ln86_1405_fu_490_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FAFA)) else "0";
    icmp_ln86_1406_fu_496_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_482)) else "0";
    icmp_ln86_1407_fu_502_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_274)) else "0";
    icmp_ln86_1408_fu_508_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_85E)) else "0";
    icmp_ln86_1409_fu_514_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FC0D)) else "0";
    icmp_ln86_fu_334_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE6F)) else "0";
