...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x9 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x9_U615 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x9
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1265_fu_324_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF19)) else "0";
    icmp_ln86_1266_fu_330_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_26D)) else "0";
    icmp_ln86_1267_fu_336_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_66)) else "0";
    icmp_ln86_1268_fu_342_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_49)) else "0";
    icmp_ln86_1269_fu_348_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_C0)) else "0";
    icmp_ln86_1270_fu_354_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FF52)) else "0";
    icmp_ln86_1271_fu_360_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_5C4)) else "0";
    icmp_ln86_1272_fu_366_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_A5)) else "0";
    icmp_ln86_1273_fu_372_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF31)) else "0";
    icmp_ln86_1274_fu_378_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF43)) else "0";
    icmp_ln86_1275_fu_384_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_27)) else "0";
    icmp_ln86_1276_fu_390_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FE58)) else "0";
    icmp_ln86_1277_fu_396_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF37)) else "0";
    icmp_ln86_1278_fu_402_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_129)) else "0";
    icmp_ln86_1279_fu_408_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FF9A)) else "0";
    icmp_ln86_1280_fu_414_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FFED)) else "0";
    icmp_ln86_1281_fu_420_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_310)) else "0";
    icmp_ln86_1282_fu_426_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FFF5)) else "0";
    icmp_ln86_1283_fu_432_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FF01)) else "0";
    icmp_ln86_1284_fu_438_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD32)) else "0";
    icmp_ln86_1285_fu_444_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFE0)) else "0";
    icmp_ln86_1286_fu_450_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FCF6)) else "0";
    icmp_ln86_1287_fu_456_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF76)) else "0";
    icmp_ln86_1288_fu_462_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FCC2)) else "0";
    icmp_ln86_1289_fu_468_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_822)) else "0";
    icmp_ln86_1290_fu_474_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_4BC)) else "0";
    icmp_ln86_1291_fu_480_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FF4B)) else "0";
    icmp_ln86_1292_fu_486_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF7A)) else "0";
    icmp_ln86_1293_fu_492_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_373)) else "0";
    icmp_ln86_fu_318_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FFF4)) else "0";
