...
begin
    sparsemux_65_5_13_1_1_x10_U546 : component conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x10
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1088_fu_314_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFA6)) else "0";
    icmp_ln86_1089_fu_320_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_1E1)) else "0";
    icmp_ln86_1090_fu_326_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_7F)) else "0";
    icmp_ln86_1091_fu_332_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_2A7)) else "0";
    icmp_ln86_1092_fu_338_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_40B)) else "0";
    icmp_ln86_1093_fu_344_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_2DC)) else "0";
    icmp_ln86_1094_fu_350_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FEBA)) else "0";
    icmp_ln86_1095_fu_356_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FD2E)) else "0";
    icmp_ln86_1096_fu_372_p2 <= "1" when (signed(tmp_fu_362_p4) < signed(ap_const_lv10_1)) else "0";
    icmp_ln86_1097_fu_378_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_16F)) else "0";
    icmp_ln86_1098_fu_384_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_39E)) else "0";
    icmp_ln86_1099_fu_390_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_D1)) else "0";
    icmp_ln86_1100_fu_396_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_452)) else "0";
    icmp_ln86_1101_fu_402_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_44E)) else "0";
    icmp_ln86_1102_fu_408_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FF36)) else "0";
    icmp_ln86_1103_fu_414_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FFB0)) else "0";
    icmp_ln86_1104_fu_420_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFBE)) else "0";
    icmp_ln86_1105_fu_426_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_1106_fu_432_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_193)) else "0";
    icmp_ln86_1107_fu_438_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_90)) else "0";
    icmp_ln86_1108_fu_444_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FE98)) else "0";
    icmp_ln86_1109_fu_450_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_470)) else "0";
    icmp_ln86_1110_fu_456_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FB1B)) else "0";
    icmp_ln86_1111_fu_462_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FE73)) else "0";
    icmp_ln86_1112_fu_468_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FCEC)) else "0";
    icmp_ln86_1113_fu_474_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_5AA)) else "0";
    icmp_ln86_1114_fu_480_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_29C)) else "0";
    icmp_ln86_1115_fu_486_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_36F)) else "0";
    icmp_ln86_fu_308_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_232)) else "0";
    ...
    select_ln117_fu_611_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_362_p4 <= p_read3_int_reg(17 downto 8);
