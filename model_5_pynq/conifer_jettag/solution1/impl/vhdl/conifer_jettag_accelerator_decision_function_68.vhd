...
begin
    sparsemux_65_5_12_1_1_x11_U480 : component conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x11
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_912_fu_350_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_C4)) else "0";
    icmp_ln86_913_fu_356_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_1BF)) else "0";
    icmp_ln86_914_fu_362_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF62)) else "0";
    icmp_ln86_915_fu_378_p2 <= "1" when (signed(tmp_fu_368_p4) < signed(ap_const_lv13_1)) else "0";
    icmp_ln86_916_fu_384_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_F5)) else "0";
    icmp_ln86_917_fu_390_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_660)) else "0";
    icmp_ln86_918_fu_396_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FB50)) else "0";
    icmp_ln86_919_fu_402_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_E5)) else "0";
    icmp_ln86_920_fu_408_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3E3)) else "0";
    icmp_ln86_921_fu_414_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3F865)) else "0";
    icmp_ln86_922_fu_420_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_1BC)) else "0";
    icmp_ln86_923_fu_426_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_5CF)) else "0";
    icmp_ln86_924_fu_432_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_A2C)) else "0";
    icmp_ln86_925_fu_438_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_75C)) else "0";
    icmp_ln86_926_fu_444_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FB96)) else "0";
    icmp_ln86_927_fu_450_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_5C7)) else "0";
    icmp_ln86_928_fu_456_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3F91F)) else "0";
    icmp_ln86_929_fu_462_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FCE1)) else "0";
    icmp_ln86_930_fu_468_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_224)) else "0";
    icmp_ln86_931_fu_474_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FA9C)) else "0";
    icmp_ln86_932_fu_480_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3F9F0)) else "0";
    icmp_ln86_933_fu_486_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_7B)) else "0";
    icmp_ln86_934_fu_492_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE64)) else "0";
    icmp_ln86_935_fu_498_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_FC)) else "0";
    icmp_ln86_936_fu_504_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FE7D)) else "0";
    icmp_ln86_937_fu_510_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_672)) else "0";
    icmp_ln86_938_fu_516_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_6C1)) else "0";
    icmp_ln86_939_fu_522_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_EDA)) else "0";
    icmp_ln86_940_fu_528_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_ADD)) else "0";
    icmp_ln86_941_fu_534_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_5A3)) else "0";
    icmp_ln86_fu_344_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FCCA)) else "0";
    ...
    select_ln117_fu_659_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_368_p4 <= p_read4_int_reg(17 downto 5);
