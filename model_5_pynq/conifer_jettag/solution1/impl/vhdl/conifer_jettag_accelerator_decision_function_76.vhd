...
entity conifer_jettag_accelerator_decision_function_76 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conifer_jettag_accelerator_decision_function_76 is 
...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_13_1_1_x0_U82 : component conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x0
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_676_fu_290_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FFE5)) else "0";
    icmp_ln86_677_fu_296_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF8D)) else "0";
    icmp_ln86_678_fu_302_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_167)) else "0";
    icmp_ln86_679_fu_308_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_C2)) else "0";
    icmp_ln86_680_fu_314_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_D3)) else "0";
    icmp_ln86_681_fu_320_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_CB)) else "0";
    icmp_ln86_682_fu_326_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF21)) else "0";
    icmp_ln86_683_fu_332_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF12)) else "0";
    icmp_ln86_684_fu_338_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_253)) else "0";
    icmp_ln86_685_fu_344_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_F2)) else "0";
    icmp_ln86_686_fu_350_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FE44)) else "0";
    icmp_ln86_687_fu_356_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_E5)) else "0";
    icmp_ln86_688_fu_362_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFA5)) else "0";
    icmp_ln86_689_fu_368_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFB1)) else "0";
    icmp_ln86_690_fu_374_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FD8D)) else "0";
    icmp_ln86_691_fu_380_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FFA0)) else "0";
    icmp_ln86_692_fu_386_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_2E1)) else "0";
    icmp_ln86_693_fu_392_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_42C)) else "0";
    icmp_ln86_694_fu_398_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FF60)) else "0";
    icmp_ln86_695_fu_404_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_45B)) else "0";
    icmp_ln86_696_fu_410_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_10B)) else "0";
    icmp_ln86_697_fu_416_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FBDE)) else "0";
    icmp_ln86_698_fu_422_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_1D)) else "0";
    icmp_ln86_699_fu_428_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FDEF)) else "0";
    icmp_ln86_700_fu_434_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_249)) else "0";
    icmp_ln86_701_fu_440_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FDB7)) else "0";
    icmp_ln86_702_fu_446_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFC8)) else "0";
    icmp_ln86_703_fu_452_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_106)) else "0";
    icmp_ln86_704_fu_458_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_BC)) else "0";
    icmp_ln86_fu_284_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF76)) else "0";
