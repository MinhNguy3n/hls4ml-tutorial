...
begin
    sparsemux_63_5_13_1_1_U353 : component conifer_jettag_accelerator_sparsemux_63_5_13_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv13_0;
    icmp_ln86_588_fu_300_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FF8F)) else "0";
    icmp_ln86_589_fu_306_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_376)) else "0";
    icmp_ln86_590_fu_312_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FBDE)) else "0";
    icmp_ln86_591_fu_318_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FC61)) else "0";
    icmp_ln86_592_fu_324_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_77E)) else "0";
    icmp_ln86_593_fu_330_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_692)) else "0";
    icmp_ln86_594_fu_336_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FAD6)) else "0";
    icmp_ln86_595_fu_342_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_685)) else "0";
    icmp_ln86_596_fu_348_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FCD5)) else "0";
    icmp_ln86_597_fu_354_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_9BF)) else "0";
    icmp_ln86_598_fu_360_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3DB)) else "0";
    icmp_ln86_599_fu_366_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_604)) else "0";
    icmp_ln86_600_fu_372_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_68A)) else "0";
    icmp_ln86_601_fu_378_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_60F)) else "0";
    icmp_ln86_602_fu_384_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_603_fu_390_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FA64)) else "0";
    icmp_ln86_604_fu_396_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FE15)) else "0";
    icmp_ln86_605_fu_402_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FF3A)) else "0";
    icmp_ln86_606_fu_408_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FBF8)) else "0";
    icmp_ln86_607_fu_414_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FC19)) else "0";
    icmp_ln86_608_fu_420_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FFFD)) else "0";
    icmp_ln86_609_fu_426_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_97A)) else "0";
    icmp_ln86_610_fu_432_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FDAD)) else "0";
    icmp_ln86_611_fu_438_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_231)) else "0";
    icmp_ln86_612_fu_444_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_889)) else "0";
    icmp_ln86_613_fu_450_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_B67)) else "0";
    icmp_ln86_614_fu_456_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_76B)) else "0";
    icmp_ln86_615_fu_462_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_213)) else "0";
    icmp_ln86_616_fu_468_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_67E)) else "0";
    icmp_ln86_fu_294_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FCED)) else "0";
