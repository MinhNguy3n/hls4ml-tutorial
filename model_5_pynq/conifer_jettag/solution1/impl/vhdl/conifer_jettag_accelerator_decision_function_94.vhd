...
begin
    sparsemux_61_5_12_1_1_U186 : component conifer_jettag_accelerator_sparsemux_61_5_12_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00001",
    ...
    icmp_ln86_144_fu_306_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_1D)) else "0";
    icmp_ln86_145_fu_312_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFB4)) else "0";
    icmp_ln86_146_fu_318_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3B)) else "0";
    icmp_ln86_147_fu_324_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_86)) else "0";
    icmp_ln86_148_fu_330_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_109)) else "0";
    icmp_ln86_149_fu_346_p2 <= "1" when (signed(tmp_fu_336_p4) < signed(ap_const_lv11_1)) else "0";
    icmp_ln86_150_fu_352_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_151_fu_358_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_2E1)) else "0";
    icmp_ln86_152_fu_364_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF44)) else "0";
    icmp_ln86_153_fu_370_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_6B)) else "0";
    icmp_ln86_154_fu_376_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FC3D)) else "0";
    icmp_ln86_155_fu_382_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FDB4)) else "0";
    icmp_ln86_156_fu_388_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_563)) else "0";
    icmp_ln86_157_fu_394_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FBD4)) else "0";
    icmp_ln86_158_fu_400_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF56)) else "0";
    icmp_ln86_159_fu_406_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_79)) else "0";
    icmp_ln86_160_fu_412_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD61)) else "0";
    icmp_ln86_161_fu_418_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_5D5)) else "0";
    icmp_ln86_162_fu_424_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_287)) else "0";
    icmp_ln86_163_fu_430_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_76)) else "0";
    icmp_ln86_164_fu_436_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FA24)) else "0";
    icmp_ln86_165_fu_442_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_78)) else "0";
    icmp_ln86_166_fu_448_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FEDC)) else "0";
    icmp_ln86_167_fu_454_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFE6)) else "0";
    icmp_ln86_168_fu_460_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_4C)) else "0";
    icmp_ln86_169_fu_466_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FEF5)) else "0";
    icmp_ln86_170_fu_472_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FD99)) else "0";
    icmp_ln86_fu_300_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF9A)) else "0";
    ...
    select_ln117_fu_528_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_336_p4 <= p_read8_int_reg(17 downto 7);
