...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x29 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x29_U1614 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x29
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_31_fu_350_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_17B)) else "0";
    icmp_ln86_32_fu_356_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_4DA)) else "0";
    icmp_ln86_33_fu_362_p2 <= "1" when (signed(p_read14_int_reg) < signed(ap_const_lv18_77E)) else "0";
    icmp_ln86_34_fu_368_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_5EB)) else "0";
    icmp_ln86_35_fu_374_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_353)) else "0";
    icmp_ln86_36_fu_380_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FCFB)) else "0";
    icmp_ln86_37_fu_386_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_BD1)) else "0";
    icmp_ln86_38_fu_392_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_20F)) else "0";
    icmp_ln86_39_fu_398_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_4E3)) else "0";
    icmp_ln86_40_fu_404_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_5D7)) else "0";
    icmp_ln86_41_fu_410_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF41)) else "0";
    icmp_ln86_42_fu_416_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FFA8)) else "0";
    icmp_ln86_43_fu_422_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_3FB8E)) else "0";
    icmp_ln86_44_fu_428_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_4FD)) else "0";
    icmp_ln86_45_fu_434_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_6D6)) else "0";
    icmp_ln86_46_fu_440_p2 <= "1" when (signed(p_read13_int_reg) < signed(ap_const_lv18_849)) else "0";
    icmp_ln86_47_fu_446_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FEF8)) else "0";
    icmp_ln86_48_fu_452_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_684)) else "0";
    icmp_ln86_49_fu_458_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_646)) else "0";
    icmp_ln86_50_fu_464_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_630)) else "0";
    icmp_ln86_51_fu_470_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FCE7)) else "0";
    icmp_ln86_52_fu_476_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FF1D)) else "0";
    icmp_ln86_53_fu_482_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_9C7)) else "0";
    icmp_ln86_54_fu_488_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_346)) else "0";
    icmp_ln86_55_fu_494_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F792)) else "0";
    icmp_ln86_56_fu_500_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_610)) else "0";
    icmp_ln86_57_fu_506_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_53E)) else "0";
    icmp_ln86_58_fu_512_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCB0)) else "0";
    icmp_ln86_59_fu_518_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_5BB)) else "0";
    icmp_ln86_60_fu_524_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_508)) else "0";
    icmp_ln86_fu_344_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_38A)) else "0";
