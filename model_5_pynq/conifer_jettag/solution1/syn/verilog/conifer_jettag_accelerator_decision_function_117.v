...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_61_5_12_1_1_x0 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_61_5_12_1_1_x0_U1387(
    .din0(12'd1782),
    .din1(12'd3591),
    .din2(12'd4095),
    .din3(12'd96),
...
assign icmp_ln86_1665_fu_342_p2 = (($signed(p_read13_int_reg) < $signed(18'd737)) ? 1'b1 : 1'b0);

assign icmp_ln86_1666_fu_348_p2 = (($signed(p_read10_int_reg) < $signed(18'd261953)) ? 1'b1 : 1'b0);

assign icmp_ln86_1667_fu_354_p2 = (($signed(p_read4_int_reg) < $signed(18'd77)) ? 1'b1 : 1'b0);

assign icmp_ln86_1668_fu_360_p2 = (($signed(p_read9_int_reg) < $signed(18'd1184)) ? 1'b1 : 1'b0);

assign icmp_ln86_1669_fu_366_p2 = (($signed(p_read13_int_reg) < $signed(18'd2068)) ? 1'b1 : 1'b0);

assign icmp_ln86_1670_fu_372_p2 = (($signed(p_read13_int_reg) < $signed(18'd678)) ? 1'b1 : 1'b0);

assign icmp_ln86_1671_fu_378_p2 = (($signed(p_read4_int_reg) < $signed(18'd57)) ? 1'b1 : 1'b0);

assign icmp_ln86_1672_fu_384_p2 = (($signed(p_read11_int_reg) < $signed(18'd260531)) ? 1'b1 : 1'b0);

assign icmp_ln86_1673_fu_390_p2 = (($signed(p_read4_int_reg) < $signed(18'd316)) ? 1'b1 : 1'b0);

assign icmp_ln86_1674_fu_396_p2 = (($signed(p_read13_int_reg) < $signed(18'd988)) ? 1'b1 : 1'b0);

assign icmp_ln86_1675_fu_402_p2 = (($signed(p_read7_int_reg) < $signed(18'd262001)) ? 1'b1 : 1'b0);

assign icmp_ln86_1676_fu_408_p2 = (($signed(p_read6_int_reg) < $signed(18'd262072)) ? 1'b1 : 1'b0);

assign icmp_ln86_1677_fu_414_p2 = (($signed(p_read12_int_reg) < $signed(18'd513)) ? 1'b1 : 1'b0);

assign icmp_ln86_1678_fu_420_p2 = (($signed(p_read4_int_reg) < $signed(18'd860)) ? 1'b1 : 1'b0);

assign icmp_ln86_1679_fu_426_p2 = (($signed(p_read3_int_reg) < $signed(18'd421)) ? 1'b1 : 1'b0);

assign icmp_ln86_1680_fu_432_p2 = (($signed(p_read2_int_reg) < $signed(18'd68)) ? 1'b1 : 1'b0);

assign icmp_ln86_1681_fu_438_p2 = (($signed(p_read14_int_reg) < $signed(18'd262078)) ? 1'b1 : 1'b0);

assign icmp_ln86_1682_fu_444_p2 = (($signed(p_read4_int_reg) < $signed(18'd90)) ? 1'b1 : 1'b0);

assign icmp_ln86_1683_fu_450_p2 = (($signed(p_read1_int_reg) < $signed(18'd260998)) ? 1'b1 : 1'b0);

assign icmp_ln86_1684_fu_456_p2 = (($signed(p_read5_int_reg) < $signed(18'd681)) ? 1'b1 : 1'b0);

assign icmp_ln86_1685_fu_462_p2 = (($signed(p_read4_int_reg) < $signed(18'd124)) ? 1'b1 : 1'b0);

assign icmp_ln86_1686_fu_468_p2 = (($signed(p_read3_int_reg) < $signed(18'd814)) ? 1'b1 : 1'b0);

assign icmp_ln86_1687_fu_474_p2 = (($signed(p_read13_int_reg) < $signed(18'd640)) ? 1'b1 : 1'b0);

assign icmp_ln86_1688_fu_480_p2 = (($signed(p_read8_int_reg) < $signed(18'd260911)) ? 1'b1 : 1'b0);

assign icmp_ln86_1689_fu_486_p2 = (($signed(p_read9_int_reg) < $signed(18'd261964)) ? 1'b1 : 1'b0);

assign icmp_ln86_1690_fu_492_p2 = (($signed(p_read12_int_reg) < $signed(18'd493)) ? 1'b1 : 1'b0);

assign icmp_ln86_1691_fu_498_p2 = (($signed(p_read13_int_reg) < $signed(18'd950)) ? 1'b1 : 1'b0);

assign icmp_ln86_1692_fu_504_p2 = (($signed(p_read13_int_reg) < $signed(18'd1229)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_336_p2 = (($signed(p_read4_int_reg) < $signed(18'd336)) ? 1'b1 : 1'b0);
