...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_47_5_13_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 13 ),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_ce))) begin
        ...
        tmp_2_reg_1056 <= p_read9_int_reg[32'd17];
...
assign icmp_ln86_845_fu_286_p2 = (($signed(p_read3_int_reg) < $signed(18'd3827)) ? 1'b1 : 1'b0);

assign icmp_ln86_846_fu_292_p2 = (($signed(p_read8_int_reg) < $signed(18'd1735)) ? 1'b1 : 1'b0);

assign icmp_ln86_847_fu_298_p2 = (($signed(p_read12_int_reg) < $signed(18'd2815)) ? 1'b1 : 1'b0);

assign icmp_ln86_848_fu_304_p2 = (($signed(p_read11_int_reg) < $signed(18'd2534)) ? 1'b1 : 1'b0);

assign icmp_ln86_850_fu_318_p2 = (($signed(p_read5_int_reg) < $signed(18'd261623)) ? 1'b1 : 1'b0);

assign icmp_ln86_851_fu_324_p2 = (($signed(p_read4_int_reg) < $signed(18'd2203)) ? 1'b1 : 1'b0);

assign icmp_ln86_852_fu_330_p2 = (($signed(p_read2_int_reg) < $signed(18'd2709)) ? 1'b1 : 1'b0);

assign icmp_ln86_853_fu_336_p2 = (($signed(p_read5_int_reg) < $signed(18'd261936)) ? 1'b1 : 1'b0);

assign icmp_ln86_854_fu_342_p2 = (($signed(p_read1_int_reg) < $signed(18'd832)) ? 1'b1 : 1'b0);

assign icmp_ln86_855_fu_348_p2 = (($signed(p_read8_int_reg) < $signed(18'd290)) ? 1'b1 : 1'b0);

assign icmp_ln86_856_fu_354_p2 = (($signed(p_read6_int_reg) < $signed(18'd261530)) ? 1'b1 : 1'b0);

assign icmp_ln86_857_fu_360_p2 = (($signed(p_read3_int_reg) < $signed(18'd261976)) ? 1'b1 : 1'b0);

assign icmp_ln86_858_fu_366_p2 = (($signed(p_read7_int_reg) < $signed(18'd261720)) ? 1'b1 : 1'b0);

assign icmp_ln86_859_fu_372_p2 = (($signed(p_read3_int_reg) < $signed(18'd3185)) ? 1'b1 : 1'b0);

assign icmp_ln86_860_fu_378_p2 = (($signed(p_read3_int_reg) < $signed(18'd3838)) ? 1'b1 : 1'b0);

assign icmp_ln86_861_fu_384_p2 = (($signed(p_read10_int_reg) < $signed(18'd1170)) ? 1'b1 : 1'b0);

assign icmp_ln86_862_fu_390_p2 = (($signed(p_read9_int_reg) < $signed(18'd557)) ? 1'b1 : 1'b0);

assign icmp_ln86_863_fu_396_p2 = (($signed(p_read1_int_reg) < $signed(18'd843)) ? 1'b1 : 1'b0);

assign icmp_ln86_864_fu_402_p2 = (($signed(p_read4_int_reg) < $signed(18'd2234)) ? 1'b1 : 1'b0);

assign icmp_ln86_865_fu_408_p2 = (($signed(p_read10_int_reg) < $signed(18'd262133)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_280_p2 = (($signed(p_read11_int_reg) < $signed(18'd3517)) ? 1'b1 : 1'b0);
