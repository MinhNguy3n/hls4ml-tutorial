...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x16 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 13 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 13 ))
sparsemux_65_5_13_1_1_x16_U904(
    .din0(13'd176),
    .din1(13'd34),
    .din2(13'd8186),
    .din3(13'd53),
...
assign icmp_ln86_926_fu_358_p2 = (($signed(p_read1_int_reg) < $signed(18'd2802)) ? 1'b1 : 1'b0);

assign icmp_ln86_927_fu_364_p2 = (($signed(p_read8_int_reg) < $signed(18'd51)) ? 1'b1 : 1'b0);

assign icmp_ln86_928_fu_370_p2 = (($signed(p_read2_int_reg) < $signed(18'd300)) ? 1'b1 : 1'b0);

assign icmp_ln86_929_fu_376_p2 = (($signed(p_read2_int_reg) < $signed(18'd256034)) ? 1'b1 : 1'b0);

assign icmp_ln86_930_fu_382_p2 = (($signed(p_read11_int_reg) < $signed(18'd894)) ? 1'b1 : 1'b0);

assign icmp_ln86_931_fu_388_p2 = (($signed(p_read14_int_reg) < $signed(18'd261511)) ? 1'b1 : 1'b0);

assign icmp_ln86_932_fu_394_p2 = (($signed(p_read1_int_reg) < $signed(18'd235)) ? 1'b1 : 1'b0);

assign icmp_ln86_933_fu_400_p2 = (($signed(p_read1_int_reg) < $signed(18'd262017)) ? 1'b1 : 1'b0);

assign icmp_ln86_934_fu_406_p2 = (($signed(p_read3_int_reg) < $signed(18'd260891)) ? 1'b1 : 1'b0);

assign icmp_ln86_935_fu_412_p2 = (($signed(p_read10_int_reg) < $signed(18'd260627)) ? 1'b1 : 1'b0);

assign icmp_ln86_936_fu_418_p2 = (($signed(p_read12_int_reg) < $signed(18'd570)) ? 1'b1 : 1'b0);

assign icmp_ln86_937_fu_424_p2 = (($signed(p_read7_int_reg) < $signed(18'd262126)) ? 1'b1 : 1'b0);

assign icmp_ln86_938_fu_430_p2 = (($signed(p_read1_int_reg) < $signed(18'd302)) ? 1'b1 : 1'b0);

assign icmp_ln86_939_fu_436_p2 = (($signed(p_read1_int_reg) < $signed(18'd261746)) ? 1'b1 : 1'b0);

assign icmp_ln86_940_fu_442_p2 = (($signed(p_read14_int_reg) < $signed(18'd261936)) ? 1'b1 : 1'b0);

assign icmp_ln86_941_fu_448_p2 = (($signed(p_read5_int_reg) < $signed(18'd262044)) ? 1'b1 : 1'b0);

assign icmp_ln86_942_fu_454_p2 = (($signed(p_read14_int_reg) < $signed(18'd261984)) ? 1'b1 : 1'b0);

assign icmp_ln86_943_fu_460_p2 = (($signed(p_read13_int_reg) < $signed(18'd130)) ? 1'b1 : 1'b0);

assign icmp_ln86_944_fu_466_p2 = (($signed(p_read13_int_reg) < $signed(18'd260809)) ? 1'b1 : 1'b0);

assign icmp_ln86_945_fu_472_p2 = (($signed(p_read10_int_reg) < $signed(18'd260851)) ? 1'b1 : 1'b0);

assign icmp_ln86_946_fu_478_p2 = (($signed(p_read12_int_reg) < $signed(18'd260467)) ? 1'b1 : 1'b0);

assign icmp_ln86_947_fu_484_p2 = (($signed(p_read6_int_reg) < $signed(18'd261777)) ? 1'b1 : 1'b0);

assign icmp_ln86_948_fu_490_p2 = (($signed(p_read9_int_reg) < $signed(18'd1409)) ? 1'b1 : 1'b0);

assign icmp_ln86_949_fu_496_p2 = (($signed(p_read8_int_reg) < $signed(18'd46)) ? 1'b1 : 1'b0);

assign icmp_ln86_950_fu_502_p2 = (($signed(p_read10_int_reg) < $signed(18'd2534)) ? 1'b1 : 1'b0);

assign icmp_ln86_951_fu_508_p2 = (($signed(p_read14_int_reg) < $signed(18'd123)) ? 1'b1 : 1'b0);

assign icmp_ln86_952_fu_514_p2 = (($signed(p_read11_int_reg) < $signed(18'd834)) ? 1'b1 : 1'b0);

assign icmp_ln86_953_fu_520_p2 = (($signed(p_read9_int_reg) < $signed(18'd1405)) ? 1'b1 : 1'b0);

assign icmp_ln86_955_fu_542_p2 = (($signed(p_read13_int_reg) < $signed(18'd260886)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_352_p2 = (($signed(p_read9_int_reg) < $signed(18'd1389)) ? 1'b1 : 1'b0);
...
assign tmp_fu_526_p4 = {{p_read4_int_reg[17:2]}};
