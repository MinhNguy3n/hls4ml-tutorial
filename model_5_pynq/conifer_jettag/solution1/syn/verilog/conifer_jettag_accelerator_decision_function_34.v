...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x15 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 5'h0 ),
    .din0_WIDTH( 13 ),
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 13 ))
sparsemux_65_5_13_1_1_x15_U894(
    .din0(13'd7911),
    .din1(13'd619),
    .din2(13'd1326),
    .din3(13'd181),
...
assign icmp_ln86_956_fu_302_p2 = (($signed(p_read1_int_reg) < $signed(18'd261590)) ? 1'b1 : 1'b0);

assign icmp_ln86_957_fu_308_p2 = (($signed(p_read1_int_reg) < $signed(18'd261015)) ? 1'b1 : 1'b0);

assign icmp_ln86_958_fu_314_p2 = (($signed(p_read2_int_reg) < $signed(18'd649)) ? 1'b1 : 1'b0);

assign icmp_ln86_959_fu_320_p2 = (($signed(p_read2_int_reg) < $signed(18'd547)) ? 1'b1 : 1'b0);

assign icmp_ln86_960_fu_326_p2 = (($signed(p_read8_int_reg) < $signed(18'd737)) ? 1'b1 : 1'b0);

assign icmp_ln86_961_fu_332_p2 = (($signed(p_read7_int_reg) < $signed(18'd168)) ? 1'b1 : 1'b0);

assign icmp_ln86_962_fu_338_p2 = (($signed(p_read8_int_reg) < $signed(18'd262031)) ? 1'b1 : 1'b0);

assign icmp_ln86_963_fu_344_p2 = (($signed(p_read7_int_reg) < $signed(18'd6)) ? 1'b1 : 1'b0);

assign icmp_ln86_964_fu_350_p2 = (($signed(p_read1_int_reg) < $signed(18'd262056)) ? 1'b1 : 1'b0);

assign icmp_ln86_965_fu_356_p2 = (($signed(p_read3_int_reg) < $signed(18'd261797)) ? 1'b1 : 1'b0);

assign icmp_ln86_966_fu_362_p2 = (($signed(p_read2_int_reg) < $signed(18'd795)) ? 1'b1 : 1'b0);

assign icmp_ln86_967_fu_368_p2 = (($signed(p_read8_int_reg) < $signed(18'd2107)) ? 1'b1 : 1'b0);

assign icmp_ln86_968_fu_374_p2 = (($signed(p_read1_int_reg) < $signed(18'd261640)) ? 1'b1 : 1'b0);

assign icmp_ln86_969_fu_380_p2 = (($signed(p_read7_int_reg) < $signed(18'd266)) ? 1'b1 : 1'b0);

assign icmp_ln86_970_fu_386_p2 = (($signed(p_read4_int_reg) < $signed(18'd261160)) ? 1'b1 : 1'b0);

assign icmp_ln86_971_fu_392_p2 = (($signed(p_read2_int_reg) < $signed(18'd162)) ? 1'b1 : 1'b0);

assign icmp_ln86_972_fu_398_p2 = (($signed(p_read1_int_reg) < $signed(18'd261171)) ? 1'b1 : 1'b0);

assign icmp_ln86_973_fu_404_p2 = (($signed(p_read6_int_reg) < $signed(18'd261895)) ? 1'b1 : 1'b0);

assign icmp_ln86_974_fu_410_p2 = (($signed(p_read8_int_reg) < $signed(18'd261653)) ? 1'b1 : 1'b0);

assign icmp_ln86_975_fu_416_p2 = (($signed(p_read2_int_reg) < $signed(18'd110)) ? 1'b1 : 1'b0);

assign icmp_ln86_976_fu_422_p2 = (($signed(p_read1_int_reg) < $signed(18'd261711)) ? 1'b1 : 1'b0);

assign icmp_ln86_977_fu_428_p2 = (($signed(p_read7_int_reg) < $signed(18'd1885)) ? 1'b1 : 1'b0);

assign icmp_ln86_978_fu_434_p2 = (($signed(p_read1_int_reg) < $signed(18'd260884)) ? 1'b1 : 1'b0);

assign icmp_ln86_979_fu_440_p2 = (($signed(p_read1_int_reg) < $signed(18'd260838)) ? 1'b1 : 1'b0);

assign icmp_ln86_980_fu_446_p2 = (($signed(p_read1_int_reg) < $signed(18'd260365)) ? 1'b1 : 1'b0);

assign icmp_ln86_981_fu_452_p2 = (($signed(p_read7_int_reg) < $signed(18'd1260)) ? 1'b1 : 1'b0);

assign icmp_ln86_982_fu_458_p2 = (($signed(p_read2_int_reg) < $signed(18'd692)) ? 1'b1 : 1'b0);

assign icmp_ln86_983_fu_464_p2 = (($signed(p_read7_int_reg) < $signed(18'd60)) ? 1'b1 : 1'b0);

assign icmp_ln86_984_fu_470_p2 = (($signed(p_read5_int_reg) < $signed(18'd261391)) ? 1'b1 : 1'b0);

assign icmp_ln86_985_fu_476_p2 = (($signed(p_read5_int_reg) < $signed(18'd261240)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_296_p2 = (($signed(p_read8_int_reg) < $signed(18'd218)) ? 1'b1 : 1'b0);
