...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x5 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_63_5_12_1_1_x5_U1248(
    .din0(12'd3528),
    .din1(12'd3968),
    .din2(12'd119),
    .din3(12'd170),
...
assign icmp_ln86_141_fu_314_p2 = (($signed(p_read1_int_reg) < $signed(18'd326)) ? 1'b1 : 1'b0);

assign icmp_ln86_142_fu_320_p2 = (($signed(p_read4_int_reg) < $signed(18'd261543)) ? 1'b1 : 1'b0);

assign icmp_ln86_143_fu_326_p2 = (($signed(p_read4_int_reg) < $signed(18'd261987)) ? 1'b1 : 1'b0);

assign icmp_ln86_144_fu_332_p2 = (($signed(p_read2_int_reg) < $signed(18'd62)) ? 1'b1 : 1'b0);

assign icmp_ln86_145_fu_338_p2 = (($signed(p_read9_int_reg) < $signed(18'd261665)) ? 1'b1 : 1'b0);

assign icmp_ln86_146_fu_344_p2 = (($signed(p_read9_int_reg) < $signed(18'd261611)) ? 1'b1 : 1'b0);

assign icmp_ln86_147_fu_350_p2 = (($signed(p_read6_int_reg) < $signed(18'd261847)) ? 1'b1 : 1'b0);

assign icmp_ln86_148_fu_356_p2 = (($signed(p_read4_int_reg) < $signed(18'd96)) ? 1'b1 : 1'b0);

assign icmp_ln86_149_fu_362_p2 = (($signed(p_read1_int_reg) < $signed(18'd755)) ? 1'b1 : 1'b0);

assign icmp_ln86_150_fu_368_p2 = (($signed(p_read8_int_reg) < $signed(18'd260793)) ? 1'b1 : 1'b0);

assign icmp_ln86_151_fu_374_p2 = (($signed(p_read1_int_reg) < $signed(18'd261776)) ? 1'b1 : 1'b0);

assign icmp_ln86_152_fu_380_p2 = (($signed(p_read9_int_reg) < $signed(18'd261992)) ? 1'b1 : 1'b0);

assign icmp_ln86_153_fu_386_p2 = (($signed(p_read4_int_reg) < $signed(18'd261556)) ? 1'b1 : 1'b0);

assign icmp_ln86_154_fu_392_p2 = (($signed(p_read9_int_reg) < $signed(18'd142)) ? 1'b1 : 1'b0);

assign icmp_ln86_155_fu_398_p2 = (($signed(p_read9_int_reg) < $signed(18'd157)) ? 1'b1 : 1'b0);

assign icmp_ln86_156_fu_404_p2 = (($signed(p_read7_int_reg) < $signed(18'd1244)) ? 1'b1 : 1'b0);

assign icmp_ln86_157_fu_410_p2 = (($signed(p_read5_int_reg) < $signed(18'd261615)) ? 1'b1 : 1'b0);

assign icmp_ln86_158_fu_416_p2 = (($signed(p_read9_int_reg) < $signed(18'd121)) ? 1'b1 : 1'b0);

assign icmp_ln86_159_fu_422_p2 = (($signed(p_read6_int_reg) < $signed(18'd2620)) ? 1'b1 : 1'b0);

assign icmp_ln86_160_fu_428_p2 = (($signed(p_read2_int_reg) < $signed(18'd261881)) ? 1'b1 : 1'b0);

assign icmp_ln86_161_fu_434_p2 = (($signed(p_read3_int_reg) < $signed(18'd406)) ? 1'b1 : 1'b0);

assign icmp_ln86_162_fu_440_p2 = (($signed(p_read5_int_reg) < $signed(18'd301)) ? 1'b1 : 1'b0);

assign icmp_ln86_163_fu_446_p2 = (($signed(p_read4_int_reg) < $signed(18'd261516)) ? 1'b1 : 1'b0);

assign icmp_ln86_164_fu_452_p2 = (($signed(p_read2_int_reg) < $signed(18'd342)) ? 1'b1 : 1'b0);

assign icmp_ln86_165_fu_458_p2 = (($signed(p_read2_int_reg) < $signed(18'd260116)) ? 1'b1 : 1'b0);

assign icmp_ln86_166_fu_464_p2 = (($signed(p_read7_int_reg) < $signed(18'd261663)) ? 1'b1 : 1'b0);

assign icmp_ln86_167_fu_470_p2 = (($signed(p_read9_int_reg) < $signed(18'd261579)) ? 1'b1 : 1'b0);

assign icmp_ln86_168_fu_476_p2 = (($signed(p_read4_int_reg) < $signed(18'd262038)) ? 1'b1 : 1'b0);

assign icmp_ln86_169_fu_482_p2 = (($signed(p_read8_int_reg) < $signed(18'd261261)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_308_p2 = (($signed(p_read10_int_reg) < $signed(18'd261559)) ? 1'b1 : 1'b0);
