...
(* dissolve_hierarchy = "yes" *) conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x13 #(
    ...
    .sel_WIDTH( 5 ),
    .dout_WIDTH( 12 ))
sparsemux_65_5_12_1_1_x13_U532(
    .din0(12'd4029),
    .din1(12'd85),
    .din2(12'd3719),
    .din3(12'd4023),
...
assign icmp_ln86_1059_fu_336_p2 = (($signed(p_read11_int_reg) < $signed(18'd260800)) ? 1'b1 : 1'b0);

assign icmp_ln86_1060_fu_342_p2 = (($signed(p_read5_int_reg) < $signed(18'd310)) ? 1'b1 : 1'b0);

assign icmp_ln86_1061_fu_348_p2 = (($signed(p_read3_int_reg) < $signed(18'd260851)) ? 1'b1 : 1'b0);

assign icmp_ln86_1062_fu_354_p2 = (($signed(p_read12_int_reg) < $signed(18'd312)) ? 1'b1 : 1'b0);

assign icmp_ln86_1063_fu_360_p2 = (($signed(p_read11_int_reg) < $signed(18'd261664)) ? 1'b1 : 1'b0);

assign icmp_ln86_1064_fu_366_p2 = (($signed(p_read10_int_reg) < $signed(18'd261481)) ? 1'b1 : 1'b0);

assign icmp_ln86_1065_fu_372_p2 = (($signed(p_read11_int_reg) < $signed(18'd260790)) ? 1'b1 : 1'b0);

assign icmp_ln86_1066_fu_378_p2 = (($signed(p_read12_int_reg) < $signed(18'd548)) ? 1'b1 : 1'b0);

assign icmp_ln86_1067_fu_384_p2 = (($signed(p_read11_int_reg) < $signed(18'd1713)) ? 1'b1 : 1'b0);

assign icmp_ln86_1068_fu_390_p2 = (($signed(p_read1_int_reg) < $signed(18'd261640)) ? 1'b1 : 1'b0);

assign icmp_ln86_1069_fu_396_p2 = (($signed(p_read12_int_reg) < $signed(18'd261606)) ? 1'b1 : 1'b0);

assign icmp_ln86_1070_fu_402_p2 = (($signed(p_read1_int_reg) < $signed(18'd1504)) ? 1'b1 : 1'b0);

assign icmp_ln86_1071_fu_408_p2 = (($signed(p_read11_int_reg) < $signed(18'd452)) ? 1'b1 : 1'b0);

assign icmp_ln86_1072_fu_414_p2 = (($signed(p_read11_int_reg) < $signed(18'd382)) ? 1'b1 : 1'b0);

assign icmp_ln86_1073_fu_420_p2 = (($signed(p_read2_int_reg) < $signed(18'd257481)) ? 1'b1 : 1'b0);

assign icmp_ln86_1074_fu_426_p2 = (($signed(p_read11_int_reg) < $signed(18'd260788)) ? 1'b1 : 1'b0);

assign icmp_ln86_1075_fu_432_p2 = (($signed(p_read1_int_reg) < $signed(18'd261878)) ? 1'b1 : 1'b0);

assign icmp_ln86_1076_fu_438_p2 = (($signed(p_read6_int_reg) < $signed(18'd653)) ? 1'b1 : 1'b0);

assign icmp_ln86_1077_fu_444_p2 = (($signed(p_read4_int_reg) < $signed(18'd2430)) ? 1'b1 : 1'b0);

assign icmp_ln86_1078_fu_450_p2 = (($signed(p_read8_int_reg) < $signed(18'd261425)) ? 1'b1 : 1'b0);

assign icmp_ln86_1079_fu_456_p2 = (($signed(p_read12_int_reg) < $signed(18'd973)) ? 1'b1 : 1'b0);

assign icmp_ln86_1080_fu_462_p2 = (($signed(p_read7_int_reg) < $signed(18'd3600)) ? 1'b1 : 1'b0);

assign icmp_ln86_1081_fu_468_p2 = (($signed(p_read10_int_reg) < $signed(18'd87)) ? 1'b1 : 1'b0);

assign icmp_ln86_1082_fu_474_p2 = (($signed(p_read9_int_reg) < $signed(18'd261569)) ? 1'b1 : 1'b0);

assign icmp_ln86_1083_fu_480_p2 = (($signed(p_read2_int_reg) < $signed(18'd260714)) ? 1'b1 : 1'b0);

assign icmp_ln86_1084_fu_486_p2 = (($signed(p_read11_int_reg) < $signed(18'd233)) ? 1'b1 : 1'b0);

assign icmp_ln86_1085_fu_492_p2 = (($signed(p_read10_int_reg) < $signed(18'd261043)) ? 1'b1 : 1'b0);

assign icmp_ln86_1086_fu_508_p2 = (($signed(tmp_fu_498_p4) < $signed(11'd1)) ? 1'b1 : 1'b0);

assign icmp_ln86_1087_fu_514_p2 = (($signed(p_read4_int_reg) < $signed(18'd131)) ? 1'b1 : 1'b0);

assign icmp_ln86_fu_330_p2 = (($signed(p_read7_int_reg) < $signed(18'd3298)) ? 1'b1 : 1'b0);
...
assign tmp_fu_498_p4 = {{p_read11_int_reg[17:7]}};
