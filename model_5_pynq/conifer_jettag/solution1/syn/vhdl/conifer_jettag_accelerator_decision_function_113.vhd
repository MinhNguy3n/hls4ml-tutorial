...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_61_5_12_1_1_x1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_61_5_12_1_1_x1_U1439 : component conifer_jettag_accelerator_sparsemux_61_5_12_1_1_x1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_1782_fu_310_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_385)) else "0";
    icmp_ln86_1783_fu_316_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_4A5)) else "0";
    icmp_ln86_1784_fu_322_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FEDD)) else "0";
    icmp_ln86_1785_fu_328_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FCDB)) else "0";
    icmp_ln86_1786_fu_334_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_A13)) else "0";
    icmp_ln86_1787_fu_340_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FDDB)) else "0";
    icmp_ln86_1788_fu_346_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_AD)) else "0";
    icmp_ln86_1789_fu_352_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_2B8)) else "0";
    icmp_ln86_1790_fu_358_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_2BE)) else "0";
    icmp_ln86_1791_fu_364_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_C2)) else "0";
    icmp_ln86_1792_fu_370_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3F7DC)) else "0";
    icmp_ln86_1793_fu_376_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_666)) else "0";
    icmp_ln86_1794_fu_382_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FDCA)) else "0";
    icmp_ln86_1795_fu_388_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FFED)) else "0";
    icmp_ln86_1796_fu_394_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FB80)) else "0";
    icmp_ln86_1797_fu_400_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_334)) else "0";
    icmp_ln86_1798_fu_406_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_1799_fu_412_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_90E)) else "0";
    icmp_ln86_1800_fu_418_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_6BF)) else "0";
    icmp_ln86_1801_fu_424_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3F9A7)) else "0";
    icmp_ln86_1802_fu_430_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FAC3)) else "0";
    icmp_ln86_1803_fu_436_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF19)) else "0";
    icmp_ln86_1804_fu_442_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F3)) else "0";
    icmp_ln86_1805_fu_448_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_FC4)) else "0";
    icmp_ln86_1806_fu_454_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FE8F)) else "0";
    icmp_ln86_1807_fu_460_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FDC9)) else "0";
    icmp_ln86_1808_fu_466_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_CE)) else "0";
    icmp_ln86_1809_fu_472_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_313)) else "0";
    icmp_ln86_fu_304_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_340)) else "0";
