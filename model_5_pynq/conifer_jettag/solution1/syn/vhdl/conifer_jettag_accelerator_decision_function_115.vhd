...
begin
    sparsemux_65_5_12_1_1_x26_U1415 : component conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x26
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1723_fu_312_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FE9C)) else "0";
    icmp_ln86_1724_fu_318_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_5A9)) else "0";
    icmp_ln86_1725_fu_324_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF40)) else "0";
    icmp_ln86_1726_fu_330_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FAD1)) else "0";
    icmp_ln86_1727_fu_336_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FC0D)) else "0";
    icmp_ln86_1728_fu_342_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD76)) else "0";
    icmp_ln86_1729_fu_348_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FF0E)) else "0";
    icmp_ln86_1730_fu_354_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_1D3)) else "0";
    icmp_ln86_1731_fu_360_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_510)) else "0";
    icmp_ln86_1732_fu_366_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FD58)) else "0";
    icmp_ln86_1733_fu_372_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FB78)) else "0";
    icmp_ln86_1734_fu_378_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBC9)) else "0";
    icmp_ln86_1735_fu_384_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FF60)) else "0";
    icmp_ln86_1736_fu_390_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCA8)) else "0";
    icmp_ln86_1737_fu_396_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FCA5)) else "0";
    icmp_ln86_1738_fu_402_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_7A)) else "0";
    icmp_ln86_1739_fu_408_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_4C)) else "0";
    icmp_ln86_1740_fu_414_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_38B)) else "0";
    icmp_ln86_1741_fu_420_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FC9A)) else "0";
    icmp_ln86_1742_fu_426_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_267)) else "0";
    icmp_ln86_1743_fu_432_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_16C)) else "0";
    icmp_ln86_1744_fu_438_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FAF5)) else "0";
    icmp_ln86_1745_fu_444_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FFB0)) else "0";
    icmp_ln86_1746_fu_450_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_4E3)) else "0";
    icmp_ln86_1747_fu_456_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBE1)) else "0";
    icmp_ln86_1748_fu_462_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_7E4)) else "0";
    icmp_ln86_1749_fu_468_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBDB)) else "0";
    icmp_ln86_1750_fu_474_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FD7D)) else "0";
    icmp_ln86_1751_fu_480_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FE55)) else "0";
    icmp_ln86_fu_306_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_38F)) else "0";
