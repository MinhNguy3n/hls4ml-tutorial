...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x24 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x24_U1403 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x24
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1693_fu_320_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FD06)) else "0";
    icmp_ln86_1694_fu_326_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FF9D)) else "0";
    icmp_ln86_1695_fu_332_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FD95)) else "0";
    icmp_ln86_1696_fu_338_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FD82)) else "0";
    icmp_ln86_1697_fu_344_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_24D)) else "0";
    icmp_ln86_1698_fu_350_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FB31)) else "0";
    icmp_ln86_1699_fu_356_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FEB7)) else "0";
    icmp_ln86_1700_fu_362_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FFED)) else "0";
    icmp_ln86_1701_fu_368_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FD83)) else "0";
    icmp_ln86_1702_fu_374_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FEA7)) else "0";
    icmp_ln86_1703_fu_380_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FF30)) else "0";
    icmp_ln86_1704_fu_386_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_11E)) else "0";
    icmp_ln86_1705_fu_392_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FCA4)) else "0";
    icmp_ln86_1706_fu_398_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FCA2)) else "0";
    icmp_ln86_1707_fu_404_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FBCC)) else "0";
    icmp_ln86_1708_fu_410_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FD71)) else "0";
    icmp_ln86_1709_fu_416_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FB8D)) else "0";
    icmp_ln86_1710_fu_422_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FDBF)) else "0";
    icmp_ln86_1711_fu_428_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_15E)) else "0";
    icmp_ln86_1712_fu_434_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FC)) else "0";
    icmp_ln86_1713_fu_440_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_609)) else "0";
    icmp_ln86_1714_fu_446_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FF83)) else "0";
    icmp_ln86_1715_fu_452_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_10F)) else "0";
    icmp_ln86_1716_fu_458_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_349)) else "0";
    icmp_ln86_1717_fu_464_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FA07)) else "0";
    icmp_ln86_1718_fu_470_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_179)) else "0";
    icmp_ln86_1719_fu_476_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FCA0)) else "0";
    icmp_ln86_1720_fu_482_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FB27)) else "0";
    icmp_ln86_1721_fu_488_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FBAD)) else "0";
    icmp_ln86_1722_fu_494_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FB5F)) else "0";
    icmp_ln86_fu_314_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_B7)) else "0";
