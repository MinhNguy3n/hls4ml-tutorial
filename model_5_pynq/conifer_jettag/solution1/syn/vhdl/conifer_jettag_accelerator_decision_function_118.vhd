...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x20 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_13_1_1_x20_U1374 : component conifer_jettag_accelerator_sparsemux_65_5_13_1_1_x20
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1635_fu_328_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FE91)) else "0";
    icmp_ln86_1636_fu_334_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCD2)) else "0";
    icmp_ln86_1637_fu_340_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_24B)) else "0";
    icmp_ln86_1638_fu_346_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_203)) else "0";
    icmp_ln86_1639_fu_352_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FC23)) else "0";
    icmp_ln86_1640_fu_358_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FBB7)) else "0";
    icmp_ln86_1641_fu_364_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_5A1)) else "0";
    icmp_ln86_1642_fu_370_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3BA)) else "0";
    icmp_ln86_1643_fu_376_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_89)) else "0";
    icmp_ln86_1644_fu_382_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FF42)) else "0";
    icmp_ln86_1645_fu_388_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FB4F)) else "0";
    icmp_ln86_1646_fu_394_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_700)) else "0";
    icmp_ln86_1647_fu_400_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_49E)) else "0";
    icmp_ln86_1648_fu_406_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_152)) else "0";
    icmp_ln86_1649_fu_412_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FE73)) else "0";
    icmp_ln86_1650_fu_418_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_739)) else "0";
    icmp_ln86_1651_fu_424_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_2B)) else "0";
    icmp_ln86_1652_fu_430_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FE57)) else "0";
    icmp_ln86_1653_fu_436_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_335)) else "0";
    icmp_ln86_1654_fu_442_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_5F)) else "0";
    icmp_ln86_1655_fu_448_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCE1)) else "0";
    icmp_ln86_1656_fu_454_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FF01)) else "0";
    icmp_ln86_1657_fu_460_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_166)) else "0";
    icmp_ln86_1658_fu_466_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FDBE)) else "0";
    icmp_ln86_1659_fu_472_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_380)) else "0";
    icmp_ln86_1660_fu_478_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_2CA)) else "0";
    icmp_ln86_1661_fu_484_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_497)) else "0";
    icmp_ln86_1662_fu_490_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FA21)) else "0";
    icmp_ln86_1663_fu_496_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_7D)) else "0";
    icmp_ln86_1664_fu_502_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_1D2)) else "0";
    icmp_ln86_fu_322_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_4C)) else "0";
