...
begin
    sparsemux_63_5_12_1_1_x_U836 : component conifer_jettag_accelerator_sparsemux_63_5_12_1_1_x
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    ap_return <= 
        ...
        ap_const_lv12_0;
    icmp_ln86_1073_fu_324_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FB61)) else "0";
    icmp_ln86_1074_fu_330_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FBF8)) else "0";
    icmp_ln86_1075_fu_336_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_349)) else "0";
    icmp_ln86_1076_fu_342_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_DD)) else "0";
    icmp_ln86_1077_fu_348_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_13C)) else "0";
    icmp_ln86_1078_fu_354_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCFE)) else "0";
    icmp_ln86_1079_fu_360_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_2E1)) else "0";
    icmp_ln86_1080_fu_366_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF88)) else "0";
    icmp_ln86_1081_fu_372_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFBD)) else "0";
    icmp_ln86_1082_fu_378_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF9F)) else "0";
    icmp_ln86_1083_fu_384_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_D9)) else "0";
    icmp_ln86_1084_fu_390_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFD1)) else "0";
    icmp_ln86_1085_fu_396_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FC2A)) else "0";
    icmp_ln86_1086_fu_402_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FCFF)) else "0";
    icmp_ln86_1087_fu_408_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_1C0)) else "0";
    icmp_ln86_1088_fu_414_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_798)) else "0";
    icmp_ln86_1089_fu_420_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FE65)) else "0";
    icmp_ln86_1090_fu_426_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_98)) else "0";
    icmp_ln86_1091_fu_432_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_6E)) else "0";
    icmp_ln86_1092_fu_438_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_D0)) else "0";
    icmp_ln86_1093_fu_444_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_FE)) else "0";
    icmp_ln86_1094_fu_450_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FE30)) else "0";
    icmp_ln86_1095_fu_456_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FFAF)) else "0";
    icmp_ln86_1096_fu_462_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_292)) else "0";
    icmp_ln86_1097_fu_468_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_388)) else "0";
    icmp_ln86_1098_fu_474_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_1BA)) else "0";
    icmp_ln86_1099_fu_480_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_B1)) else "0";
    icmp_ln86_1100_fu_486_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_1057)) else "0";
    icmp_ln86_1101_fu_492_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FFFC)) else "0";
    icmp_ln86_fu_318_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_36F)) else "0";
