...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x16 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x16_U808 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x16
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1132_fu_342_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_A08)) else "0";
    icmp_ln86_1133_fu_348_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FD78)) else "0";
    icmp_ln86_1134_fu_354_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FAC7)) else "0";
    icmp_ln86_1135_fu_360_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FB7E)) else "0";
    icmp_ln86_1136_fu_366_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_607)) else "0";
    icmp_ln86_1137_fu_372_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FF39)) else "0";
    icmp_ln86_1138_fu_378_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_5EA)) else "0";
    icmp_ln86_1139_fu_384_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_6B8)) else "0";
    icmp_ln86_1140_fu_390_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_7BA)) else "0";
    icmp_ln86_1141_fu_396_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FFBE)) else "0";
    icmp_ln86_1142_fu_402_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FFB9)) else "0";
    icmp_ln86_1143_fu_408_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_6CB)) else "0";
    icmp_ln86_1145_fu_430_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_B8)) else "0";
    icmp_ln86_1146_fu_436_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FF8F)) else "0";
    icmp_ln86_1147_fu_442_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_23)) else "0";
    icmp_ln86_1148_fu_448_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_BF)) else "0";
    icmp_ln86_1149_fu_454_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_283)) else "0";
    icmp_ln86_1150_fu_460_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_2B3)) else "0";
    icmp_ln86_1151_fu_466_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_7E1)) else "0";
    icmp_ln86_1152_fu_472_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_41B)) else "0";
    icmp_ln86_1153_fu_478_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_6AC)) else "0";
    icmp_ln86_1154_fu_484_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FC74)) else "0";
    icmp_ln86_1155_fu_490_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_176)) else "0";
    icmp_ln86_1156_fu_496_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_3FDA2)) else "0";
    icmp_ln86_1157_fu_502_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FB0E)) else "0";
    icmp_ln86_1158_fu_508_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_82B)) else "0";
    icmp_ln86_1159_fu_514_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_AA)) else "0";
    icmp_ln86_1160_fu_520_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_196)) else "0";
    icmp_ln86_1161_fu_526_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_134)) else "0";
    icmp_ln86_1458_fu_424_p2 <= "1" when (signed(tmp_fu_414_p4) < signed(ap_const_lv11_1)) else "0";
    icmp_ln86_fu_336_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FC62)) else "0";
    ...
    select_ln117_fu_651_p3 <= 
        ...
        ap_const_lv2_2;
    tmp_fu_414_p4 <= p_read5_int_reg(17 downto 7);
