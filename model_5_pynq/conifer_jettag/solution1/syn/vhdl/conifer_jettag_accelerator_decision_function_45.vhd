...
attribute shreg_extract : string;
    ...
    component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x14 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
...
begin
    sparsemux_65_5_11_1_1_x14_U753 : component conifer_jettag_accelerator_sparsemux_65_5_11_1_1_x14
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1281_fu_332_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_C8)) else "0";
    icmp_ln86_1282_fu_338_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FA7D)) else "0";
    icmp_ln86_1283_fu_344_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_81)) else "0";
    icmp_ln86_1284_fu_350_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_8FA)) else "0";
    icmp_ln86_1285_fu_356_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FE09)) else "0";
    icmp_ln86_1286_fu_362_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_2DB)) else "0";
    icmp_ln86_1287_fu_368_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_36)) else "0";
    icmp_ln86_1288_fu_374_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FF5D)) else "0";
    icmp_ln86_1289_fu_380_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F927)) else "0";
    icmp_ln86_1290_fu_386_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3F23D)) else "0";
    icmp_ln86_1291_fu_392_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FF9F)) else "0";
    icmp_ln86_1292_fu_398_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF5D)) else "0";
    icmp_ln86_1293_fu_404_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FFAA)) else "0";
    icmp_ln86_1294_fu_410_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_47C)) else "0";
    icmp_ln86_1295_fu_416_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FDA4)) else "0";
    icmp_ln86_1296_fu_422_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_144)) else "0";
    icmp_ln86_1297_fu_428_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_C5)) else "0";
    icmp_ln86_1298_fu_434_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FF60)) else "0";
    icmp_ln86_1299_fu_440_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_747)) else "0";
    icmp_ln86_1300_fu_446_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_5C2)) else "0";
    icmp_ln86_1301_fu_452_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FACB)) else "0";
    icmp_ln86_1302_fu_458_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FF49)) else "0";
    icmp_ln86_1303_fu_464_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_3FC9B)) else "0";
    icmp_ln86_1304_fu_470_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_3FDA5)) else "0";
    icmp_ln86_1305_fu_476_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_10B)) else "0";
    icmp_ln86_1306_fu_482_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FD0D)) else "0";
    icmp_ln86_1307_fu_488_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_3FD85)) else "0";
    icmp_ln86_1308_fu_494_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_144)) else "0";
    icmp_ln86_1309_fu_500_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_DD)) else "0";
    icmp_ln86_1310_fu_506_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FCDC)) else "0";
    icmp_ln86_fu_326_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FCCA)) else "0";
