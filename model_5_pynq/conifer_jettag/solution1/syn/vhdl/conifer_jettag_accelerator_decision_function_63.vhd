...
entity conifer_jettag_accelerator_decision_function_63 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conifer_jettag_accelerator_decision_function_63 is 
...
begin
    sparsemux_65_5_12_1_1_x13_U532 : component conifer_jettag_accelerator_sparsemux_65_5_12_1_1_x13
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "00000",
    ...
    icmp_ln86_1059_fu_336_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FAC0)) else "0";
    icmp_ln86_1060_fu_342_p2 <= "1" when (signed(p_read5_int_reg) < signed(ap_const_lv18_136)) else "0";
    icmp_ln86_1061_fu_348_p2 <= "1" when (signed(p_read3_int_reg) < signed(ap_const_lv18_3FAF3)) else "0";
    icmp_ln86_1062_fu_354_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_138)) else "0";
    icmp_ln86_1063_fu_360_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FE20)) else "0";
    icmp_ln86_1064_fu_366_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FD69)) else "0";
    icmp_ln86_1065_fu_372_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FAB6)) else "0";
    icmp_ln86_1066_fu_378_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_224)) else "0";
    icmp_ln86_1067_fu_384_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_6B1)) else "0";
    icmp_ln86_1068_fu_390_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FE08)) else "0";
    icmp_ln86_1069_fu_396_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3FDE6)) else "0";
    icmp_ln86_1070_fu_402_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_5E0)) else "0";
    icmp_ln86_1071_fu_408_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_1C4)) else "0";
    icmp_ln86_1072_fu_414_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_17E)) else "0";
    icmp_ln86_1073_fu_420_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3EDC9)) else "0";
    icmp_ln86_1074_fu_426_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_3FAB4)) else "0";
    icmp_ln86_1075_fu_432_p2 <= "1" when (signed(p_read1_int_reg) < signed(ap_const_lv18_3FEF6)) else "0";
    icmp_ln86_1076_fu_438_p2 <= "1" when (signed(p_read6_int_reg) < signed(ap_const_lv18_28D)) else "0";
    icmp_ln86_1077_fu_444_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_97E)) else "0";
    icmp_ln86_1078_fu_450_p2 <= "1" when (signed(p_read8_int_reg) < signed(ap_const_lv18_3FD31)) else "0";
    icmp_ln86_1079_fu_456_p2 <= "1" when (signed(p_read12_int_reg) < signed(ap_const_lv18_3CD)) else "0";
    icmp_ln86_1080_fu_462_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_E10)) else "0";
    icmp_ln86_1081_fu_468_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_57)) else "0";
    icmp_ln86_1082_fu_474_p2 <= "1" when (signed(p_read9_int_reg) < signed(ap_const_lv18_3FDC1)) else "0";
    icmp_ln86_1083_fu_480_p2 <= "1" when (signed(p_read2_int_reg) < signed(ap_const_lv18_3FA6A)) else "0";
    icmp_ln86_1084_fu_486_p2 <= "1" when (signed(p_read11_int_reg) < signed(ap_const_lv18_E9)) else "0";
    icmp_ln86_1085_fu_492_p2 <= "1" when (signed(p_read10_int_reg) < signed(ap_const_lv18_3FBB3)) else "0";
    icmp_ln86_1086_fu_508_p2 <= "1" when (signed(tmp_fu_498_p4) < signed(ap_const_lv11_1)) else "0";
    icmp_ln86_1087_fu_514_p2 <= "1" when (signed(p_read4_int_reg) < signed(ap_const_lv18_83)) else "0";
    icmp_ln86_fu_330_p2 <= "1" when (signed(p_read7_int_reg) < signed(ap_const_lv18_CE2)) else "0";
    ...
    select_ln117_fu_591_p3 <= 
        ...
        ap_const_lv2_3;
    tmp_fu_498_p4 <= p_read11_int_reg(17 downto 7);
